...
!0,this._offset={x:a.offset&&a.offset.x||0,y:a.offset&&a.offset.y||0},this._image=wade.getImage(this._imageName),this._stopped=!!a.stopped,this._imageArea=a.imageArea||{minX:0,minY:0,maxX:1,maxY:1},a.properties)for(var j in a.properties)if(a.properties.hasOwnProperty(j))try{this[j]=JSON.parse(JSON.stringify(a.properties[j]))}catch(l){}}else this._image=wade.getImage(a),this._imageName=wade.getFullPathAndFileName(a),this._numCells={x:b?b:1,y:c?c:1},this._startFrame=f?f:0,this._endFrame="undefined"!=
...
y:this._image.height*(this._imageArea.maxY-this._imageArea.minY)/this._numCells.y};this._frameCorner={};try{this._f32AnimFrameInfo=new Float32Array([0,0,this._frameSize.x/this._image.width,this._frameSize.y/this._image.height])}catch(k){}this._updateFrameCorner()}Animation.prototype.getImageSize=function(){return{x:this._image.width,y:this._image.height}};Animation.prototype.getFrameSize=function(){return{x:this._frameSize.x,y:this._frameSize.y}};
...
this.response,h=new FileReader;h.onloadend=function(){var e=document.createElement("style");e.id="__wade_font_"+f;e.appendChild(document.createTextNode("@font-face {font-family: '"+f+"';src: url('"+h.result+"') format('woff');}"));document.head.appendChild(e);var l=document.createElement("span");l.innerHTML="giItT1WQy@!-/#";l.style.position="absolute";l.style.left="-10000px";l.style.top="-10000px";l.style.fontSize="300px";l.style.fontFamily="sans-serif";l.style.fontVariant="normal";l.style.fontStyle=
"normal";l.style.fontWeight="normal";l.style.letterSpacing="0";document.body.appendChild(l);var i=l.offsetWidth;l.style.fontFamily=f;var m,q=0;m=setInterval(function(){if(l&&l.offsetWidth!=i)return l.parentNode.removeChild(l),l=null,clearInterval(m),g.loadedFonts[a]=h.result,g.fontLoaded(a,c)(),!0;if(15E3<(q+=50))clearInterval(m),g.fontLoadingError(a,c,d)();return!1},50)};h.readAsDataURL(e)}};e.send()}};this.fontLoaded=function(a,c){var d=this;return function(){"ok"!=d.loadingStatus[a]&&(d.loadingSuccess.fonts++,
...
this.getGamepadData=function(){return m};this.event_mouseDown=function(c){var g={screenPosition:G(c,z)};if(Math.abs(g.screenPosition.x)>wade.getScreenWidth()/2||Math.abs(g.screenPosition.y)>wade.getScreenHeight()/2)return!1;a._setLastMousePosition(g.screenPosition.x,g.screenPosition.y);var l=(new Date).getTime();if(!p&&f.mouseDown&&e.mouseDown&&l-e.mouseDown<f.mouseDown||!p&&f.mouseUp&&e.mouseUp&&l-e.mouseUp<f.mouseUp)return!1;if(p||!b){b=p?b+1:!0;h.push({x:g.screenPosition.x,y:g.screenPosition.y});
g.button=c.button;g.pointerId=c.pointerId||0;j[g.button]=1;d=c;if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onMouseDown",g))&&wade.app.onMouseDown)wade.app.onMouseDown(g);s(c);e.mouseDown=l;u.length=0;t="";u.push({x:g.screenPosition.x,y:g.screenPosition.y})}return!1};this.event_mouseUp=function(c){var g={screenPosition:G(c,z)};if(Math.abs(g.screenPosition.x)>wade.getScreenWidth()/2||Math.abs(g.screenPosition.y)>wade.getScreenHeight()/2)return!1;a._setLastMousePosition(g.screenPosition.x,
g.screenPosition.y);var i=(new Date).getTime();if(!p&&f.mouseUp&&e.mouseUp&&i-e.mouseUp<f.mouseUp)return!1;if(p||b){b=p?b-1:!1;g.button=c.button;g.pointerId=c.pointerId||0;j[g.button]=0;d=c;if(h.length){for(var r=0;r<h.length;r++){var n=g.screenPosition.x-h[r].x,k=g.screenPosition.y-h[r].y;if(n*n+k*k<=l*l){a.event_click(g);break}}h.length--}if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onMouseUp",g))&&wade.app.onMouseUp)wade.app.onMouseUp(g);!e.mouseUp&&(navigator&&navigator.userAgent.match(/(iPod|iPhone|iPad)/)&&
navigator.userAgent.match(/AppleWebKit/))&&wade.playSilentSound();s(c);e.mouseUp=i;u.length=0;t=""}return!1};this.event_mouseMove=function(c){var b={screenPosition:G(c,z)};if(Math.abs(b.screenPosition.x)>wade.getScreenWidth()/2||Math.abs(b.screenPosition.y)>wade.getScreenHeight()/2)return!1;a._setLastMousePosition(b.screenPosition.x,b.screenPosition.y);var j=(new Date).getTime();if(!p&&f.mouseMove&&e.mouseMove&&j-e.mouseMove<f.mouseMove)return!1;b.pointerId=c.pointerId||0;d=c;if(wade.app&&(wade.isAppInitialized()&&
!wade.processEvent("onMouseMove",b))&&wade.app.onMouseMove)wade.app.onMouseMove(b);e.mouseMove=j;s(c);a.isMouseDown()&&(u.push({x:b.screenPosition.x,y:b.screenPosition.y}),a.detectGestures())};this.event_mouseWheel=function(c){var c=c?c:window.event,b={screenPosition:G(c,z)};if(Math.abs(b.screenPosition.x)>wade.getScreenWidth()/2||Math.abs(b.screenPosition.y)>wade.getScreenHeight()/2)return!1;a._setLastMousePosition(b.screenPosition.x,b.screenPosition.y);var j=(new Date).getTime();if(p||!f.mouseWheel||
!(e.mouseWheel&&j-e.mouseWheel<f.mouseWheel)){b.value=c.detail?-1*c.detail:c.wheelDelta/40;d=b;if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onMouseWheel",b))&&wade.app.onMouseWheel)wade.app.onMouseWheel(b);e.mouseWheel=j;s(c)}};this.event_click=function(a){var c=(new Date).getTime();if(p||!f.onClick||!(e.onClick&&c-e.onClick<f.onClick)){if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onClick",a))&&wade.app.onClick)wade.app.onClick(a);e.onClick=c}};this.event_touchStart=function(b){for(var d=
b.touches||i,e=0;e<d.length;e++)d[e].pointerId="undefined"==typeof d[e].pointerId?d[e].identifier:d.pointerId;if(2==d.length){var e=d[0].pageX-d[1].pageX,f=d[0].pageY-d[1].pageY;c=Math.sqrt(e*e+f*f);p&&a.event_mouseDown(d[1])}else 1==d.length?a.event_mouseDown(d[0]):p&&a.event_mouseDown(d[d.length-1]);s(b)};this.event_touchEnd=function(c){if(c.changedTouches&&c.changedTouches.length)for(var b=0;b<c.changedTouches.length;b++)c.changedTouches[b].pointerId="undefined"==typeof c.changedTouches[b].pointerId?
c.changedTouches[b].identifier:c.changedTouches[b].pointerId,a.event_mouseUp(c.changedTouches[b]);else a.event_mouseUp(d);s(c)};this.event_touchMove=function(b){var d;d=b.touches||i;if(2==d.length){var e=d[0].pageX-d[1].pageX,f=d[0].pageY-d[1].pageY;if(e=Math.sqrt(e*e+f*f))f=c-e,Math.abs(f)>wade.c_epsilon&&(f=-30*f/Math.max(wade.getScreenWidth(),wade.getScreenHeight()),a.event_mouseWheel({clientX:d[0].pageX,clientY:d[0].pageY,detail:-f}));c=e;if(p&&b.changedTouches)for(d=0;d<b.changedTouches.length;d++)a.event_mouseMove({clientX:b.changedTouches[d].pageX,
clientY:b.changedTouches[d].pageY,pointerId:b.changedTouches[d].identifier})}else if(1==d.length)a.event_mouseMove({clientX:d[0].pageX,clientY:d[0].pageY,pointerId:d[0].identifier});else if(p&&b.changedTouches)for(d=0;d<b.changedTouches.length;d++)a.event_mouseMove({clientX:b.changedTouches[d].pageX,clientY:b.changedTouches[d].pageY,pointerId:b.changedTouches[d].identifier});s(b)};this.event_keyDown=function(a){var b={keyCode:"which"in a?a.which:a.keyCode,shift:a.shiftKey,ctrl:a.ctrlKey,alt:a.altKey,
meta:a.metaKey};w[b.keyCode]?s(a):(b.keyName=x[b.keyCode],w[b.keyCode]=!0,wade.app&&wade.isAppInitialized()&&!wade.processEvent("onKeyDown",b)?wade.app.onKeyDown&&wade.app.onKeyDown(b)&&s(a):s(a))};this.event_keyUp=function(a){var b={keyCode:"which"in a?a.which:a.keyCode,shift:a.shiftKey,ctrl:a.ctrlKey,alt:a.altKey,meta:a.metaKey};b.keyName=x[b.keyCode];w[b.keyCode]=!1;wade.app&&wade.isAppInitialized()&&!wade.processEvent("onKeyUp",b)?wade.app.onKeyUp&&wade.app.onKeyUp(b)&&s(a):s(a)};this.event_keyPress=
function(a){var b={charCode:"charCode"in a?a.charCode:a.keyCode};b.charName=String.fromCharCode(b.charCode);wade.app&&wade.isAppInitialized()&&!wade.processEvent("onKeyPress",b)?wade.app.onKeyPress&&wade.app.onKeyPress(b)&&s(a):s(a)};this.isKeyDown=function(a){return"string"==typeof a?!!w[this.getKeyCode(a)]:!!w[a]};this.event_pointerDown=function(b){g[b.pointerId]||(g[b.pointerId]=1,i.push({pageX:b.pageX,pageY:b.pageY,clientX:b.clientX,clientY:b.clientY,pointerId:b.pointerId}),a.event_touchStart(b))};
this.event_pointerUp=function(b){if(g[b.pointerId]){for(var c=0;c<i.length;c++)if(i[c].pointerId==b.pointerId){wade.removeObjectFromArrayByIndex(c,i);break}g[b.pointerId]=0;a.event_touchEnd({changedTouches:[b]})}};this.event_pointerMove=function(b){if(g[b.pointerId]){for(var c=0;c<i.length;c++)if(i[c].pointerId==b.pointerId){i[c].pageX=b.pageX;i[c].pageY=b.pageY;i[c].clientX=b.clientX;i[c].clientY=b.clientY;i[c].identifier=b.pointerId;b.changedTouches=[i[c]];break}a.event_touchMove(b)}};this.event_deviceMotion=
function(a){if(a.acceleration&&null!==a.acceleration.x){var b={acceleration:a.acceleration,accelerationIncludingGravity:a.accelerationIncludingGravity,rotation:a.rotationRate,refreshInterval:a.interval};wade.app&&wade.isAppInitialized()&&!wade.processEvent("onDeviceMotion",b)?wade.app.onDeviceMotion&&wade.app.onDeviceMotion(b)&&s(a):s(a)}};this.event_deviceOrientation=function(a){if(null!==a.alpha){var b={alpha:a.alpha,beta:a.beta,gamma:a.gamma};wade.app&&wade.isAppInitialized()&&!wade.processEvent("onDeviceOrientation",
b)?wade.app.onDeviceOrientation&&wade.app.onDeviceOrientation(b)&&s(a):s(a)}};this.event_gamepadConnected=function(a){wade.app.onGamepadConnected&&wade.app.onGamepadConnected({gamepadId:a.gamepad.id})};this.event_gamepadDisconnected=function(a){wade.app.onGamepadDisconnected&&wade.app.onGamepadDisconnected({gamepadId:a.gamepad.id})};this.event_blur=function(a){var b={};wade.app&&wade.isAppInitialized()&&!wade.processEvent("onBlur",b)?wade.app.onBlur&&wade.app.onBlur(b)&&s(a):s(a)};this.event_focus=
function(a){var b={};wade.app&&wade.isAppInitialized()&&!wade.processEvent("onFocus",b)?wade.app.onFocus&&wade.app.onFocus(b)&&s(a):s(a)};this.noEvent=function(a){s(a)};this.isMouseDown=function(a){return"undefined"==typeof a?!!b:!!j[a]};this.setMinimumIntervalBetweenEvents=function(a,b){f[a]=b};this.setClickTolerance=function(a){l=a};this.getMousePosition=function(){return{x:k.x,y:k.y}};this.enableMultitouch=function(a){p=a};this.isMultitouchEnabled=function(){return p};this.cancelEvents=function(a){"undefined"==
typeof a&&(a=!0);n=a};this._setLastMousePosition=function(a,b){if(a!=k.x||b!=k.y)wade.updateMouseInOut(k,{x:a,y:b}),k.x=a,k.y=b};this.detectGestures=function(){var a=0,b=0,c=0,d=0;if(!t&&u.length<3*v){for(var e=1;e<u.length&&!t;e++){var f=u[e].x-u[e-1].x||wade.c_epsilon,p=u[e].y-u[e-1].y||wade.c_epsilon,j=f/Math.abs(p),f=p/Math.abs(f);-1>j&&Math.abs(f)<=y&&++a==v&&!b&&!c&&!d?t="onSwipeLeft":1<j&&Math.abs(f)<=y&&++b==v&&!a&&!c&&!d?t="onSwipeRight":-1>f&&Math.abs(j)<=y&&++c==v&&!a&&!b&&!d?t="onSwipeUp":
1<f&&(Math.abs(j)<=y&&++d==v&&!a&&!c&&!b)&&(t="onSwipeDown")}if(t&&(a=u[0],a={screenPosition:{x:a.x,y:a.y},screenPositions:u},wade.app&&(wade.isAppInitialized()&&!wade.processEvent(t,a))&&wade.app[t]))wade.app[t](a)}};this.setSwipeTolerance=function(a,b){y=a;v=b};this.getKeyName=function(a){return x[a]};this.getKeyCode=function(a){return F[a]}}
...
this._sprites[a-1]=this._sprites[a],this._sprites[a]=j,h++;else break;if(!h)for(a=c-1;0<=a;a--)if(0>this._sortingFunction(j,this._sprites[a]))this._sprites[a].setDirtyArea(),this._sprites[a+1]=this._sprites[a],this._sprites[a]=j,h++;else break}}this._needsFullSorting=!1;this._movingSprites.length=0;"webgl"==this._renderMode&&(d.bindFramebuffer(d.FRAMEBUFFER,this._useOffScreenTarget?this._mainRenderTarget:null),d.uniform2fv(d.currentShader.uniforms.uViewportSize,this._f32ViewportSize),d.uniform4fv(d.currentShader.uniforms.uCameraScaleTranslateTime,
...
32),l=new Sprite("__wade_pathLine_",b);l.setSize(wade.vec2.length(h),2);var k=wade.vec2.add(g,wade.vec2.scale(h,0.5));k.angle=Math.atan2(g.y-i.y,g.x-i.x);this._debugDraw.addSprite(l,k);i=this._getInterpolationFunction(c);for(l=0;l<j;l++)if(k={x:i(l/(j-1),g.x,h.x),y:i(l/(j-1),g.y,h.y)},l!=j-1){var m=new Sprite("__wade_pathSubNode_",b);m.nodeIndex=c;m.isIntermediateSprite=!0;this._debugDraw.addSprite(m,k)}}this._debugDraw.addSprite(d,e);e.y+=10;this._debugDraw.addSprite(f,{x:e.x,y:e.y-4,angle:e.angle})}}else wade.removeSceneObject(this._debugDraw),
...
g,e,c,d),f=0;f<a.getSpriteCount();f++)a.getSprite(f).setSize(h.x,h.y);if("undefined"!=typeof c.opacity)for(var j=this._evaluateProperty("opacity",g,e,c,d),f=0;f<a.getSpriteCount();f++){for(var h=a.getSprite(f),l=h.getDrawModifiers(),k=l.length-1;0<=k;k--){var m=l[k];("alpha"==m.type||"fadeOpacity"==m.type)&&wade.removeObjectFromArrayByIndex(k,l)}l.push({type:"alpha",alpha:j});k=h instanceof TextSprite?TextSprite.prototype:Sprite.prototype;k="webgl"==wade.getLayer(h.getLayerId()).getRenderMode()?k.draw_gl:
k.draw;h.setDrawFunction(k);h.setDrawModifiers(l)}if(c.properties&&d.properties)for(var q in c.properties){j=this._evaluateProperty(q,g,e,c.properties,d.properties);a[q]=j;for(f=0;f<a.getSpriteCount();f++)h=a.getSprite(f),h[q]=j}return i};
...
function Renderer(){var a={},b=[],c=0,d=0,e=0,f="full",g=1920,i=1080,h=0,j=0,l={x:0,y:0,z:1},k={},m=!0,q=!1,u=0,t=0;this._createLayerIfNeeded=function(c,d){a[c]||(a[c]=new Layer(c,d),m||a[c].setSmoothing(m),b.push(a[c]),b.sort(this._layerSorter))};this.removeLayer=function(c){a[c]&&(wade.removeObjectFromArray(a[c],b),b.sort(this._layerSorter),a[c].removeCanvas(),a[c]=null)};this.removeUnusedLayers=function(a){for(var c=b.length-1;0<=c;c--)!b[c].getSpriteCount()&&(!a||-1==a.indexOf(b[c].id))&&this.removeLayer(b[c].id)};
this.getActiveLayerIds=function(){return wade.cloneArray(b)};this.init=function(a){e=a;a=document.getElementById(wade.getContainerName());c=parseInt(a.getAttribute("width"));d=parseInt(a.getAttribute("height"))};this.draw=function(a,l){var n,k,m;if(e.getSimulationDirtyState()||a||l){wade.numDrawCalls=0;var z=wade.logDrawTime&&console.time&&console.timeEnd&&0.02>Math.random();z&&console.time("Draw");var w=document.getElementById(wade.getContainerName()),x=wade.getForcedOrientation();n=wade.getContainerWidth();
k=wade.getContainerHeight();var F=q;switch(x){case "landscape":k>n&&(q=!q);break;case "portrait":n>k&&(q=!q);break;default:q=!1}if(q!=F){var A=q?"rotateZ(90deg)":"translate3d(0, 0, 0)";w.style.MozTransform=A;w.style.msTransform=A;w.style.OTransform=A;w.style.webkitTransform=A;w.style.transform=A}A=!1;n=wade.getContainerWidth();k=wade.getContainerHeight();var G=u!=n||t!=k;if(G){var s={width:n,height:k};e.processEvent("onContainerResize",s)||wade.app.onContainerResize&&wade.app.onContainerResize(s)}var B,
D;if("full"==f){var s=c,C=d;c=Math.max(Math.min(n,g),h);d=Math.max(Math.min(k,i),j);c>n||d>k?c/n>d/k?(d=Math.max(Math.min(Math.min(d,k)*c/n,i),j),B=n+"px",D=Math.floor(n*d/c)+"px"):(c=Math.max(Math.min(Math.min(c,n)*d/k,g),h),B=Math.floor(k*c/d)+"px",D=k+"px"):c<n&&d<k?c/n>d/k?(D=Math.floor(n*d/c)+"px",B=n+"px"):(D=k+"px",B=Math.floor(k*c/d)+"px"):(D=d+"px",B=c+"px");if(s!=c||C!=d)w.setAttribute("width",c.toString()),w.setAttribute("height",d.toString()),e.onResize(s,C,c,d),A=!0}else"stretch to fit"==
f?n/c>k/d?(B=Math.floor(k*c/d)+"px",D=n+"px"):(B=n+"px",D=Math.floor(n*d/c)+"px"):"container"==f&&(s=c,C=d,c=w.getAttribute("width"),d=w.getAttribute("height"),A=s!=c||C!=d,B=c+"px",D=d+"px",A&&(m=!0,e.onResize(s,C,c,d)));if(m=m||B&&D&&(B!=w.style.width||D!=w.style.height)||q!=F||q&&G)w.style.width=B,w.style.height=D,q?"landscape"==x?(x=getComputedStyle(w),x=(parseInt(x.marginLeft)+parseInt(x.marginRight))/2,w.style.marginLeft=x+"px",w.style.marginTop="auto"):"portrait"==x&&(x=getComputedStyle(w),
x=(parseInt(x.marginTop)+parseInt(x.marginBottom))/2,w.style.marginTop=x+"px",w.style.marginLeft="auto"):w.style.margin="auto";t=k;u=n;x={};for(n=0;n<b.length;n++)if(k=b[n],1!=k.getResolutionFactor()&&B&&D&&B==D&&"auto"==B?k.setCanvasStyleSize(w.getAttribute("width")+"px",w.getAttribute("height")+"px"):m&&k.setCanvasStyleSize(B,D),A&&k.resize(c,d),!a||!("number"==typeof a&&a!=k.id||a.indexOf&&-1==a.indexOf(k.id)))F=k.getCanvas().id,x[F]=x[F]||l||k.hasAnythingChanged();for(n=0;n<b.length;n++)k=b[n],
x[k.getCanvas().id]&&k.draw(l);z&&(console.timeEnd("Draw"),console.log("Number of draw calls: "+wade.numDrawCalls));e.clearSimulationDirtyState()}};this.addSprite=function(a){a.getLayer().addSprite(a)};this.removeSprite=function(a){a.getLayer().removeSprite(a)};this._layerSorter=function(a,b){return b.id-a.id};this.getLayer=function(b,c){this._createLayerIfNeeded(b,c);return a[b]};this.getLayerSorting=function(b){return a[b].getSorting()};this.setLayerSorting=function(b,c){this._createLayerIfNeeded(b);
...
position:h.relativeWorldPosition,screenPosition:g,topLayer:h.topLayer,button:b.button,value:b.value,pointerId:b.pointerId||0},d.push(f))}d.sort(this.eventListenersSorter);break;default:for(e=c[a].length-1;0<=e;e--)f=c[a][e],f.eventResponse=b,d.push(f)}return d};this.eventListenersSorter=function(a,b){return a.eventResponse.topLayer-b.eventResponse.topLayer||-wade.getLayer(a.eventResponse.topLayer).compareSprites(a.getSprite(a.eventResponse.spriteIndex),b.getSprite(b.eventResponse.spriteIndex))};this.isObjectListeneningForEvent=
function(a,b){var d=c[b];return!!(d&&0<=d.indexOf(a))};this.onResize=function(b,c,d,e){for(var f=0;f<a.length;f++){var g=a[f],h=g.getPosition(),i=g.getAlignment(),r=0,n=0;switch(i.x){case "right":r=(d-b)/2;break;case "left":r=-(d-b)/2}switch(i.y){case "top":n=-(e-c)/2;break;case "bottom":n=(e-c)/2}g.setPosition(h.x+r,h.y+n);if(g.isMoving()&&(r||n))(h=g.getTargetPosition())&&g.moveTo(h.x+r,h.y+n,g.getMovementSpeed())}b={width:d,height:e};this.processEvent("onResize",b)||wade.app.onResize&&wade.app.onResize(b)};
...
c._behaviorClasses=wade.cloneArray(this._behaviorClasses);c._behaviors=[];if(c._behaviorClasses)for(d=0;d<c._behaviorClasses.length;d++){if("function"==typeof this._behaviors[d].clone)c._behaviors[d]=this._behaviors[d].clone(c);else{c._behaviors[d]=new this._behaviorClasses[d];for(var f in this._behaviors[d])if(this._behaviors[d].hasOwnProperty(f))if(e=typeof this._behaviors[d][f],this._behaviors[d][f]&&"object"==e)c._behaviors[d][f]=wade.isArray(this._behaviors[d][f])?wade.cloneArray(this._behaviors[d][f]):
wade.cloneObject(this._behaviors[d][f]);else if("function"!=e||!c._behaviors[d][f])c._behaviors[d][f]=this._behaviors[d][f]}c._behaviors[d].owner=c}if("undefined"!=typeof a||"undefined"!=typeof b)"undefined"==typeof a&&(a=this._position.x),"undefined"==typeof b&&(b=this._position.y),c.setPosition(a,b);this.simulated&&(c.simulated=!1,wade.simulateSceneObject(c,!0));return c};
SceneObject.prototype.toGrid=function(a,b,c,d){var e,f,c=c||0,d=d||0,g=this._position,i=Infinity;f=Infinity;var h=-Infinity,j=-Infinity;for(e=0;e<this.getSpriteCount();e++){var l=this.getSprite(e),k=this.getSpriteOffset(e),l=l.getSize(),i=Math.min(i,k.x-l.x/2);f=Math.min(f,k.y-l.y/2);h=Math.max(h,k.x+l.x/2);j=Math.max(j,k.y+l.y/2)}i=h-i;j-=f;h=[[this]];for(e=1;e<=a;e++){h[e-1]=h[e-1]||[];for(f=1;f<=b;f++)1==e&&1==f||(k=this.clone(g.x+(e-1)*(i+c),g.y+(f-1)*(j+d)),wade.addSceneObject(k),h[e-1].push(k))}return h};
...
if(this._behaviors[d].serialize)h=this._behaviors[d].serialize();else{h={};for(var j in this._behaviors[d])if(this._behaviors[d].hasOwnProperty(j)&&"_"!=j[0]&&"name"!=j)try{var l=JSON.stringify(this._behaviors[d][j]);h[j]=JSON.parse(l)}catch(k){}}f={name:f};h&&(f.properties=h);e.behaviors.push(f)}}for(d=0;d<this._spriteOffsets.length;d++)e.spriteOffsets.push({x:"number"==typeof this._spriteOffsets[d].originalX?this._spriteOffsets[d].originalX:this._spriteOffsets[d].x,y:"number"==typeof this._spriteOffsets[d].originalY?
this._spriteOffsets[d].originalY:this._spriteOffsets[d].y,angle:this._spriteOffsets[d].angle});for(d=0;d<this._sprites.length;d++)e.sprites.push(this._sprites[d].serialize());d=["autoListen","addToSceneParams","simulated","eventResponse","flowChartStatus"];b&&(d=d.concat(b));for(var m in this)if(this.hasOwnProperty(m)&&"_"!=m[0]&&-1==d.indexOf(m))if(c&&"function"==typeof this[m])e.functions=e.functions||{},e.functions[m]=this[m].toString();else try{var q=JSON.stringify(this[m]);e.properties[m]=JSON.parse(q)}catch(u){}for(d=
...
a.boundingBox):wade.orientedBoxIntersectsBox(a.orientedBoundingBox,this.boundingBox);if("pixel"==b){var g,i,h,j,l,k,m;this instanceof TextSprite?(this.isCached()||this.cache(),e={x:0,y:0},i=this.getSize(),h={x:0,y:0},g=this.getImageName(),wade.setImage(g,this.getCachedImage()),g=wade.getImageData(g)):(g=this._animations[this._currentAnimation],e=g.getFrameCorner(),i=g.getFrameSize(),h=g.getOffset_ref(),g=wade.getImageData(g.getRelativeImageName()));a instanceof TextSprite?(a.isCached()||a.cache(),
l={x:0,y:0},k=a.getSize(),m={x:0,y:0},j=a.getImageName(),wade.setImage(j,a.getCachedImage()),j=wade.getImageData(j)):(j=a.getCurrentAnimation(),l=j.getFrameCorner(),k=j.getFrameSize(),m=j.getOffset(),j=wade.getImageData(j.getRelativeImageName()));for(var q=a.getPosition(),u=a.getSize(),t=l.y;t<l.y+k.y;t++)for(var p=l.x;p<l.x+k.x;p++)if(j.data[4*(p+t*j.width)+3]){var r={x:p-l.x,y:t-l.y};wade.vec2.mulInPlace(r,wade.vec2.div(u,k));wade.vec2.subInPlace(r,wade.vec2.scale(u,0.5));f&&wade.vec2.rotateInPlace(r,
...
"",pixelShaderUniforms:this._pixelShaderUniforms?wade.cloneObject(this._pixelShaderUniforms):null,pixelPerfectMouseEvents:this._pixelPerfectMouseEvents||0,properties:{}};this._sizeWasSet&&!(1==this._size.x&&1==this._size.y)&&(c.size={x:this._size.x,y:this._size.y});for(var d in this._animations)this._animations.hasOwnProperty(d)&&!this._animations[d].isDefault&&(c.animations[d]=this._animations[d].serialize());d="sceneObject boundingBox orientedBoundingBox id needsDrawing uniformTypeNames".split(" ");
...
Sprite.prototype.isOnScreen=function(){if(!this.boundingBox||!this._sceneObject||!this._sceneObject.isInScene()||!this._visible)return!1;var a=wade.getScreenWidth()/2,b=wade.getScreenHeight()/2;return wade.boxIntersectsBox({minX:-a,minY:-b,maxX:a,maxY:b},wade.worldBoxToScreen(this._layer.id,this.boundingBox))};Sprite.prototype.isUsingBatchableDraw=function(){return this.draw.batched&&(!this._shaderProgram||this._shaderProgram==this._layer.getDefaultShaderProgram())};Sprite.prototype.getLayer=function(){return this._layer};
Sprite.prototype.onAnimationStart=function(a,b){this._sceneObject&&this._sceneObject.processEvent("onAnimationStart",{name:a,restarting:b})};Sprite.prototype.onAnimationEnd=function(a){this._sceneObject&&this._sceneObject.processEvent("onAnimationEnd",{name:a})};
...
0,a)};TextSprite.prototype.draw_gl=function(a){a.isWebGl?this._visible&&this._text&&(this._image||this.cache(),this._activeImage=this._cachedImageName,this._cornerX=this.boundingBox.minX,this._cornerY=this.boundingBox.minY,Sprite.prototype.draw_gl.call(this,a)):TextSprite.prototype.draw_2d.call(this,a)};TextSprite.prototype.draw=TextSprite.prototype.draw_gl;TextSprite.prototype.step=function(){};TextSprite.prototype.playAnimation=function(){};
TextSprite.prototype.setSceneObject=function(a){this._sceneObject=a};
...
g[i].split(" "),j=1,l;0<h.length&&j<=h.length;)if(l=h.slice(0,j).join(" "),c.measureText(l).width+this._outlineWidth>this._maxWidth&&0<this._maxWidth){1==j&&(j=2);l=h.slice(0,j-1).join(" ");if(!this._maxLines||f<this._maxLines)a&&(c.fillText(l,this._position.x,this._position.y+this._lineHeight*this._lineSpacing*f),this._outlineWidth&&c.strokeText(this._text,this._position.x,this._position.y)),b&&b.push({width:c.measureText(l).width+this._outlineWidth,text:l});f++;h=h.splice(j-1);j=1}else j++;if(0<
j&&(!this._maxLines||f<this._maxLines))l=h.join(" "),a&&(c.fillText(l,this._position.x,this._position.y+this._lineHeight*this._lineSpacing*f),this._outlineWidth&&c.strokeText(this._text,this._position.x,this._position.y)),b&&b.push({width:c.measureText(l).width+this._outlineWidth,text:l}),f++}this._numLines=f}this._shadowColor&&(c.shadowColor="rgba(0, 0, 0, 0)");this._outlineWidth&&(c.strokeStyle=d,c.lineWidth=e);this._rotation&&c.restore()};TextSprite.prototype.getCachedImage=function(){return this._image};
function Wade(){var a=this,b=0,c=0,d=0,e=0,f=0,g=0,i=!1,h=!1,j="",l=1,k=[],m=[],q=0,u=1,t="none",p=new Image,r=[],n={},y=[],v,z,w,x,F,A,G,s,B=!0,D=!0,C={},H={},E=[],K=0,N=!0,P={}.hasOwnProperty.toString,R=P.call(Object),O=1,L="wade_main_div",M=!1,I={straight:[{x:-1,y:-1},{x:-1,y:1},{x:1,y:-1},{x:1,y:1}],diagonal:[{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}],both:[{x:-1,y:-1},{x:-1,y:1},{x:1,y:-1},{x:1,y:1},{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}]};I["top-down straight"]=I.diagonal;I["top-down diagonal"]=
I.straight;I["iso straight"]=I.straight;I["iso diagonal"]=I.diagonal;p.src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVQIW2NkAAIAAAoAAggA9GkAAAAASUVORK5CYII=";this.app=0;this.c_timeStep=1/60;this.defaultLayer=1;this._appData=0;this.c_epsilon=1E-4;this.init=function(a,f,g){var g=g||{},h=g.forceReload,i=g.updateCallback;A=g.forceWebGl;var p=g.container;D="undefined"!=typeof g.globalUnderscore?!!g.globalUnderscore:!0;L=p||"wade_main_div";var l=function(){var a=window.applicationCache;
if(a)if(a.status==a.UPDATEREADY)wade.log("a new version of the app is available"),i?i():(alert("A new version is available.\nPlease press OK to restart."),a.swapCache(),window.location.reload(!0),window.location=window.location);else{try{a.update()}catch(b){}a.addEventListener("updateready",l,!1)}};l();a&&(j=a.substr(0,Math.max(a.lastIndexOf("/"),a.lastIndexOf("\\"))+1));for(var n=0,p=["ms","moz","webkit","o"],k=0;k<p.length&&!window.requestAnimationFrame;k++)window.requestAnimationFrame=window[p[k]+
"RequestAnimationFrame"],window.cancelAnimationFrame=window[p[k]+"CancelAnimationFrame"]||window[p[k]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(a){var b=(new Date).getTime(),c=Math.max(0,16-(b-n)),d=window.setTimeout(function(){a(b+c)},c);n=b+c;return d});window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)});p="undefined"==typeof g.audio||g.audio;s=g.audioContext;if(p&&!s){try{window.AudioContext=window.AudioContext||
window.webkitAudioContext;s=new AudioContext;var r=XMLHttpRequest&&"string"===typeof(new XMLHttpRequest).responseType}catch(y){}r||wade.warn("Warning: the WebAudio API is not supported in this environment. Audio functionality will be limited")}c=new AssetLoader;c.init(!1);d=new AssetLoader;d.init(!0);b=new SceneManager;b.init();e=new InputManager;("undefined"==typeof g.input||g.input)&&e.init();w=document.createElement("canvas");w.width=w.height=256;x=w.getContext("2d");this.proceduralImages.init();
G=!!g.debug;this._appData=f?f:{};a?c.loadAppScript(a,h):window.App?this.instanceApp():wade.warn("Warning - App is not defined.");this.event_mainLoop()};this.stop=function(){f&&cancelAnimationFrame(f);g&&clearTimeout(g);this.setLoadingImages([]);wade.stopInputEvents()};this.stopInputEvents=function(){e.deinit()};this.restartInputEvents=function(){e.init()};this.cancelInputEvents=function(a){e.cancelEvents(a)};this.getBasePath=function(){return j};this.setBasePath=function(a){j=a||""};this.getFullPathAndFileName=
function(a){if(!a||"procedural_"==a.substr(0,11)||j&&a.substr(0,j.length)==j)return a;var b=a[0];return"\\"==b||"/"==b||-1!=a.indexOf(":")?a:j+a};this.loadScript=function(a,b,d,e,f){a=this.getFullPathAndFileName(a);c.loadScript(a,b,d,e,f)};this.preloadScript=function(a,b,c,e,f){a=this.getFullPathAndFileName(a);d.loadScript(a,b,c,e,f)};this.getScript=function(a){a=this.getFullPathAndFileName(a);return c.getScript(a)};this.setScript=function(a,b,e){a=this.getFullPathAndFileName(a);c.setScript(a,b);
...
function(a){a=this.getFullPathAndFileName(a);c.unloadImage(a);d.unloadImage(a);delete C[a]};this.unloadAllImages=function(){c.unloadAllImages();d.unloadAllImages();C=[]};this.getImage=function(a,b){if(a){var d=this.getFullPathAndFileName(a);return c.getImage(d,b)}return p};this.setImage=function(a,e,f){a=this.getFullPathAndFileName(a);c.setImage(a,e);f&&d.setImage(a,e);delete C[a];b.renderer.updateImageUsers(a)};this.loadAudio=function(a,b,d,e,f){a=this.getFullPathAndFileName(a);c.loadAudio(a,b,d,
...
a;e.connect(s.destination);e.endEventFired=!1;e.onended=function(){e.endEventFired=!0;d&&(d(),d=null)};e.start(b);if(d){var f=function(){e.playbackState!=e.FINISHED_STATE?setTimeout(f,wade.c_timeStep):e.onended&&!e.endEventFired&&(e.endEventFired=!0,e.onended())};e.checkEnded=setTimeout(f,1E3*(e.buffer.duration-b)+wade.c_timeStep)}c&&e.stop(c);r.push(e)}else c=c||a.duration,a.alreadyPlayed&&!a.ended&&(a=new Audio(a.src)),a.addEventListener("timeupdate",function(){this.currentTime>=c&&(this.pause(),
...
this.instanceApp=function(){this.app=new App;this.app.appData=this._appData;this.app.load&&this.app.load();i=!1;h=!0};this.initializeApp=function(){i=!0;this.app.init?this.app.init():wade.warn("Warning: Unable to initialize app. App.init function is missing.");g=setTimeout(function(){wade.event_appTimerEvent()},1E3*l)};this.getGamepadData=function(){return e.getGamepadData()};this.processEvent=function(a,c){return b.processEvent(a,c)};this.addEventListener=function(a,c){b.addEventListener(a,c)};this.removeEventListener=
...
window.performance.now?window.performance.now():(new Date).getTime()};this.setAppTimerInterval=function(a){l=a};this.removeObjectFromArrayByIndex=function(a,b){if(0<=a){var c=b.slice(a+1||b.length);b.length=a;return b.push.apply(b,c)}return b};this.removeObjectFromArray=function(a,b){var c=b.lastIndexOf(a);return-1!=c?this.removeObjectFromArrayByIndex(c,b):b};this.addSceneObject=function(a,c,d){"undefined"==typeof c&&(c=!0);b.addSceneObject(a,c,d);return a};this.removeSceneObject=function(a){b.removeSceneObject("string"==
...
c>=-a.halfHeight&&c<=a.halfHeight};this.orientedBoxIntersectsOrientedBox=function(a,b){var c=b.centerX-a.centerX,d=b.centerY-a.centerY,e=a.axisXx,f=a.axisXy,g=a.axisYx,h=a.axisYy,i=b.axisXx,j=b.axisXy,p=b.axisYx,l=b.axisYy;return!(Math.abs(c*e+d*f)>e*e+f*f+Math.abs(i*e+j*f)+Math.abs(p*e+l*f)||Math.abs(c*g+d*h)>g*g+h*h+Math.abs(i*g+j*h)+Math.abs(p*g+l*h)||Math.abs(c*i+d*j)>i*i+j*j+Math.abs(i*e+j*f)+Math.abs(i*g+j*h)||Math.abs(c*p+d*l)>p*p+l*l+Math.abs(p*e+l*f)+Math.abs(p*g+l*h))};this.boxIntersectsOrientedBox=
function(a,b){var c=(a.minX+a.maxX)/2-b.centerX,d=(a.minY+a.maxY)/2-b.centerY,e=(a.maxX-a.minX)/2,f=(a.maxY-a.minY)/2,g=b.axisXx,h=b.axisXy,i=b.axisYx,j=b.axisYy;return!(Math.abs(c*e)>e*e+Math.abs(g*e)+Math.abs(i*e)||Math.abs(d*f)>f*f+Math.abs(h*f)+Math.abs(j*f)||Math.abs(c*g+d*h)>g*g+h*h+Math.abs(g*e)+Math.abs(h*f)||Math.abs(c*i+d*j)>i*i+j*j+Math.abs(i*e)+Math.abs(j*f))};this.orientedBoxIntersectsBox=function(a,b){return this.boxIntersectsOrientedBox(b,a)};this.expandBox=function(a,b){a.minX=Math.min(a.minX,
...
function(a){c.setGlobalCallback(a)};this.setMainLoop=function(a,b,c){for(var b=b||"_wade_default",d=0;d<m.length&&m[d].name!=b;d++);m[d]={func:a,name:b,priority:c||0};m.sort(function(a,b){return b.priority-a.priority})};this.setLoadingImages=function(a,b){for(var c=0;c<k.length;c++)document.body.removeChild(k[c]);k.length=0;wade.isArray(a)||(a=[a]);for(c=0;c<a.length;c++){var d=document.createElement("img");d.className="loadingImage_class";d.style.display="none";var e=document.getElementById("container");
document.body.insertBefore(d,e);d.src=this.getFullPathAndFileName(a[c]);k.push(d);b&&d.addEventListener("click",function(){window.open(b,"_blank")})}};this.worldPositionToScreen=function(a,c){return b.renderer.worldPositionToScreen(a,c)};this.worldDirectionToScreen=function(a,c){return b.renderer.worldDirectionToScreen(a,c)};this.worldBoxToScreen=function(a,c){return b.renderer.worldBoxToScreen(a,c)};this.worldUnitToScreen=function(a){return b.renderer.worldUnitToScreen(a)};this.screenPositionToWorld=
...
"_wade_cameraTarget")};this.setCameraBounds=function(a,b,c,d,e,f){var g="undefined"==typeof a||null===a,h="undefined"==typeof c||null===c,i="undefined"==typeof e||null===e,j="undefined"==typeof b||null===b,p="undefined"==typeof d||null===d,l="undefined"==typeof f||null===f;g&&h&&i&&j&&p&&l?this.setMainLoop(null,"_wade_cameraBounds"):this.setMainLoop(function(){var n=wade.getCameraPosition();!g&&(n.x=Math.max(a,n.x));!h&&(n.y=Math.max(c,n.y));!i&&(n.z=Math.max(e,n.z));!j&&(n.x=Math.min(b,n.x));!p&&
(n.y=Math.min(d,n.y));!l&&(n.z=Math.min(f,n.z));wade.setCameraPosition(n)},"_wade_cameraBounds",-1)};this.getObjectsInArea=function(a,c){var d=[];b.renderer.addObjectsInAreaToArray(a,d,c);return d};this.getObjectsInScreenArea=function(a){var c=[];b.renderer.addObjectsInScreenAreaToArray(a,c);return c};this.getSpritesInArea=function(a,c,d){var e=[];b.renderer.addSpritesInAreaToArray(a,e,c,d);return e};this.getSpritesInScreenArea=function(a){if(!a)var a=this.getScreenWidth()/2,c=this.getScreenHeight()/
2,a={minX:-a,minY:-c,maxX:a,maxY:c};c=[];b.renderer.addSpritesInScreenAreaToArray(a,c);return c};this.getSceneObject=function(a){return(a=b.getObjectByName(a))&&a instanceof SceneObject?a:null};this.getSceneObjects=function(a,c){return b.getSceneObjects(a,c)};this.getImageData=function(a,b,d,e,f){var g=this.getFullPathAndFileName(a);if(C[g]&&!b&&!d&&!e&&!f)return C[g];var h=c.getImage(g),i;if(h.getContext)i=h.getContext("2d");else{var j=h,h=document.createElement("canvas");h.width=j.width;h.height=
j.height;i=h.getContext("2d");i.drawImage(j,0,0);wade.setImage(a,h)}b=b||0;d=d||0;e=e||h.width;f=f||h.height;a=!b&&!d&&e==h.width&&f==h.height;if(C[g]&&a)return C[g];b=i.getImageData(b,d,e,f);C[g]=a?b:i.getImageData(0,0,h.width,h.height);return b};this.putImageData=function(a,d,e,f,g,h,i,j){var e=e||0,f=f||0,g=g||0,h=h||0,i=i||d.width,j=j||d.height,p=this.getFullPathAndFileName(a),l,n;if("ok"==c.getLoadingStatus(p))if(l=c.getImage(p),l.getContext)n=l.getContext("2d");else{var k=l;l=document.createElement("canvas");
l.width=k.width;l.height=k.height;n=l.getContext("2d");n.drawImage(k,0,0);wade.setImage(a,l)}else l=document.createElement("canvas"),l.width=i,l.height=j,n=l.getContext("2d"),wade.setImage(a,l);n.putImageData(d,g,h,e,f,i,j);C[p]=n.getImageData(0,0,l.width,l.height);b.renderer.updateImageUsers(p)};this.enableMultitouch=function(a){"undefined"==typeof a&&(a=!0);e.enableMultitouch(a)};this.isMultitouchEnabled=function(){return e.isMultitouchEnabled()};this.getVersion=function(){return"3.8.1"};this.requireVersion=
function(a,b,c){for(var d=["3","8"],e=a.split("."),f=0;f<e.length;f++){var g=d[f]||0;if(g>e[f])break;else if(g<e[f]){c=c||"A newer version of WADE is required ("+a+")";switch(b){case "alert":alert(c);break;case "console":wade.log(c)}return!1}}return!0};this.getLoadingPercentage=function(){return c.getPercentageComplete()};this.setLoadingBar=function(a,b,c,d){if(a){var a=document.createElement("div"),e=document.createElement("div");a.style.backgroundColor=c||"red";a.style.borderRadius="13px";a.style.padding=
"3px";a.style.width="50%";a.style.height="20px";a.style.position="absolute";a.style.left=b?2*b.x+"px":0;a.style.right=0;a.style.top=b?2*b.y+"px":0;a.style.bottom=0;a.style.margin="auto";e.style.backgroundColor=d||"orange";e.style.borderRadius="10px";e.style.height="20px";e.style.width=0;a.appendChild(e);a.id="__wade_loading_bar";v=a;v.inner=e;document.body.appendChild(a)}else v&&document.body.removeChild(v),v=null};this.areGamepadsSupported=function(){return!(!navigator.webkitGetGamepads&&!navigator.getGamepads)};
this.enableGamepads=function(){e.enableGamepads()};this.getImageDataURL=function(a){var b=wade.getImage(a);if(b.toDataURL)return b.toDataURL();(new Sprite(a)).drawToImage(a,!0);return wade.getImage(a).toDataURL()};this.getLayerDataURL=function(a){return this.getLayer(a).toDataURL()};this.log=function(a){console.log(a)};this.warn=function(a){console.warn(a)};this.error=function(a){console.error(a)};this.forceRedraw=function(a){b.setSimulationDirtyState();b.renderer.forceRedraw(a)};this.forEachPixel=
function(a,b,c){for(var d=this.getImageData(a),e=0;e<d.width;e++)for(var f=0;f<d.height;f++){var g=4*(e+f*d.width),h=b(d.data[g],d.data[g+1],d.data[g+2],d.data[g+3],e,f);h&&(d.data[g]=h.r||0,d.data[g+1]=h.g||0,d.data[g+2]=h.b||0,d.data[g+3]=h.a||0)}wade.putImageData(c||a,d)};this.getLayerCanvas=function(a){return wade.getLayer(a||1).getCanvas()};this.drawLayerToImage=function(a,b,c,d,e,f,g){var h=wade.getLayerCanvas(a),i="__wade_layer"+a;wade.draw(a);var j=function(){var j=h;h=this;wade.setImage(i,
h);var p=new Sprite(i),l=1,n=1;if(wade.isSharedCanvas(j)||"2d"==wade.getLayerRenderMode(a))l=wade.getLayerOpacity(a),n=wade.getLayerResolutionFactor(a);1!=l&&p.setDrawFunction(wade.drawFunctions.alpha_(l,p.draw));e||(e={horizontalScale:1/n,verticalScale:1/n,horizontalSkew:0,verticalSkew:0,horizontalTranslate:0,verticalTranslate:0});p.drawToImage(b,c,d,e,f,"2d");g&&setTimeout(g,0)};if("webgl"==wade.getLayerRenderMode(a)){var p=h.toDataURL(),l=new Image;l.onload=j;l.src=p}else j.call(h)};this.screenCapture=
function(a,c){wade.draw();wade.createTransparentImage(a,wade.getScreenWidth(),wade.getScreenHeight());var d=b.renderer.getActiveLayerIds();if(d.length){var e=0,f=0,g=function(b){return function(){j[b].canvas=this;if(++e==f){for(var d in j){var g="__wade_layer_"+d;wade.setImage(g,j[d].canvas);var h=new Sprite(g),i=j[d].opacity;1!=i&&h.setDrawFunction(wade.drawFunctions.alpha_(i,h.draw));i=j[d].resolution;h.drawToImage(a,!1,null,{horizontalScale:1/i,verticalScale:1/i,horizontalSkew:0,verticalSkew:0,
horizontalTranslate:0,verticalTranslate:0},"","2d");wade.unloadImage(g)}c&&setTimeout(c,0)}}},h,i,j={};for(h=0;h<d.length;h++)if(i=wade.getLayerCanvas(d[h]),!j[i.id]){f++;var p=1,l=1;if(wade.isSharedCanvas(i)||"2d"==wade.getLayerRenderMode(d[h]))p=wade.getLayerOpacity(d[h]),l=wade.getLayerResolutionFactor(d[h]);j[i.id]={canvas:i,opacity:p,resolution:l}}for(var n in j)i=j[n].canvas,d=i.toDataURL(),h=new Image,h.onload=g(n),h.src=d}else setTimeout(c,0)};this.setLayerOpacity=function(a,b){this.getLayer(a).setOpacity(b)};
this.getLayerOpacity=function(a){a=parseFloat(this.getLayer(a).getOpacity());return isNaN(a)?1:a};this.getContainerName=function(){return L};this.fadeInLayer=function(a,b,c){var d="__wade_fadeLayer_"+a;wade.setLayerOpacity(a,0);this.setMainLoop(function(){var e=wade.getLayerOpacity(a),e=Math.min(1,e+wade.c_timeStep/b);1-e<wade.c_epsilon&&(e=1);wade.setLayerOpacity(a,e);1==e&&(wade.setMainLoop(null,d),c&&c())},d)};this.fadeOutLayer=function(a,b,c){var d="__wade_fadeLayer_"+a;wade.setLayerOpacity(a,
1);this.setMainLoop(function(){var e=wade.getLayerOpacity(a),e=Math.max(0,e-wade.c_timeStep/b);e<wade.c_epsilon&&(e=0);wade.setLayerOpacity(a,e);0==e&&(wade.setMainLoop(null,d),c&&c())},d)};this.clearCanvas=function(a){this.getLayer(a).clear()};this.draw=function(a){b.draw(a,!0)};this.exportScene=function(a,c,d){c={sceneObjects:b.exportSceneObjects(c,d),paths:b.exportPaths(c)};c.layers=b.renderer.getLayerSettings(!0);c.minScreenSize={x:wade.getMinScreenWidth(),y:wade.getMinScreenHeight()};c.maxScreenSize=
{x:wade.getMaxScreenWidth(),y:wade.getMaxScreenHeight()};c.orientation=wade.getForcedOrientation();c.windowMode=wade.getWindowMode();c.defaultLayer=wade.defaultLayer||1;return a?JSON.stringify(c):c};this.importScene=function(a,b,c,d,e){M=!0;b&&wade.setLoadingBar(!0,b.position,b.backColor,b.foreColor);var f=a.sceneObjects,g=a.paths,b=a.images||[];if(f)for(var h=0;h<f.length;h++)if(f[h].sprites)for(var i=0;i<f[h].sprites.length;i++)if(f[h].sprites[i].image&&-1==b.indexOf(f[h].sprites[i].image)&&"procedural_"!=
f[h].sprites[i].image.substr(0,11)&&b.push(f[h].sprites[i].image),f[h].sprites[i].animations)for(var j in f[h].sprites[i].animations)if(f[h].sprites[i].animations.hasOwnProperty(j)){var p=f[h].sprites[i].animations[j].image;p&&"procedural_"!=p.substr(0,11)&&-1==b.indexOf(p)&&b.push(p)}var l=0,n=b.length,k=function(){if(++l==n){e&&wade.clearScene();if(a.scripts)for(var b=0;b<a.scripts.length;b++)try{eval.call(window,wade.getScript(a.scripts[b]))}catch(c){wade.error("Unable to execute script "+a.scripts[b]+
" - "+c.message)}a.minScreenSize&&wade.setMinScreenSize(a.minScreenSize.x,a.minScreenSize.y);a.maxScreenSize&&wade.setMaxScreenSize(a.maxScreenSize.x,a.maxScreenSize.y);a.windowMode&&wade.setWindowMode(a.windowMode);a.orientation&&wade.forceOrientation(a.orientation);if(a.layers)for(b=0;b<a.layers.length;b++)if(a.layers[b]){var d="number"!=typeof a.layers[b].scaleFactor?1:a.layers[b].scaleFactor,h="number"!=typeof a.layers[b].translateFactor?1:a.layers[b].translateFactor,j="undefined"!=typeof a.layers[b].useQuadtree?
a.layers[b].useQuadtree:!0,p="number"!=typeof a.layers[b].resolutionFactor?1:a.layers[b].resolutionFactor,k=a.layers[b].blur||0,Q=a.layers[b].postProcessShader||"",y=a.layers[b].postProcessShaderUniforms,m=a.layers[b].properties||{};wade.setLayerRenderMode(b,"2d"==a.layers[b].renderMode?"2d":"webgl",{offScreenTarget:!(!Q&&!k)});wade.setLayerTransform(b,d,h);wade.useQuadtree(b,j);wade.setLayerResolutionFactor(b,p);wade.setBlur(b,k);wade.setPostProcessShader(b,Q,y);wade.setLayerCustomProperties(b,m)}a.defaultLayer&&
(wade.defaultLayer=a.defaultLayer);if(g)for(b=0;b<g.length;b++)d=new Path(g[b]),wade.addPath(d);if(f){d={};for(b=0;b<f.length;b++)if(h=new SceneObject(f[b]),a.loadGlTextures)for(i=0;i<h.getSpriteCount();i++)if(p=h.getSprite(i),j=p.getLayerId(),"webgl"==wade.getLayerRenderMode(j)){d[j]=d[j]||[];p=p.getAllImageNames();for(k=0;k<p.length;k++)-1==d[j].indexOf(p[k])&&d[j].push(p[k])}for(var v in d){h=wade.getLayer(v).getContext();for(b=0;b<d[v].length;b++)h.setTextureImage(wade.getImage(d[v][b]),!0)}}if(a.modules)if(b=
function(){++l==n&&r()},Object.keys(a.modules).length)for(var J in a.modules)a.modules.hasOwnProperty(J)&&(wade[J]&&wade[J].importScene?(n++,wade[J].importScene(a.modules[J],b)):(wade.error("The scene being imported contains data for module "+J+", but the module isn't available or not up to date"),n++,setTimeout(b,0)));else r();else r()}},r=function(){setTimeout(function(){M=!1;a.timeline&&wade.startTimeline(a.timeline);a.flowChart&&wade.runFlowChart(a.flowChart);c&&c()},0)},y=function(a){return function(){wade.error(a);
k()}},m=d?"pre":"";if(a.json){var n=n+a.json.length,v={};a.json.forEach(function(a){if("object"==typeof a)var b=a.resource,c=a.target;else b=a;a=b+"___"+c;v[a]?n--:(wade[m+"loadJson"](b,null,function(a){c&&(wade.app[c]=wade.isArray(a)?wade.cloneArray(a):wade.cloneObject(a));k()},!1,y("Failed to load JSON file "+b)),v[a]=!0)})}if(a.text){var n=n+a.text.length,x={};a.text.forEach(function(a){if("object"==typeof a)var b=a.resource,c=a.target;else b=a;a=b+"___"+c;x[a]?n--:(wade[m+"loadText"](b,null,function(a){c&&
(wade.app[c]=a);k()},!1,y("Failed to load text file "+b)),x[a]=!0)})}if(a.audio&&(!a.webAudioOnly||wade.isWebAudioSupported())){n+=a.audio.length;for(h=0;h<a.audio.length;h++)if(a.audio.indexOf(a.audio[h])==h)wade[m+"loadAudio"](a.audio[h],!1,!1,k,y("Failed to load audio file "+a.audio[h]));else n--}if(a.fonts){n+=a.fonts.length;for(h=0;h<a.fonts.length;h++)if(a.fonts.indexOf(a.fonts[h])==h)wade[m+"loadFont"](a.fonts[h],k,y("Failed to load font file "+a.fonts[h]));else n--}if(a.scripts){n+=a.scripts.length;
for(h=0;h<a.scripts.length;h++)if(a.scripts.indexOf(a.scripts[h])==h)wade[m+"loadScript"](a.scripts[h],k,!1,y("Failed to load script file "+a.scripts[h]),!0);else n--}if(b.length)for(h=0;h<b.length;h++)if(b.indexOf(b[h])==h)wade[m+"loadImage"](b[h],k,y("Failed to load image file "+b[h]));else n--;n||(n=1,k())};this.loadScene=function(a,b,c,d){wade.loadJson(a,null,function(a){wade.importScene(a,b,c,!1,d)})};this.preloadScene=function(a,b,c,d){wade.preloadJson(a,null,function(a){wade.importScene(a,
b,c,!0,d)})};this.useQuadtree=function(a,b){"undefined"==typeof b&&(b=!0);this.getLayer(a).useQuadtree(b)};this.isUsingQuadtree=function(a){return this.getLayer(a).isUsingQuadtree()};this.pauseSimulation=function(a){if(a)for(var b=0;b<m.length;b++){if(m[b].name==a){m[b].paused=!0;break}}else z=!0};this.resumeSimulation=function(a){var b;if(a)for(b=0;b<m.length;b++){if(m[b].name==a){m[b].paused=!1;break}}else{for(b=0;b<m.length;b++)m[b].paused=!1;z=!1}};this.setCatchUpBuffer=function(a){O=a};this.getCatchUpBuffer=
function(){return O};this.preventIframe=function(){if(!window.location||!window.top.location||!location||!top.location||window.location!==window.top.location||location!==top.location)wade=0};this.siteLock=function(a){var b="localhost";try{b=top.location.hostname}catch(c){try{b=this.getHostName(top.location.origin)}catch(d){try{b=this.getHostName(top.location.href)}catch(e){}}}b=b.toLowerCase();b!=a.toLowerCase()&&("localhost"!=b&&"127.0.0.1"!=b)&&(wade=0)};this.getHostName=function(a){var b=URL||
...
this.blacklistReferrers=function(a){var b=document.referrer;if(b&&(b=this.getHostName(b))){var c;if("string"==typeof a)c=[a.toLowerCase()];else if(wade.isArray(a)){c=[];for(var d=0;d<a.length;d++)c.push(a[d].toLowerCase())}else return;b&&-1!=c.indexOf(b.toLowerCase())&&(wade=0)}};this.removeLayer=function(a){b.renderer.removeLayer(a)};this.removeUnusedLayers=function(a){b.renderer.removeUnusedLayers(a)};this.setLayer3DTransform=function(a,b,c,d,e){this.getLayer(a).set3DTransform(b||"translate3d(0, 0, 0)",
c||"50% 50%",d,e)};this.skipMissedFrames=function(){q=(new Date).getTime()};this.getSceneObjectIndex=function(a){return b.getSceneObjectIndex(a)};this.setSceneObjectIndex=function(a,c){return b.setSceneObjectIndex(a,c)};this.setSwipeTolerance=function(a,b){e.setSwipeTolerance(a,b||3)};this.setLayerRenderMode=function(a,b,c){this.getLayer(a,b).setRenderMode(b,c)};this.getLayerRenderMode=function(a){return this.getLayer(a).getRenderMode()};this.isWebGlSupported=function(){if("undefined"!=typeof F)return!!F;
try{var a=document.createElement("canvas"),b=a.getContext("webgl",{failIfMajorPerformanceCaveat:!A})||a.getContext("experimental-webgl",{failIfMajorPerformanceCaveat:!A})}catch(c){return F=!1}return F=!!b};this.isDebugMode=function(){return!!G};this.getWebAudioContext=function(){return s};this.getActiveLayerIds=function(){return b.renderer.getActiveLayerIds()};this.hashString=function(a){var b,c,d,e=0;if(!a.length)return e;b=0;for(d=a.length;b<d;b++)c=a.charCodeAt(b),e=(e<<5)-e+c,e|=0;return e};this.createPseudoArray=
function(a,b){for(var c=[],d={isPseudoArray:!0},e=0;e<a;e++)(function(a){Object.defineProperty(d,a.toString(),{enumerable:!0,set:function(d){var e=a>=c.length;c[a]=d;b(a,d,e)},get:function(){return c[a]}})})(e);Object.defineProperty(d,"length",{enumerable:!0,set:function(a){for(var d=c.length-1;d>=a;d--)b(d);c.length=a},get:function(){return c.length}});d.push=function(){for(var a=0;a<arguments.length;a++){var d=c.push(arguments[a])-1;b(d,arguments[a],!0)}};return d};this.autoLoadImages=function(a){"undefined"==
typeof a&&(a=!0);B=a};this.isAutoLoadingImages=function(){return B};this.addPath=function(a){b.addPath(a)};this.removePath=function(a){b.removePath("string"==typeof a?this.getPath(a):a)};this.getPaths=function(a,c){return b.getPaths(a,c)};this.getPath=function(a){return(a=b.getObjectByName(a))&&a instanceof Path?a:null};this.getKeyName=function(a){return e.getKeyName(a)};this.getKeyCode=function(a){return e.getKeyCode(a)};this.isArray=function(a){return Array.isArray(a)};this.ajax=function(a){var a=
a||{},b=a.type||"GET",c=a.url;if(c){"undefined"!=typeof a.cache&&!a.cache&&(c+=/\?/.test(c)?"&":"?"+(new Date).getTime());var d=function(){a.error&&a.error(this.responseText)},e=new XMLHttpRequest;e.addEventListener("load",function(){var b=this.responseText;if(a.dataType)switch(a.dataType){case "json":try{b=JSON.parse(b)}catch(c){wade.error("Failed to load JSON data from "+a.url+" : "+c);a.error&&a.error(b);return}}a.success&&a.success(b)});e.addEventListener("error",d);e.open(b,c);a.timeout&&(e.addEventListener("timeout",
d),e.timeout=a.timeout);a.contentType&&e.setRequestHeader("Content-type",a.contentType);e.send(a.data||null)}else wade.error("Invalid ajax request - url was not specified")};this.startTimeline=function(b,c,d){b.events||(b.events=[]);c=c||0;d||(d=this.timelineUid=this.timelineUid+1||1,d="__wade_timeline_"+d,n[d]={timeline:b,time:c,active:!0});var e="clock"==b.referenceTime?this.getClockTime()/1E3:this.getAppTime(),f=function(){var f=("clock"==b.referenceTime?a.getClockTime()/1E3:a.getAppTime())-e+
c;n[d].time=f;for(var g=0,h=0;h<b.events.length;h++)if(!b.events[h].processed&&b.events[h].code&&(g++,f>=b.events[h].time)){b.events[h].processed=!0;var i="(function(){"+b.events[h].code+"})()";if(G){var j=y.length;y.push({time:b.events[h].time,code:b.events[h].code});i+="\n//# sourceURL=timeline_event_"+j+"_"+b.events[h].time+"s.js"}eval.call(window,i)}g||a.setMainLoop(null,d)};this.setMainLoop(f,d);f();return d};this.stopTimeline=function(a){n[a]&&(n[a].active=!1);this.setMainLoop(null,a)};this.resumeTimeline=
function(a){n[a].active=!0;this.startTimeline(n[a].timeline,n[a].time,a)};this.getProcessedTimelineEvent=function(a){return!G?(wade.error("Cannot call wade.getProcessedTimelineEvent when not in debug mode"),{time:0,code:""}):y[a||0]};this.clearTimelines=function(){for(var a in n)this.stopTimeline(a);n={}};this.createTransparentImage=function(a,b,c){var d=new Sprite;d.setDrawFunction(wade.doNothing);d.setSize(b,c);d.drawToImage(a,!0,null,null,"","2d")};this.getTimelines=function(){return n};this.setPostProcessShader=
function(a,b,c){this.getLayer(a).setPostProcessShader(b,c)};this.getPostProcessShader=function(a){return this.getLayer(a).getPostProcessShader()};this.getPostProcessShaderUniforms=function(a){return this.getLayer(a).getPostProcessShaderUniforms()};this.setLayerCustomProperty=function(a,b,c){this.getLayer(a).setCustomProperty(b,c)};this.setLayerCustomProperties=function(a,b){this.getLayer(a).setCustomProperties(b)};this.getLayerCustomProperty=function(a,b){return this.getLayer(a).getCustomProperty(b)};
this.getLayerCustomProperties=function(a){return this.getLayer(a).getCustomProperties()};this.setTimeout=function(b,c){if("function"==typeof c&&"number"==typeof b)var d=c,c=b,b=d;E.push({f:b,time:1E3*a.getAppTime()+c,uid:++K});return K};this.setInterval=function(b,c){if("function"==typeof c&&"number"==typeof b)var d=c,c=b,b=d;E.push({f:b,time:1E3*a.getAppTime()+c,repeat:c,uid:++K});return K};this.clearTimeout=function(a){for(var b=0;b<E.length;b++)if(E[b].uid==a&&!E[b].repeat)return wade.removeObjectFromArrayByIndex(b,
E),!0;return!1};this.clearInterval=function(a){for(var b=0;b<E[b];b++)if(E[b].uid==a&&E[b].repeat)return wade.removeObjectFromArrayByIndex(b,E),!0;return!1};this.clearAllTimeoutsAndIntervals=function(){var a=E.length;E.length=0;return!!a};this.runFlowChart=function(a,b,c,d,e){"undefined"==typeof c&&(c=!0);var d=d||0,f={visitedNodes:[],startTime:wade.getAppTime(),flowChartData:wade.cloneObject(a)},g=function(a){e&&e.isInScene&&!e.isInScene()||f.cancelled?(f.running=!1,e&&delete e.next):(a.func||(a.func=
j(a)),f.visitedNodes.push(a.uid),e&&(e.next=h),a.func.call(e||i))},h=function(a){var b=f.currentNode.children&&f.currentNode.children[Object.keys(f.currentNode.children)[0]],a="undefined"==typeof a?b:f.currentNode.children&&f.currentNode.children[a];f.currentNode=(a||"number"==typeof a)&&p[a];f.currentNode?wade.setTimeout(function(){g(f.currentNode)},d||0):(f.currentNode=null,f.running=!1,a={flowChartData:f.flowChartData},e&&e.process("onFlowChartEnd",a),wade.app.onFlowChartEnd&&wade.app.onFlowChartEnd(a))},
i={next:h},j=function(a){var b=a.code;a.func=b?eval.call(window,"(function(){"+b+"})"):wade.doNothing},p=f.flowChartData.boxes,n;for(n in p)if(p.hasOwnProperty(n)&&(c&&j(p[n]),!f.currentNode)){if(!b&&(p[n].startNode&&"number"!=typeof b)&&(f.currentNode=p[n],!c))break;if((b||"number"==typeof b)&&(p[n].title==b||n==b))if(f.currentNode=p[n],!c)break}f.currentNode=f.currentNode||p[Object.keys(p)[0]];if(!f.currentNode)return wade.warn("Unable to run flow chart - no start node was found"),null;f.running=
!0;g(f.currentNode);e&&(e.flowChartStatus=f);return f};this.mergeGlLayers=function(a){"undefined"==typeof a&&(a=!0);if(!!a!==!!N){N=!!a;for(var a=this.getAllLayers(),b=0;b<a.length;b++)"webgl"==a[b].getRenderMode()&&(a[b].removeCanvas(),a[b].initCanvas())}};this.areGlLayersMerged=function(){return N};this.findPath=function(a){var b={x:a.start.x,y:a.start.y},c=a.target.x,d=a.target.y,e=a.collisionMap,f=a.boundaries||{minX:0,minY:0,maxX:e[0].length-1,maxY:e[0][0].length-1},g=a.heightMap,h=a.movementOffsets||
I.straight;"string"==typeof h&&(h=I[h]);var i=a.maxPathLength||0,j=a.maxStepHeight,p="undefined"!=typeof j,n,l=[],k=[b];b.gScore=0;b.hScore=Math.abs(b.x-c)+Math.abs(b.y-d);for(b.fScore=b.hScore;k.length;){for(var r=k[0].fScore,y=k[0],m=0,a=1;a<k.length;a++){n=k[a];var v=n.fScore;v<r&&(y=n,r=v,m=a)}if(y.x==c&&y.y==d){c=[];for(a=y;a.cameFrom;)c.push(a),a=a.cameFrom;c.push(b);b=[];for(a=0;a<c.length;a++)b.push(c[c.length-1-a]);return b}wade.removeObjectFromArrayByIndex(m,k);l.push(y);if(!(i&&y.gScore>=
i)){r=g&&g[y.x]&&g[y.x][y.y]||0;for(a=0;a<h.length;a++)if(m=h[a],m={x:y.x+m.x,y:y.y+m.y},!(m.x<f.minX||m.y<f.minY||m.x>f.maxX||m.y>f.maxY))if(!(p&&Math.abs((g[m.x]&&g[m.x][m.y]||0)-r)>j)&&(!e[m.x]||!e[m.x][m.y])){v=!1;for(n=0;n<l.length;n++){var x=l[n];if(x.x==m.x&&x.y==m.y){v=!0;break}}if(!v){v=y.gScore+1;x=!1;for(n=0;n<k.length;n++){var z=k[n];if(z.x==m.x&&z.y==m.y){x=!0;m=z;break}}n=!1;x?v<m.gScore&&(n=!0):(k.push(m),m.hScore=Math.abs(m.x-c)+Math.abs(m.y-d),n=!0);n&&(m.cameFrom=y,m.gScore=v,m.fScore=
m.gScore+m.hScore)}}}}return[]};this.enableBatching=function(a,c){"undefined"==typeof c&&(c=!0);if("undefined"==typeof a||null===a)for(var d=b.renderer.getActiveLayerIds(),e=0;e<d.length;e++)this.getLayer(d[e]).enableBatching(c);else this.getLayer(a).enableBatching(c)};this.isBatchingEnabled=function(a){return this.getLayer(a).isBatchingEnabled()};this.setBlur=function(a,c,d){c=c||0;if("undefined"==typeof a||null===a)for(var a=b.renderer.getActiveLayerIds(),e=0;e<a.length;e++)d?H[a[e]]={startValue:this.getLayer(a[e]).getBlur(),
endValue:c,time:d,startTime:this.getAppTime()}:(this.getLayer(a[e]).setBlur(c),delete H[a[e]]);else d?H[a]={startValue:this.getLayer(a).getBlur(),endValue:c,time:d,startTime:this.getAppTime()}:(this.getLayer(a).setBlur(c),delete H[a])};this.getBlur=function(a){return this.getLayer(a).getBlur()};this.alwaysUpdateBlur=function(a,c){"undefined"==typeof c&&(c=!0);if("undefined"==typeof a||null===a)for(var d=b.renderer.getActiveLayerIds(),e=0;e<d.length;e++)this.getLayer(d[e]).alwaysUpdateBlur(!!c);else this.getLayer(a).alwaysUpdateBlur(!!c)};
this.getPathIndex=function(a){return b.getPathIndex(a)};this.setPathIndex=function(a,c){return b.setPathIndex(a,c)};this.doNothing=function(){};this.isImportingScene=function(){return!!M};this.getAudio=function(a){a=this.getFullPathAndFileName(a);return c.getAudio(a)};this.playSilentSound=function(){if(s){var a=s.createOscillator();a.frequency.value=440;var b=s.createGainNode();b.gain.value=0;a.connect(b);b.connect(s.destination);a.start?a.start(0):a.noteOn(0);a.stop?a.stop(0.001):a.noteOff(0.001)}else{a=
new Audio;a.src="data:audio/wav;base64,UklGRjoAAABXQVZFZm10IBAAAAABAAEA6AcAANAPAAACABAAZGF0YQYAAAAAAAAAAAA%3D";try{a.play()}catch(c){}}};this.event_mainLoopCallback_=function(){return function(){a.event_mainLoop()}};this.event_mainLoop=function(){var d,e;f=requestAnimationFrame(this.event_mainLoopCallback_());if(!M)if(c.isFinishedLoading()){for(d=0;d<k.length;d++)"none"!=k[d].style.display&&(k[d].style.display="none");v&&"none"!=v.style.display&&(v.style.display="none");if(i){d=a.getAppTime();for(var g in H)e=
(d-H[g].startTime)/H[g].time,1<=e?(a.getLayer(g).setBlur(H[g].endValue),delete H[g]):a.getLayer(g).setBlur(H[g].startValue*(1-e)+H[g].endValue*e);b.draw();d=(new Date).getTime();g=0;e=Math.round((d-q)/(1E3*wade.c_timeStep));q?g=Math.min(3,e):q=d;g&&(e>O/wade.c_timeStep?(g=1,q=d):q+=1E3*g*wade.c_timeStep);for(d=0;d<g&&!z;d++){b.step();var j=1E3*a.getAppTime();for(e=E.length-1;0<=e;e--)if(j>=E[e].time){var p=E[e];p.repeat?p.time+=p.repeat:a.removeObjectFromArrayByIndex(e,E);p.f()}for(e=0;e<m.length;e++)m[e].paused||
(j=m[e].func)&&j()}z&&b.setSimulationDirtyState()}else h&&this.initializeApp()}else{q=(new Date).getTime();for(d=0;d<k.length;d++)k[d].src&&(k[d].style.display="inline");v&&(v.inner.style.width=this.getLoadingPercentage()+"%")}};this.event_appTimerEvent=function(){g=setTimeout("wade.event_appTimerEvent();",1E3*l);b.appTimerEvent()};this.onObjectNameChange=function(a,c){a.isInScene()&&b.changeObjectName(a,c)};this.getLayer=function(a,c){return b.renderer.getLayer(a,c)};this.getAllLayers=function(){return b.renderer.getAllLayers()};
this.isSharedCanvas=function(a){for(var b=this.getAllLayers(),c=0,d=0;d<b.length;d++)if(b[d].getCanvas()==a&&2==++c)return!0;return!1};this.updateMouseInOut=function(a,c){b.updateMouseInOut(a,c)};this.addImageUser=function(a,c){b.renderer.addImageUser(a,c)};this.removeImageUser=function(a,c){b.renderer.removeImageUser(a,c)};this.removeAllImageUsers=function(a){b.renderer.removeAllImageUsers(a)};this.getInternalContext=function(){return x};this.getImageUsers=function(a){return b.renderer.getImageUsers(a)};
this.releaseImageReference=function(a){c.releaseImageReference(this.getFullPathAndFileName(a))};this.extend=function(){var a,b,c,d,e,f=arguments[0]||{},g=1,h=arguments.length,i=!1;"boolean"===typeof f&&(i=f,f=arguments[g]||{},g++);"object"!==typeof f&&"function"!==typeof f&&(f={});g===h&&(f=this,g--);for(;g<h;g++)if(null!=(a=arguments[g]))for(b in a)c=f[b],d=a[b],f!==d&&(i&&d&&(wade.isPlainObject(d)||(e=wade.isArray(d)))?(e?(e=!1,c=c&&wade.isArray(c)?c:[]):c=c&&wade.isPlainObject(c)?c:{},f[b]=wade.extend(i,
c,d)):void 0!==d&&(f[b]=d));return f};this.isPlainObject=function(a){if(!a)return!1;try{if("[object Object]"!==toString.call(a))return!1}catch(b){try{if("[object Object]"!==Object.prototype.toString.call(a))return!1}catch(c){}}a=Object.getPrototypeOf(a);if(!a)return!0;a=Object.hasOwnProperty.call(a,"constructor")&&a.constructor;return"function"===typeof a&&P.call(a)===R};this.texImage2D=function(a,b){var c=b.width,d=b.height,e=!(c&c-1||d&d-1);b.image?a.texImage2D(a.TEXTURE_2D,0,a.RGBA,a.RGBA,a.UNSIGNED_BYTE,
b.image):a.texImage2D(a.TEXTURE_2D,0,a.RGBA,c,d,0,a.RGBA,a.UNSIGNED_BYTE,null);e?(a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MAG_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.LINEAR_MIPMAP_NEAREST),a.generateMipmap(a.TEXTURE_2D)):(a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MAG_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE))};this.isUsingGlobalUnderscore=
function(){return D};this.shaderErrorLog=this.log;this.shaderSuccessLog=this.doNothing;this.deprecate=function(b,c){this[b]=function(){a.warn("wade."+b+" is deprecated. Please use wade."+c+" instead");return a[c].apply(a,arguments)}};window.console||(window.console={});window.console.log||(window.console.log=this.doNothing);window.console.warn||(window.console.warn=window.console.log);window.console.error||(window.console.error=window.console.warn);this.deprecate("playAudioSegmentIfAvailable","playAudioSegment");
this.deprecate("playAudioIfAvailable","playAudio");this.deprecate("setMainLoopCallback","setMainLoop")}wade=new Wade;
...
this._size.x-d,this._size.y-d);c.restore()}}};this.solidFade_=function(a,b,c,d,e,f,g,i,h,j){var l=0;return function(k){if(this._visible)if(k.isWebGl)wade.error("wade.drawFunctions.solidFade_ is not available in webgl mode");else{if(!this._animations.__fade){var m=new Animation("",1,1,1,!0);this.addAnimation("__fade",m)}this.playAnimation("__fade");var m=k.fillStyle,q=l/h,u=Math.floor(a*(1-q)+e*q),t=Math.floor(b*(1-q)+f*q),p=Math.floor(c*(1-q)+g*q),q=d*(1-q)+i*q;this._rotation&&(k.save(),k.translate(this._position.x,
this._position.y),k.rotate(this._rotation),k.translate(-this._position.x,-this._position.y));k.fillStyle="rgba("+u+","+t+","+p+","+q+")";u=this._layer?0.5*wade.screenUnitToWorld(this._layer.id):0.5;k.fillRect(this._position.x-this._size.x/2+u,this._position.y-this._size.y/2+u,this._size.x-u,this._size.y-u);k.fillStyle=m;this._rotation&&k.restore();l<h&&(l++,l==h&&j&&j())}}};this.grid_=function(a,b,c,d){return function(e){if(this._visible)if(e.isWebGl)wade.error("wade.drawFunctions.grid_ is not available in webgl mode");
else{d=d||1;e.save();e.lineWidth=d;e.strokeStyle=c;e.lineJoin="round";e.lineCap="round";this._rotation&&(e.translate(this._position.x,this._position.y),e.rotate(this._rotation),e.translate(-this._position.x,-this._position.y));for(var f=(this._layer?0.5*wade.screenUnitToWorld(this._layer.id):0.5)*d,g=(this._size.x-2*f)/a,i=(this._size.y-2*f)/b,h=this._position.x-this._size.x/2+f,j=this._position.y-this._size.y/2+f,l=this._position.x+this._size.x/2-f,f=this._position.y+this._size.y/2-f,k=h,m=j,q=0;q<=
b;q++)e.beginPath(),e.moveTo(h,m),e.lineTo(l,m),e.stroke(),m+=i;for(i=0;i<=a;i++)e.beginPath(),e.moveTo(k,j),e.lineTo(k,f),e.stroke(),k+=g;e.restore()}}};this.alpha_=function(a,b){var b=b||Sprite.prototype.draw,c=function(c){if(this._visible){var e=c.globalAlpha;c.globalAlpha=a;b.call(this,c);c.globalAlpha=e}};b.batched&&(c.batched=function(c,e){var f=c.globalAlpha;this._f32RotationAlpha[1]=c.globalAlpha=a;b.batched.call(this,c,e);c.globalAlpha=f});return c};this.blink_=function(a,b,c){var d=1,e=
a;return function(f){if(this._visible){if(0>(e-=wade.c_timeStep))e=d?b:a,d=!d;d&&c.call(this,f);this.setDirtyArea()}}};this.additive_=function(a){a=a||Sprite.prototype.draw;return function(b){var c=b.globalCompositeOperation;b.globalCompositeOperation="lighter";a.call(this,b);b.globalCompositeOperation=c}};this.fadeOpacity_=function(a,b,c,d,e){var f=(b-a)*wade.c_timeStep/c,g=a,d=d||Sprite.prototype.draw,i=function(c){if(this._visible){var j=g;g=Math[b>a?"min":"max"](b,g+f);var l=c.globalAlpha;c.globalAlpha=
g;d.call(this,c);c.globalAlpha=l;g==b&&(1==g||0==g)?this.getDrawFunction()==i&&this.setDrawFunction(d):g!=j&&this.setDirtyArea();g==b&&(e&&e(),e=null)}};d.batched&&(i.batched=function(c,j){var l=g;g=Math[b>a?"min":"max"](b,g+f);var k=c.globalAlpha;this._f32RotationAlpha[1]=c.globalAlpha=g;d.batched.call(this,c,j);c.globalAlpha=k;g==b&&(1==g||0==g)?this.getDrawFunction()==i&&this.setDrawFunction(d):g!=l&&this.setDirtyArea();g==b&&(e&&e(),e=null)});return i};this.resizeOverTime_=function(a,b,c,d,e,
f,g){var i=(c-a)*wade.c_timeStep/e,h=a,j=(d-b)*wade.c_timeStep/e,l=b,f=f||Sprite.prototype.draw,k=function(e){this._visible&&(h=Math[c>a?"min":"max"](c,h+i),l=Math[d>b?"min":"max"](d,l+j),this.setSize(h,l),f.call(this,e),h==c&&l==d&&(k==this.getDrawFunction()&&this.setDrawFunction(f),g&&g(),g=null))};return k};this.resizePeriodically_=function(a,b,c,d,e,f){var g=1,i=(c-a)*wade.c_timeStep/e,h=a,j=(d-b)*wade.c_timeStep/e,l=b,f=f||Sprite.prototype.draw;return function(e){if(this._visible){var m=1==g?
c:a,q=1==g?b:d,u=1==g?d:b;h=Math[m>(1==g?a:c)?"min":"max"](m,h+i*g);l=Math[u>q?"min":"max"](u,l+j*g);this.setSize(h,l);f.call(this,e);h==m&&l==u&&(g*=-1)}}};this.mirror_=function(a){var a=a||Sprite.prototype.draw,b=function(b){b.isWebGl?(this._f32AnimFrameInfo[2]*=-1,this._animations&&this._animations[this._currentAnimation].mirror()):b.scale(-1,1);var d=this._position.x,e=this._cornerX;this._position.x*=-1;this._cornerX=this._position.x-this._size.x/2;a.call(this,b);this._position.x=d;this._cornerX=
...
else{d.save();d.lineWidth=1;var e=this._layer?0.5*wade.screenUnitToWorld(this._layer.id):0.5;if(this._rotation){d.strokeStyle=b;d.lineJoin="round";d.lineCap="round";d.beginPath();var f=-this.orientedBoundingBox.axisXx-this.orientedBoundingBox.axisYx,g=-this.orientedBoundingBox.axisXx+this.orientedBoundingBox.axisYx,i=this.orientedBoundingBox.axisXx+this.orientedBoundingBox.axisYx,h=this.orientedBoundingBox.axisXx-this.orientedBoundingBox.axisYx,j=-this.orientedBoundingBox.axisXy-this.orientedBoundingBox.axisYy,
l=-this.orientedBoundingBox.axisXy+this.orientedBoundingBox.axisYy,k=this.orientedBoundingBox.axisXy+this.orientedBoundingBox.axisYy,m=this.orientedBoundingBox.axisXy-this.orientedBoundingBox.axisYy,f=f+(0<f?-e:e),g=g+(0<g?-e:e),h=h+(0<h?-e:e),i=i+(0<i?-e:e),j=j+(0<j?-e:e),l=l+(0<l?-e:e),m=m+(0<m?-e:e),k=k+(0<k?-e:e);d.moveTo(this.orientedBoundingBox.centerX+f,this.orientedBoundingBox.centerY+j);d.lineTo(this.orientedBoundingBox.centerX+g,this.orientedBoundingBox.centerY+l);d.lineTo(this.orientedBoundingBox.centerX+
i,this.orientedBoundingBox.centerY+k);d.lineTo(this.orientedBoundingBox.centerX+h,this.orientedBoundingBox.centerY+m);d.lineTo(this.orientedBoundingBox.centerX+f,this.orientedBoundingBox.centerY+j);d.stroke()}d.strokeStyle=a;d.beginPath();d.moveTo(this.boundingBox.minX+e,this.boundingBox.minY+e);d.lineTo(this.boundingBox.maxX-e,this.boundingBox.minY+e);d.lineTo(this.boundingBox.maxX-e,this.boundingBox.maxY-e);d.lineTo(this.boundingBox.minX+e,this.boundingBox.maxY-e);d.lineTo(this.boundingBox.minX+
...
Wade_iso=function(){var a=this,b=1.018,c=30,d=25,e={},f=[],g,i,h,j,l,k,m=function(){g||a.init()};this.init=function(p){g=!0;p=p||{};"number"==typeof p.tileScaleFactor&&(b=p.tileScaleFactor);"number"==typeof p.terrainLayerId&&(c=p.terrainLayerId);"number"==typeof p.objectsLayerId&&(d=p.objectsLayerId);p.dontClearCanvas&&wade.setCanvasClearing(c,!1);wade.setLayerSorting(d,"bottomToTop");i=new SceneObject(0,TerrainBehavior,0,0,"iso_terrain");i.iso={};h=i.getBehavior();"object"==typeof p.tileSize&&(h.c_tileSize=
wade.cloneObject(p.tileSize));if("object"==typeof p.numTiles)var r=p.numTiles.x,n=p.numTiles.z;r=r||0;n=n||0;r&&n&&wade.addSceneObject(i,!1);this.gameObjects=[];this.gridObjects=[];this.collisionMap=[];f=[];l=p.movementDirection||"diagonal";k=u(l);var m=new Sprite(0,c);m.setSize(h.c_tileSize.x,h.c_tileSize.x);m.setDrawFunction(wade.drawFunctions.solidFill_("white"));m.setRotation(Math.PI/4);var v=new Sprite(0,c);v.setSize(h.c_tileSize.x,h.c_tileSize.x);v.setDrawFunction(wade.drawFunctions.grid_(1,
1,"black",2));v.setRotation(Math.PI/4);var z=new Sprite(0,c);z.setDrawFunction(function(){});var w=Math.ceil(h.c_tileSize.x*Math.sqrt(2));z.setSize(w,w);z.drawToImage("_wade_isoDefault",!0);m.drawToImage("_wade_isoDefault",!1,null,null,"","2d");m=new Sprite("_wade_isoDefault",c);m.setSize(h.c_tileSize.x,h.c_tileSize.y);m.drawToImage("_wade_isoDefault",!0,null,null,"","2d");z.drawToImage("_wade_isoGrid",!0,null,null,"","2d");v.drawToImage("_wade_isoGrid",!1,null,null,"","2d");m=new Sprite("_wade_isoGrid",
c);m.setSize(h.c_tileSize.x,h.c_tileSize.y);m.drawToImage("_wade_isoGrid",!0,null,null,"","2d");p.map?(e={},"string"==typeof p.map?wade.loadJson(p.map,null,function(a){j={data:wade.cloneObject(a)};h.loadData_begin(j.data,q("terrain",p.callback));t(j.data,p.callback)}):(j=wade.cloneObject(p.map),h.loadData_begin(j.data,q("terrain",p.callback)),t(j.data,p.callback))):h.setNumTiles(r,n);wade.setMainLoop(function(){for(var b=f.length-1;0<=b;b--){var c=f[b],d=c.getPosition(),e=h.getFlatTileCoordinates(d.x,
d.y),g=h.getFlatWorldCoordinates(e.x,e.z),i=d.x-g.x,g=d.y-g.y,j=h.c_tileSize.x/2,p=h.c_tileSize.y/2,n=wade.c_epsilon;("both"==l||"straight"==l)&&Math.abs(i)<n&&g*g>=p*p-n||Math.abs(g)<n&&i*i>=j*j-n||(a.updateObjectTile(c,e.x,e.z)?(c.iso.previousPosition.x=d.x,c.iso.previousPosition.y=d.y):(c.setPosition(c.iso.previousPosition),c.processEvent("onStuck",{})),c.iso.targetCoords&&(c.iso.targetCoords.x==e.x&&c.iso.targetCoords.z==e.z)&&(c.iso.targetCoords=0,wade.removeObjectFromArray(c,f)))}},"_wade_isoMovingObjects");
!p.map&&p.callback&&p.callback()};this.importScene=function(a,b){m();j={data:a};h.loadData_begin(j.data,q("terrain",b));t(j.data,b)};this.getTileSize=function(){m();return wade.cloneObject(h.c_tileSize)};this.getValidMovementDirections=function(){m();return wade.cloneArray(k)};this.getTileScaleFactor=function(){m();return b};this.setTileHeight=function(a,b,c){h.setTileHeight(a,b,c||0)};this.getTileHeight=function(a,b){return h.getTileHeight(a,b)};this.addTileHeight=function(a,b,c){h.addTileHeight(a,
...
(this.collisionMap[a][b]=null)};this.setCollisionAtTile=function(a,b,c){this.collisionMap[a]||(this.collisionMap[a]=[]);this.collisionMap[a][b]=c};this.setNumTiles=function(a,b){m();a&&b&&!wade.getSceneObject("iso_terrain")?wade.addSceneObject(i,!0):!a&&(!b&&wade.getSceneObject("iso_terrain"))&&wade.removeSceneObject(i);h.setNumTiles(a,b)};this.createObject=function(a,b,c){m();var a=a||{},c=c?wade.cloneObject(c):{},b=b||{x:0,z:0},e=h.getFlatWorldCoordinates(b.x,b.z);if(a.properties&&Object.keys(a.properties).length){var f=
{};wade.extend(!0,f,a.properties,c);c=f}var g,i,j;if(!a.gridMap)if(a.gridSize){a.gridMap=[];for(f=0;f<a.gridSize.x;f++)for(g=0;g<a.gridSize.z;g++)a.gridMap.push({x:f,z:g})}else a.gridMap=[{x:0,z:0}];if(!a.collisionMap&&a.collisionSize){a.collisionMap=[];for(f=0;f<a.collisionSize.x;f++)for(g=0;g<a.collisionSize.z;g++)a.collisionMap.push({x:f,z:g})}g=a.gridMap;var l=a.collisionMap;if(l)for(f=0;f<l.length;f++)if(i=l[f].x+b.x,j=l[f].z+b.z,this.collisionMap[i]){if(this.collisionMap[i][j])return null}else this.collisionMap[i]=
[];i=[];j=[];if(a.sprites){l=wade.isArray(a.sprites)?a.sprites:[a.sprites];for(f=0;f<l.length;f++){var k=l[f];k.layer=d;k.sortPoint||(k.sortPoint={x:0,y:0.5});var q="TextSprite"==k.type?new TextSprite(k):new Sprite(k);i.push(q);q.baseOffset=k.offset||{x:0,y:0};j.push({x:q.baseOffset.x,y:q.baseOffset.y-this.getTileHeight(b.x,b.z)})}}var s=a.behaviors;if(s){wade.isArray(s)||(s=[s]);for(var u=0;u<s.length;u++)"string"==typeof s[u]&&("function"==typeof window[s[u]]?s[u]=window[s[u]]:function(a){s[u]=
function(){this.name=a}}(s[u]))}var t=new SceneObject(i,s,e.x,e.y,c.name);t.setSpriteOffsets(j);t.iso={objectData:a,gridCoords:{x:b.x,z:b.z}};var C=c.flowChart;delete c.flowChart;wade.extend(t,c);delete t.name;t.functions&&(e=t.functions,delete t.functions,t.importFunctions(e));!a.dontAddToScene&&!c.dontAddToScene&&wade.addSceneObject(t,!0);this.gameObjects.push(t);for(f=0;f<g.length;f++)i=g[f].x+b.x,j=g[f].z+b.z,this.gridObjects[i]||(this.gridObjects[i]=[]),this.gridObjects[i][j]||(this.gridObjects[i][j]=
[]),this.gridObjects[i][j].push(t);if(a.collisionMap)for(f=0;f<a.collisionMap.length;f++)i=a.collisionMap[f].x+b.x,j=a.collisionMap[f].z+b.z,this.collisionMap[i]||(this.collisionMap[i]=[]),this.collisionMap[i][j]=t;C&&wade.setTimeout(function(){t.isInScene()&&wade.runFlowChart(C,null,!0,0,t)},0);return t};this.deleteObject=function(a){m();wade.removeObjectFromArray(a,this.gameObjects);var b,c,d,e=a.iso.objectData.collisionMap;if(e)for(b=0;b<e.length;b++)c=e[b].x+a.iso.gridCoords.x,d=e[b].z+a.iso.gridCoords.z,
this.collisionMap[c]&&this.collisionMap[c][d]&&(this.collisionMap[c][d]=0);e=(e=a.iso.objectData.gridMap)||[{x:0,z:0}];for(b=0;b<e.length;b++)c=e[b].x+a.iso.gridCoords.x,d=e[b].z+a.iso.gridCoords.z,this.gridObjects[c]&&this.gridObjects[c][d]&&wade.removeObjectFromArray(a,this.gridObjects[c][d]);wade.removeSceneObject(a)};this.reset=function(){g?(f.length=0,e={},this.setNumTiles(0,0),this.gameObjects.length=this.gridObjects.length=this.collisionMap.length=0):m()};this.deleteObjectByName=function(a){(a=
g&&wade.getSceneObject(a))&&this.deleteObject(a)};this.deleteObjectsInTile=function(a,b){if(!g||!this.gridObjects[a])return!1;var c=this.gridObjects[a][b];if(!c)return!1;if(c.length){for(var d=c.length-1;0<=d;d--)this.deleteObject(c[d]);return!0}return!1};this.constrainCamera=function(a){m();"undefined"==typeof a&&(a=!0);a?wade.setMainLoop(function(){var a=wade.getScreenWidth()/2,b=wade.getScreenHeight()/2,a={minX:-a,minY:-b,maxX:a,maxY:b},b=wade.getLayer(c).screenBoxToWorld(a),a=(b.maxX-b.minX)/
2,b=(b.maxY-b.minY)/2,d,e,f,g;d={x:0,y:0};e=h.getWorldCoordinates(0,h.numTilesZ-1);e.x-=h.c_tileSize.x/2;f=h.getWorldCoordinates(h.numTilesX-1,0);f.x+=h.c_tileSize.x/2;g=h.getWorldCoordinates(h.numTilesX-1,h.numTilesZ-1);g.y-=h.c_tileSize.y/2;var i=function(a,b){var c={};c.start=a;c.end=b;c.slope=(b.y-a.y)/(b.x-a.x);c.intercept=c.start.y-c.start.x*c.slope;c.getX=function(a){return(a-this.intercept)/this.slope};return c},j;j=i(d,f);d=i(d,e);f=i(g,f);e=i(g,e);i=wade.getCameraPosition();i.y+b>-a/2?i.y=
-a/2-b:i.y-b<g.y+a/2&&(i.y=g.y+a/2+b);i.x-=Math.max(0,i.x+a-Math.min(j.getX(i.y+b),f.getX(i.y-b)));i.x+=Math.max(0,Math.max(d.getX(i.y+b),e.getX(i.y-b))-(i.x-a));wade.setCameraPosition(i)},"_wade_isoConstrainCamera"):wade.setMainLoop(null,"_wade_isoConstrainCamera")};this.spawnObjectNearObject=function(a,b,c,d,e,f,g){m();var a="string"==typeof a?wade.getSceneObject(a).gridCoords:a.gridCoords,h;"undefined"==typeof d&&(d=-1);"undefined"==typeof e&&(e=-1);"undefined"==typeof f&&(f=1);for("undefined"==
typeof g&&(g=1);d<=f;d++)for(var i=e;i<=g;i++)if(!this.collisionMap[a.x+d]||!this.collisionMap[a.x+d][a.z+i])h={x:a.x+d,z:a.z+i};return h?this.createObject(b,h,c):null};this.swapObjects=function(a,b){m();var c,d,e,f=a.iso.objectData.gridMap||[{x:0,z:0}],g=b.iso.objectData.gridMap||[{x:0,z:0}],i=a.iso.objectData.collisionMap,j=b.iso.objectData.collisionMap,l=a.iso.gridCoords,k=b.iso.gridCoords;if(i)for(c=0;c<i.length;c++)d=i[c].x+l.x,e=i[c].z+l.z,this.collisionMap[d][e]=0;for(c=0;c<f.length;c++)d=
f[c].x+l.x,e=f[c].z+l.z,wade.removeObjectFromArray(a,this.gridObjects[d][e]);if(j)for(c=0;c<j.length;c++)d=j[c].x+k.x,e=j[c].z+k.z,this.collisionMap[d][e]=0;for(c=0;c<g.length;c++)d=g[c].x+k.x,e=g[c].z+k.z,wade.removeObjectFromArray(b,this.gridObjects[d][e]);c=l;l=k;k=c;a.iso.gridCoords=l;b.iso.gridCoords=k;if(i)for(c=0;c<i.length;c++)d=i[c].x+l.x,e=i[c].z+l.z,this.collisionMap[d]||(this.collisionMap[d]=[]),this.collisionMap[d][e]=a;for(c=0;c<f.length;c++)d=f[c].x+l.x,e=f[c].z+l.z,this.gridObjects[d]||
(this.gridObjects[d]=[]),this.gridObjects[d][e]||(this.gridObjects[d][e]=[]),this.gridObjects[d][e].push(a);if(j)for(c=0;c<j.length;c++)d=j[c].x+k.x,e=j[c].z+k.z,this.collisionMap[d]||(this.collisionMap[d]=[]),this.collisionMap[d][e]=b;for(c=0;c<f.length;c++)d=f[c].x+l.x,e=f[c].z+l.z,this.gridObjects[d]||(this.gridObjects[d]=[]),this.gridObjects[d][e]||(this.gridObjects[d][e]=[]),this.gridObjects[d][e].push(b);a.setPosition(h.getFlatWorldCoordinates(l.x,l.z));b.setPosition(h.getFlatWorldCoordinates(k.x,
k.z));f=this.getTileHeight(l.x,l.z);k=this.getTileHeight(k.x,k.z);for(c=0;c<a.getSpriteCount();c++)a.setSpriteOffset(c,a.getSprite(c).baseOffset-f);for(c=0;c<b.getSpriteCount();c++)b.setHeightOffset(c,b.getSprite(c).baseOffset-k)};this.findPath=function(a,b,c,d,e){m();a={start:{x:a.x,y:a.z},target:{x:b.x,y:b.z},collisionMap:this.collisionMap,movementOffsets:c||l,boundaries:{minX:0,minY:0,maxX:h.numTilesX-1,maxY:h.numTilesZ-1},heightMap:h.getHeightMap(),maxStepHeight:d,maxPathLength:e};a=wade.findPath(a);
for(b=0;b<a.length;b++)a[b].z=a[b].y;return a};this.moveObjectToTile=function(b,c,d,e){m();if("string"==typeof b&&(b=wade.getSceneObject(b),!b))return!1;if(!e)return a.updateObjectTile(b,c,d)?(b.setPosition(h.getFlatWorldCoordinates(c,d)),b.iso.targetCoords=0,wade.removeObjectFromArray(b,f),!0):!1;if(b.iso.gridCoords.x==c&&b.iso.gridCoords.z==d)return!0;b.iso.targetCoords={x:c,z:d};b.iso.previousPosition=b.getPosition();f.push(b);c=h.getFlatWorldCoordinates(c,d);b.moveTo(c.x,c.y,e);return!0};this.setTile=
function(a,b,c,d){m();return h.setTile(a,b,c,d)};this.setTransition=function(a,b,c){m();h.setTransition(a,b,c)};this.setDetail=function(a,b,c){m();h.setDetail(a,b,c)};this.getWorldCoordinates=function(a,b){m();return h.getWorldCoordinates(a,b)};this.getFlatWorldCoordinates=function(a,b){m();return h.getFlatWorldCoordinates(a,b)};this.getTileCoordinates=function(a,b){m();return h.getTileCoordinates(a,b)};this.getFlatTileCoordinates=function(a,b){m();return h.getFlatTileCoordinates(a,b)};this.getTileTexture=
function(a,b){return g&&h.getTileTexture(a,b)};this.setHighlight=function(a,b){m();h.setHighlight(a,b)};this.getHighlightObjects=function(){return g?h.getHighlightObjects():[]};this.getObjectsInTile=function(a,b){m();var c=this.gridObjects[a]&&this.gridObjects[a][b];return c&&wade.cloneArray(c)||[]};this.sortTerrainTiles=function(){m();h.sort()};this.drawGrid=function(a){m();"undefined"==typeof a&&(a=!0);h.drawGrid(a)};this.draw_=function(a,b){b=b||"blue";return function(c){var d=this._position,e=
this._size.x/2,f=this._size.y/2,g=c.strokeStyle,h=c.fillStyle;a&&(c.strokeStyle=a);c.fillStyle=b;c.beginPath();c.moveTo(d.x-e,d.y);c.lineTo(d.x,d.y+f);c.lineTo(d.x+e,d.y);c.lineTo(d.x,d.y-f);g&&c.stroke();h&&c.fill();c.strokeStyle=g;c.fillStyle=h}};this.exportMap=function(a){m();for(var b={version:"1.1",terrain:{numTilesX:h.numTilesX,numTilesZ:h.numTilesZ,tileData:[],tileDataIds:[],transitionData:[],transitionDataIds:[],detailData:[],detailDataIds:[],tileHeight:[]},gameObjectData:[],gameObjects:[]},
c=0;c<h.numTilesX;c++){b.terrain.tileDataIds[c]=[];b.terrain.transitionDataIds[c]=[];b.terrain.tileHeight[c]=[];for(var d=0;d<h.numTilesZ;d++){if(h.tileData[c]&&h.tileData[c][d]){var e=h.tileData[c][d],f=b.terrain.tileData.indexOf(e);-1==f&&(f=b.terrain.tileData.push(e)-1);b.terrain.tileDataIds[c][d]=f;b.terrain.tileHeight[c][d]=h.tileHeight[c]&&h.tileHeight[c][d]||0}else b.terrain.tileDataIds[c][d]=-1;h.transitionData[c]&&h.transitionData[c][d]?(e=h.transitionData[c][d],f=b.terrain.transitionData.indexOf(e),
-1==f&&(f=b.terrain.transitionData.push(e)-1),b.terrain.transitionDataIds[c][d]=f):b.terrain.transitionDataIds[c][d]=-1}}for(c=0;c<h.numTilesX;c++){b.terrain.detailDataIds[c]=[];for(d=0;d<h.numTilesZ;d++)h.detailData[c]&&h.detailData[c][d]?(e=h.detailData[c][d],f=b.terrain.detailData.indexOf(e),-1==f&&(f=b.terrain.detailData.push(e)-1),b.terrain.detailDataIds[c][d]=f):b.terrain.detailDataIds[c][d]=-1}e=this.gameObjects;for(c=0;c<e.length;c++)if(e[c].iso&&e[c].iso.objectData&&e[c].iso.gridCoords){var g=
e[c].iso.objectData,f=b.gameObjectData.indexOf(g);-1==f&&(f=b.gameObjectData.push(g)-1);var f={templateId:f,gridCoords:{x:e[c].iso.gridCoords.x||0,z:e[c].iso.gridCoords.z||0}},i=e[c].serialize(!1,["iso"]);f.instanceData=i.properties||{};f.instanceData.name=e[c].getName();g.behaviors=[];for(d=0;d<i.behaviors.length;d++)g.behaviors.push(i.behaviors[d].name);b.gameObjects.push(f)}if(a)try{b=JSON.stringify(b)}catch(j){wade.log("Unable to convert map data to a string. It may contain circular references.")}return b};
this.updateObjectTile=function(b,c,d){m();if(b.iso.gridCoords.x==c&&b.iso.gridCoords.z==d)return!0;var e,f,g,h=b.iso.objectData.gridMap||[{x:0,z:0}],i=b.iso.objectData.collisionMap;if(i)for(e=0;e<i.length;e++)if(f=i[e].x+c,g=i[e].z+d,a.collisionMap[f]&&a.collisionMap[f][g]&&a.collisionMap[f][g]!=b)return!1;for(e=0;e<h.length;e++)f=h[e].x+b.iso.gridCoords.x,g=h[e].z+b.iso.gridCoords.z,wade.removeObjectFromArray(b,a.gridObjects[f][g]);if(i)for(e=0;e<i.length;e++)f=i[e].x+b.iso.gridCoords.x,g=i[e].z+
b.iso.gridCoords.z,a.collisionMap[f]&&a.collisionMap[f][g]&&(a.collisionMap[f][g]=0);for(e=0;e<h.length;e++)f=h[e].x+c,g=h[e].z+d,a.gridObjects[f]||(a.gridObjects[f]=[]),a.gridObjects[f][g]||(a.gridObjects[f][g]=[]),a.gridObjects[f][g].push(b);if(i)for(e=0;e<i.length;e++)f=i[e].x+c,g=i[e].z+d,a.collisionMap[f]||(a.collisionMap[f]=[]),a.collisionMap[f][g]=b;if(b.iso.gridCoords.x!=c||b.iso.gridCoords.z!=d)var j={x:b.iso.gridCoords.x,z:b.iso.gridCoords.z};b.iso.gridCoords.x=c;b.iso.gridCoords.z=d;for(e=
0;e<b.getSpriteCount();e++)f=b.getSprite(e).baseOffset,b.setSpriteOffset(e,{x:f.x,y:f.y-a.getTileHeight(c,d)});j&&b.process("onIsoTileChange",{previousTile:j,currentTile:{x:c,z:d}});return!0};var q=function(a,b){return function(){e[a]=1;e.terrain&&e.objects&&b&&b()}},u=function(a){switch(a){case "straight":return[{x:-1,z:-1},{x:-1,z:1},{x:1,z:-1},{x:1,z:1}];case "diagonal":return[{x:0,z:-1},{x:0,z:1},{x:-1,z:0},{x:1,z:0}];case "both":return[{x:-1,z:-1},{x:-1,z:1},{x:1,z:-1},{x:1,z:1},{x:0,z:-1},{x:0,
z:1},{x:-1,z:0},{x:1,z:0}]}return[]},t=function(b,c){var d,e,f,g,h=[],j={},l=0;if(b.gameObjects){for(d=0;d<b.gameObjectData.length;d++){for(e=0;e<b.gameObjectData[d].sprites.length;e++){var k=b.gameObjectData[d].sprites[e].image;k&&!j[k]&&(h.push(k),j[k]=1);if(b.gameObjectData[d].sprites[e].animations)for(f=0;f<b.gameObjectData[d].sprites[e].animations.length;f++)k=b.gameObjectData[d].sprites[e].animations[f].image,j[k]||(h.push(k),j[k]=1)}if(e=b.gameObjectData[d].portraits)for(g in e)e.hasOwnProperty(g)&&
!j[e[g]]&&(h.push(e[g]),j[e[g]]=1)}if(h.length)for(d=0;d<h.length;d++)wade.loadImage(h[d],function(){if(++l==h.length){if(b.gameObjects){i.getBehavior("TerrainBehavior");for(var d=0;d<b.gameObjects.length;d++)a.createObject(b.gameObjectData[b.gameObjects[d].templateId],b.gameObjects[d].gridCoords,b.gameObjects[d].instanceData)}q("objects",c)()}});else q("objects",c)()}else q("objects",c)()}};wade.iso=new Wade_iso;
...
[]);if(d){e=e||0;this.tileHeight[a][c]=e;var g,i,h,j,l,k;g=!0;if(f=d.texture)l=wade.getImage(f),j=l.width,l=l.height;d.rotation&&(f+="_iso_rot_"+d.rotation,"ok"!=wade.getLoadingStatus(f)&&(h=new Sprite(d.texture),h.setRotation(d.rotation*Math.PI/2),h.drawToImage(f,!0)));k=d.scale||1;h=this.c_tileSize.x*wade.iso.getTileScaleFactor()*k;var m=i=this.c_tileSize.y*wade.iso.getTileScaleFactor()*k,q={x:this.c_origin.x+(a-c)*this.c_tileSize.x/2,y:this.c_origin.y-(a+c)*this.c_tileSize.y/2};this.tileSprites[a][c]&&
...
q),g=!1));g&&(d.animation?(k=new Sprite(0,wade.iso.getTerrainLayerId()),f=new Animation(f,d.animation.numFrames.x,d.animation.numFrames.y,d.animation.speed,!0),k.addAnimation("default",f),k.playAnimation("default")):k=new Sprite(f,wade.iso.getTerrainLayerId()),k.customSortOrder=0,k.customSortIndex=a+c,k.gridCoords={x:a,z:c},d.imageArea?(k.setImageArea(d.imageArea.minX,d.imageArea.minY,d.imageArea.maxX,d.imageArea.maxY),d.customHeight&&(g=d.imageArea.maxX-d.imageArea.minX,i=d.imageArea.maxY-d.imageArea.minY,
i=this.c_tileSize.x*wade.iso.getTileScaleFactor()*i/g)):d.customHeight&&(j&&l)&&(i=this.c_tileSize.x*wade.iso.getScaleFactor()*l/j),k.setSize(h,i),q.y+=(i-m)/2-e,this.tileSprites[a][c]=k,this.owner.addSprite(k,q));j={x:this.c_origin.x+(a-c)*this.c_tileSize.x/2,y:this.c_origin.y-(a+c)*this.c_tileSize.y/2-e};this.transitionSprites[a]&&this.transitionSprites[a][c]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.transitionSprites[a][c]),j);this.detailSprites[a]&&this.detailSprites[a][c]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.detailSprites[a][c]),
j);j=wade.iso.getObjectsInTile(a,c);for(l=0;l<j.length;l++)for(f=0;f<j[l].getSpriteCount();f++)h=j[l].getSprite(f).baseOffset,j[l].setSpriteOffset(f,{x:h.x,y:h.y-e});this.gridSprites[a]&&this.gridSprites[a][c]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.gridSprites[a][c]),this.getWorldCoordinates(a,c))}else this.tileSprites[a]&&this.tileSprites[a][c]&&this.owner.removeSprite(this.tileSprites[a][c]),this.tileSprites[a][c]=0,this.transitionSprites[a]&&this.transitionSprites[a][c]&&this.setTransition(a,
...
2,y:-(a+c+1)*this.c_tileSize.y/2-(this.tileHeight[a]&&this.tileHeight[a][c]||0)}};this.getFlatWorldCoordinates=function(a,c){return{x:(a-c)*this.c_tileSize.x/2,y:-(a+c+1)*this.c_tileSize.y/2}};this.getTileCoordinates=function(a,c){for(var d=wade.getSpritesInArea({minX:a,minY:c,maxX:a,maxY:c},wade.iso.getTerrainLayerId(),!0),e=this.c_tileSize.y*wade.iso.getTileScaleFactor(),f=this.c_tileSize.x*wade.iso.getTileScaleFactor()/2,g=e/2,i=f*g,h=0;h<d.length;h++){var j=d[h];if(j.gridCoords){var l=this.tileData[j.gridCoords.x][j.gridCoords.z],
k=j.getPosition(),k=wade.vec2.sub({x:a,y:c},k);if(l&&l.customHeight){var l=l.scale||1,m=j.getSize();if(k.y+m.y/2>e*l)continue;k.y+=(m.y-e)/2}if(Math.abs(k.x)*g+Math.abs(k.y)*f<=i)return{x:j.gridCoords.x,z:j.gridCoords.z,valid:!0}}}d=a/this.c_tileSize.x-c/this.c_tileSize.y;e=-(a/this.c_tileSize.x+c/this.c_tileSize.y);d=Math.floor(d);e=Math.floor(e);return{x:d,z:e,valid:0<=d&&0<=e&&d<this.numTilesX&&e<this.numTilesZ}};this.getFlatTileCoordinates=function(a,c){var d=a/this.c_tileSize.x-c/this.c_tileSize.y,
...
Wade_tilemap=function(){var a=this,b=30,c={},d,e,f,g;this.collisionMap=[];var i=function(b){d||a.init(b&&b.terrain)};this.init=function(a){d=!0;a=a||{};"number"==typeof a.terrainLayerId&&(b=a.terrainLayerId);a.dontClearCanvas&&wade.setCanvasClearing(b,!1);e=new SceneObject(0,TiledTerrain,0,0,"tilemap_terrain");e.tilemap={};f=e.getBehavior();"object"==typeof a.tileSize&&(f.c_tileSize=wade.cloneObject(a.tileSize));if("object"==typeof a.numTiles)var i=a.numTiles.x,k=a.numTiles.y;else void 0!=a.numTilesX&&
void 0!=a.numTilesY&&(i=a.numTilesX,k=a.numTilesY);i=i||0;k=k||0;i&&k&&wade.addSceneObject(e,!0);var m=new Sprite(0,b);m.setSize(f.c_tileSize.x,f.c_tileSize.x);m.setDrawFunction(wade.drawFunctions.solidFill_("white"));m.drawToImage("_wade_tilemapDefault",!1,null,null,"","2d");a.map?(c={},"string"==typeof a.map?wade.loadJson(a.map,null,function(b){g={data:wade.cloneObject(b)};f.loadData_begin(g.data,h("terrain",a.callback))}):(g=wade.cloneObject(a.map),f.loadData_begin(g.data,h("terrain",a.callback)))):
f.setNumTiles(i,k);!a.map&&a.callback&&a.callback()};this.importScene=function(a,b){this.reset(a);g={data:a};f.loadData_begin(g.data,h("terrain",b))};var h=function(a,b){return function(){c[a]=1;c.terrain&&b&&b()}};this.getTileSize=function(){i();return wade.cloneObject(f.c_tileSize)};this.getTileSprite=function(a,b){return f&&f.tileSprites[a]&&f.tileSprites[a][b]};this.getTileData=function(a,b){return f&&f.getTileData(a,b)};this.getTransitionSprite=function(a,b){return f&&f.transitionSprites[a]&&
f.transitionSprites[a][b]};this.getTransitionData=function(a,b){return f&&f.getTransitionData(a,b)};this.getDetailSprite=function(a,b){return f&&f.detailSprites[a]&&f.detailSprites[a][b]};this.getDetailData=function(a,b){return f&&f.getDetailData(a,b)};this.checkCollisionsAtTile=function(a,b,c){a=this.collisionMap&&this.collisionMap[a]&&this.collisionMap[a][b];return c&&a==c?!1:!!a};this.setTiles=function(a,b,c,d,e,g){i();return f.setTiles(a,b,c,d,e,g)};this.setTile=function(a,b,c){i();return f.setTile(a,
b,c)};this.setTransitions=function(a,b,c,d,e,g){i();return f.setTransitions(a,b,c,d,e,g)};this.setTransition=function(a,b,c){i();return f.setTransition(a,b,c)};this.setDetails=function(a,b,c,d,e,g){i();return f.setDetails(a,b,c,d,e,g)};this.setDetail=function(a,b,c){i();return f.setDetail(a,b,c)};this.setNumTiles=function(a,b){i();a&&b&&!wade.getSceneObject("tilemap_terrain")?wade.addSceneObject(e,!0):!a&&(!b&&wade.getSceneObject("tilemap_terrain"))&&wade.removeSceneObject(e);f.setNumTiles(a,b)};
this.getWorldCoordinates=function(a,b){i();return f.getWorldCoordinates(a,b)};this.getTileCoordinates=function(a,b){i();return f.getTileCoordinates(a,b)};this.getNumTiles=function(){return f?{x:f.numTilesX,y:f.numTilesY}:{x:0,y:0}};this.getTerrainLayerId=function(){return b};this.getTileScaleFactor=function(){i();return 1};this.reset=function(){d?(this.setNumTiles(0,0),this.collisionMap.length=0,c={}):i()};this.findPath=function(a,b,c,d){i();return wade.findPath({start:{x:a.x,y:a.y},target:{x:b.x,
y:b.y},collisionMap:this.collisionMap,movementOffsets:c,boundaries:{minX:0,minY:0,maxX:f.numTilesX-1,maxY:f.numTilesY-1},maxPathLength:d})};this.moveObjectToTile=function(b,c,d,e){i();var g=b.getBehavior("TilemapCharacter"),h=g.tileCoordinates();if("string"==typeof b&&(b=wade.getSceneObject(b),!b))return!1;if(!e)return a.updateObjectTile(b,c,d)?(b.setPosition(f.getWorldCoordinates(c,d)),g.targetCoords=0,!0):!1;if(h.x==c&&h.y==d)return!0;g.targetCoords={x:c,y:d};g.previousPosition=b.getPosition();
c=f.getWorldCoordinates(c,d);b.moveTo(c.x,c.y,e);return!0};this.exportMap=function(a){i();for(var b={version:"1.0",terrain:{numTilesX:f.numTilesX,numTilesY:f.numTilesY,tileData:[],tileDataIds:[],transitionData:[],transitionDataIds:[],detailData:[],detailDataIds:[]}},c=0;c<f.numTilesX;c++){b.terrain.tileDataIds[c]=[];b.terrain.transitionDataIds[c]=[];for(var d=0;d<f.numTilesY;d++){if(f.tileData[c]&&f.tileData[c][d]){var e=f.tileData[c][d],g=b.terrain.tileData.indexOf(e);-1==g&&(g=b.terrain.tileData.push(e)-
1);b.terrain.tileDataIds[c][d]=g}else b.terrain.tileDataIds[c][d]=-1;f.transitionData[c]&&f.transitionData[c][d]?(e=f.transitionData[c][d],g=b.terrain.transitionData.indexOf(e),-1==g&&(g=b.terrain.transitionData.push(e)-1),b.terrain.transitionDataIds[c][d]=g):b.terrain.transitionDataIds[c][d]=-1}}for(c=0;c<f.numTilesX;c++){b.terrain.detailDataIds[c]=[];for(d=0;d<f.numTilesY;d++)f.detailData[c]&&f.detailData[c][d]?(e=f.detailData[c][d],g=b.terrain.detailData.indexOf(e),-1==g&&(g=b.terrain.detailData.push(e)-
1),b.terrain.detailDataIds[c][d]=g):b.terrain.detailDataIds[c][d]=-1}if(a)try{b=JSON.stringify(b)}catch(h){wade.log("Unable to convert map data to a string. It may contain circular references.")}return b}};wade.tilemap=new Wade_tilemap;
function TiledTerrain(){this.name="TiledTerrain";this.tileSprites=[];this.tileData=[];this.gridSprites=[];this.transitionSprites=[];this.transitionData=[];this.detailSprites=[];this.detailData=[];this.c_tileSize={x:128,y:128};this.c_origin={x:0,y:0};this.numTilesY=this.numTilesX=0;this.tileHighlightObjects=[];this.onAddToScene=function(){this.owner.listenFor("onMouseDown");this.owner.listenFor("onMouseUp");this.owner.listenFor("onMouseClick");this.owner.listenFor("onMouseMove");wade.setLayerSorting(wade.tilemap.getTerrainLayerId(),
this.sortingFunction)};this.getTileHighlightObject=function(a){if(!this.tileHighlightObjects[a])if(this.highlightTexture){var b=new Sprite(this.highlightTexture,wade.tilemap.getTerrainLayerId());b.setSize(this.c_tileSize.x,this.c_tileSize.y);b.customSortOrder=4;b.customSortIndex=0;this.tileHighlightObjects[a]=new SceneObject(b);this.tileHighlightObjects[a].tilemap={gridCoords:{x:0,y:0}};wade.addSceneObject(this.tileHighlightObjects[a])}else this.highlightSprite&&(b=this.highlightSprite.clone(),b.customSortOrder=
...
b){this.finishedLoading_=!1;this.loadingList=[];var c={_wade_tilemapDefault:1};this.completeRequests=0;var d,e;for(d=0;d<a.terrain.tileData.length;d++)e=a.terrain.tileData[d].texture,c[e]||(this.loadingList.push(e),c[e]=1);for(d=0;d<a.terrain.transitionData.length;d++)e=a.terrain.transitionData[d].texture,c[e]||(this.loadingList.push(e),c[e]=1);for(d=0;d<a.terrain.detailData.length;d++)e=a.terrain.detailData[d].texture,c[e]||(this.loadingList.push(e),c[e]=1);if(this.loadingList.length)for(d=0;d<this.loadingList.length;d++)wade.loadImage(this.loadingList[d],
this.onLoadingRequestComplete_(a,b));else this.onLoadingRequestComplete_(a,b)(!0)};this.onLoadingRequestComplete_=function(a,b){var c=this;return function(d){if(!0===d||++c.completeRequests==c.loadingList.length)c.loadData_end(a),!c.owner.isInScene()&&(c.numTilesX&&c.numTilesY)&&wade.addSceneObject(c.owner,!1),c.finishedLoading_=!0,b&&b()}};this.loadData_end=function(a){var b,c;this.numTilesX=a.terrain.numTilesX;this.numTilesY=a.terrain.numTilesY;for(b=0;b<this.numTilesX;b++){this.tileSprites[b]=
[];this.tileData[b]=[];this.transitionSprites[b]=[];this.transitionData[b]=[];for(c=0;c<this.numTilesY;c++){this.setTile(b,c,a.terrain.tileData[a.terrain.tileDataIds[b][c]]);var d=a.terrain.transitionData[a.terrain.transitionDataIds[b][c]];d&&this.setTransition(b,c,d)}}for(b=0;b<this.numTilesX;b++){this.detailSprites[b]=[];this.detailData[b]=[];for(c=0;c<this.numTilesY;c++)(d=a.terrain.detailData[a.terrain.detailDataIds[b][c]])&&this.setDetail(b,c,d)}};this.setNumTiles=function(a,b){var c,d;for(c=
a;c<this.numTilesX;c++)for(d=0;d<this.numTilesY;d++)this.setTile(c,d,0),this.setTransition(c,d,0);for(d=b;d<this.numTilesY;d++)for(c=0;c<this.numTilesX;c++)this.setTile(c,d,0),this.setTransition(c,d,0);for(c=a;c<this.numTilesX;c++)for(d=0;d<this.numTilesY;d++)this.setDetail(c,d,0);for(d=b;d<this.numTilesY;d++)for(c=0;c<this.numTilesX;c++)this.setDetail(c,d,0);this.tileData.length=this.transitionData.length=this.detailData.length=this.tileSprites.length=this.transitionSprites.length=this.detailSprites.length=
this.gridSprites.length=a;for(c=0;c<a;c++)this.tileData[c]&&(this.tileData[c].length=b),this.transitionData[c]&&(this.transitionData[c].length=b),this.detailData[c]&&(this.detailData[c].length=b),this.tileSprites[c]&&(this.tileSprites[c].length=b),this.transitionSprites[c]&&(this.transitionSprites[c].length=b),this.detailSprites[c]&&(this.detailSprites[c].length=b),this.gridSprites[c]&&(this.gridSprites[c].length=b);var e={texture:"_wade_tilemapDefault"};for(c=this.numTilesX;c<a;c++){this.tileSprites[c]=
[];this.tileData[c]=[];this.transitionSprites[c]=[];this.transitionData[c]=[];for(d=0;d<b;d++)this.setTile(c,d,e)}for(d=this.numTilesY;d<b;d++)for(c=0;c<this.numTilesX;c++)this.setTile(c,d,e);for(c=this.numTilesX;c<a;c++)this.detailSprites[c]=[],this.detailData[c]=[];this.numTilesX=a;this.numTilesY=b};this.setTiles=function(a,b,c,d,e,f){for(var c=c||0,d=d||0,e=e||this.numTilesX,f=f||this.numTilesY,g=0;g<a.length;g++){var i=g%this.numTilesX,h=Math.floor(g/this.numTilesX);i>=c&&(i<e&&h>=d&&h<f)&&this.setTile(i,
h,b[a[g]])}};this.setTile=function(a,b,c){var d=wade.tilemap.collisionMap;if(!c||c.collision){if(d[a]&&d[a][b]&&!d[a][b].isTerrainTile)return!1;d[a]||(d[a]=[]);d[a][b]={isTerrainTile:!0,tileData:c}}else d[a]&&(d[a][b]&&d[a][b].isTerrainTile)&&(d[a][b]=0);this.tileSprites[a]||(this.tileSprites[a]=[]);this.tileData[a]||(this.tileData[a]=[]);if(c){var e,f,g,i,h=!0,j=c.texture;j&&(d=wade.getImage(j),e=d.width,f=d.height);c.rotation&&(j+="_tilemap_rot_"+c.rotation,"ok"!=wade.getLoadingStatus(j)&&(d=new Sprite(c.texture),
d.setRotation(c.rotation*Math.PI/2),d.drawToImage(j,!0)));i=c.scale||1;d=this.c_tileSize.x*wade.tilemap.getTileScaleFactor()*i;g=this.c_tileSize.y*wade.tilemap.getTileScaleFactor()*i;var l={x:this.c_origin.x+this.c_tileSize.x*a+this.c_tileSize.x/2-this.c_tileSize.x*this.numTilesX/2,y:this.c_origin.y+this.c_tileSize.y*b+this.c_tileSize.y/2-this.c_tileSize.y*this.numTilesY/2};this.tileSprites[a][b]&&(i=this.tileSprites[a][b],c.animation||this.tileData[a][b].animation?(this.owner.removeSprite(i),this.tileSprites[a][b]=
0):(i.setImageFile(j),c.imageArea&&i.setImageArea(c.imageArea.minX,c.imageArea.minY,c.imageArea.maxX,c.imageArea.maxY),i.setSize(d,g),this.owner.setSpriteOffset(this.owner.getSpriteIndex(i),l),h=!1));h&&(c.animation?(i=new Sprite(0,wade.tilemap.getTerrainLayerId()),h=new Animation(j,c.animation.numFrames.x,c.animation.numFrames.y,c.animation.speed,!0),i.addAnimation("default",h),i.playAnimation("default")):i=new Sprite(j,wade.tilemap.getTerrainLayerId()),i.customSortOrder=0,i.customSortIndex=a+b,
i.gridCoords={x:a,y:b},c.imageArea?(i.setImageArea(c.imageArea.minX,c.imageArea.minY,c.imageArea.maxX,c.imageArea.maxY),c.customHeight&&(e=c.imageArea.maxX-c.imageArea.minX,f=c.imageArea.maxY-c.imageArea.minY,g=this.c_tileSize.x*wade.tilemap.getTileScaleFactor()*f/e)):c.customHeight&&(e&&f)&&(g=this.c_tileSize.x*wade.tilemap.getScaleFactor()*f/e),i.setSize(d,g),this.tileSprites[a][b]=i,this.owner.addSprite(i,l));e={x:this.c_origin.x+this.c_tileSize.x*a+this.c_tileSize.x/2-this.c_tileSize.x*this.numTilesX/
2,y:this.c_origin.y+this.c_tileSize.y*b+this.c_tileSize.y/2-this.c_tileSize.y*this.numTilesY/2};this.transitionSprites[a]&&this.transitionSprites[a][b]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.transitionSprites[a][b]),e);this.detailSprites[a]&&this.detailSprites[a][b]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.detailSprites[a][b]),e);this.gridSprites[a]&&this.gridSprites[a][b]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.gridSprites[a][b]),this.getWorldCoordinates(a,
b))}else this.tileSprites[a]&&this.tileSprites[a][b]&&this.owner.removeSprite(this.tileSprites[a][b]),this.tileSprites[a][b]=0,this.transitionSprites[a]&&this.transitionSprites[a][b]&&this.setTransition(a,b,null),this.detailSprites[a]&&this.detailSprites[a][b]&&this.setDetail(a,b,null);this.tileData[a][b]=c;return!0};this.hideTileHighlightObjects=function(){for(var a=0;a<this.tileHighlightObjects.length;a++)this.tileHighlightObjects[a]&&this.tileHighlightObjects[a].setVisible(!1)};this.getHighlightObjects=
function(){return wade.extend([],this.tileHighlightObjects)};this.setTransitions=function(a,b,c,d,e,f){for(var c=c||0,d=d||0,e=e||this.numTilesX,f=f||this.numTilesY,g=0;g<a.length;g++){var i=g%this.numTilesX,h=Math.floor(g/this.numTilesX);i>=c&&(i<e&&h>=d&&h<f)&&this.setTransition(i,h,b[a[g]])}};this.setTransition=function(a,b,c){this.transitionSprites[a]||(this.transitionSprites[a]=[]);this.transitionData[a]||(this.transitionData[a]=[]);if(c){var d=!0,e=c.texture;if(c.rotation&&(e+="_tilemap_rot_"+
c.rotation,"ok"!=wade.getLoadingStatus(e))){var f=new Sprite(c.texture);f.setRotation(c.rotation*Math.PI/2);f.drawToImage(e,!0)}this.transitionSprites[a][b]&&(c.animation||this.transitionData[a][b].animation?(this.owner.removeSprite(this.transitionSprites[a][b]),this.transitionSprites[a][b]=0):(this.transitionSprites[a][b].setImageFile(e),c.imageArea&&this.transitionSprites[a][b].setImageArea(c.imageArea.minX,c.imageArea.minY,c.imageArea.maxX,c.imageArea.maxY),d=!1));f={x:this.c_origin.x+this.c_tileSize.x*
a+this.c_tileSize.x/2-this.c_tileSize.x*this.numTilesX/2,y:this.c_origin.y+this.c_tileSize.y*b+this.c_tileSize.y/2-this.c_tileSize.y*this.numTilesY/2};if(d){var g=c.scale||1,d=this.c_tileSize.x*wade.tilemap.getTileScaleFactor()*g,g=this.c_tileSize.y*wade.tilemap.getTileScaleFactor()*g;if(c.animation){var e=new Sprite(0,wade.tilemap.getTerrainLayerId()),i=new Animation(c.texture,c.animation.numFrames.x,c.animation.numFrames.y,c.animation.speed,!0);e.addAnimation("default",i);e.playAnimation("default")}else e=
new Sprite(e,wade.tilemap.getTerrainLayerId());e.setPosition(f);e.setSize(d*wade.tilemap.getTileScaleFactor(),g*wade.tilemap.getTileScaleFactor());e.customSortOrder=1;e.customSortIndex=a+b;c.imageArea&&e.setImageArea(c.imageArea.minX,c.imageArea.minY,c.imageArea.maxX,c.imageArea.maxY);this.owner.addSprite(e);this.transitionSprites[a][b]=e}this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.transitionSprites[a][b]),f)}else this.transitionSprites[a][b]&&this.owner.removeSprite(this.transitionSprites[a][b]),
this.transitionSprites[a][b]=0;this.transitionData[a][b]=c};this.setDetails=function(a,b,c,d,e,f){for(var c=c||0,d=d||0,e=e||this.numTilesX,f=f||this.numTilesY,g=0;g<a.length;g++){var i=g%this.numTilesX,h=Math.floor(g/this.numTilesX);i>=c&&(i<e&&h>=d&&h<f)&&this.setDetail(i,h,b[a[g]])}};this.setDetail=function(a,b,c){this.detailSprites[a]||(this.detailSprites[a]=[]);this.detailData[a]||(this.detailData[a]=[]);if(c){var d=!0,e=c.texture;if(c.rotation&&(e+="_tilemap_rot_"+c.rotation,"ok"!=wade.getLoadingStatus(e))){var f=
new Sprite(c.texture);f.setRotation(c.rotation*Math.PI/2);f.drawToImage(e,!0)}this.detailSprites[a][b]&&(c.animation||this.detailData[a][b].animation?(this.owner.removeSprite(this.transitionSprites[a][b]),this.transitionSprites[a][b]=0):(this.detailSprites[a][b].setImageFile(e),c.imageArea&&this.detailSprites[a][b].setImageArea(c.imageArea.minX,c.imageArea.minY,c.imageArea.maxX,c.imageArea.maxY),d=!1));f={x:this.c_origin.x+this.c_tileSize.x*a+this.c_tileSize.x/2-this.c_tileSize.x*this.numTilesX/2,
y:this.c_origin.y+this.c_tileSize.y*b+this.c_tileSize.y/2-this.c_tileSize.y*this.numTilesY/2};if(d){var d=c.scale||1,g=this.c_tileSize.x*wade.tilemap.getTileScaleFactor()*d,i=this.c_tileSize.y*wade.tilemap.getTileScaleFactor()*d;if(c.animation){var e=new Sprite(0,wade.tilemap.getTerrainLayerId()),h=new Animation(c.texture,c.animation.numFrames.x,c.animation.numFrames.y,c.animation.speed,!0);e.addAnimation("default",h);e.playAnimation("default")}else e=new Sprite(e,wade.tilemap.getTerrainLayerId());
e.setSize(g*wade.tilemap.getTileScaleFactor()*d,i*wade.tilemap.getTileScaleFactor()*d);e.customSortOrder=2;e.customSortIndex=a+b;c.imageArea&&e.setImageArea(c.imageArea.minX,c.imageArea.minY,c.imageArea.maxX,c.imageArea.maxY);this.owner.addSprite(e);this.detailSprites[a][b]=e}this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.detailSprites[a][b]),f)}else this.detailSprites[a][b]&&this.owner.removeSprite(this.detailSprites[a][b]),this.detailSprites[a][b]=0;this.detailData[a][b]=c};this.getWorldCoordinates=
function(a,b){var c=this.c_origin.x-this.numTilesX/2*this.c_tileSize.x,d=this.c_origin.y-this.numTilesY/2*this.c_tileSize.y,e=-this.c_tileSize.x*this.numTilesX/2+this.c_tileSize.x/2+a*this.c_tileSize.x+this.c_origin.x,f=-this.c_tileSize.y*this.numTilesY/2+this.c_tileSize.y/2+b*this.c_tileSize.y+this.c_origin.y;return{x:e,y:f,valid:!!(e>=c&&e<=d)&&!!(f>=c&&f<=d)}};this.getTileCoordinates=function(a,b){var c=Math.floor((a-this.c_origin.x+this.numTilesX*this.c_tileSize.x/2)/this.c_tileSize.x),d=Math.floor((b-
this.c_origin.y+this.numTilesY*this.c_tileSize.y/2)/this.c_tileSize.y);return{x:c,y:d,valid:!!(0<=c&&c<=this.numTilesX-1)&&!!(0<=d&&d<=this.numTilesY-1)}};this.onMouseDown=function(a){if(wade.app.onTilemapTerrainMouseDown){var b=this.getTileCoordinates(a.position.x,a.position.y);if(b.valid){var c=this.getWorldCoordinates(b.x,b.y);return wade.app.onTilemapTerrainMouseDown(wade.extend({gridCoords:b,worldCoords:c},a))}}return!1};this.onClick=function(a){if(wade.app.onTilemapTerrainClick){var b=this.getTileCoordinates(a.position.x,
a.position.y);if(b.valid){var c=this.getWorldCoordinates(b.x,b.y);return wade.app.onTilemapTerrainClick(wade.extend({gridCoords:b,worldCoords:c},a))}}return!1};this.onMouseUp=function(a){if(wade.app.onTilemapTerrainMouseUp){var b=this.getTileCoordinates(a.position.x,a.position.y);if(b.valid){var c=this.getWorldCoordinates(b.x,b.y);return wade.app.onTilemapTerrainMouseUp(wade.extend({gridCoords:b,worldCoords:c},a))}}return!1};this.setHighlight=function(a,b){var c;this.highlightOffsets=b||[{x:0,z:0}];
if(a instanceof Sprite){if(this.highlightTexture)for(c=0;c<this.tileHighlightObjects.length;c++)wade.removeSceneObject(this.tileHighlightObjects[c]),this.tileHighlightObjects[c]=null;this.highlightSprite=a;this.highlightTexture=null}else{if(this.highlightSprite){for(c=0;c<this.tileHighlightObjects.length;c++)wade.removeSceneObject(this.tileHighlightObjects[c]);this.tileHighlightObjects.length=0}this.highlightTexture=a;this.highlightSprite=null}if(this.highlightTexture&&this.highlightOffsets&&this.highlightOffsets.length)for(c=
0;c<this.tileHighlightObjects.length;c++)this.getTileHighlightObject(c).getSprite(0).setImageFile(a);else if(this.highlightSprite)for(c=0;c<this.tileHighlightObjects.length;c++)this.getTileHighlightObject(c);else this.hideTileHighlightObjects()};this.onMouseMove=function(a){var b,c;b=this.getTileCoordinates(a.position.x,a.position.y);if(b.valid&&(this.highlightTexture||this.highlightSprite)&&this.highlightOffsets&&this.highlightOffsets.length)for(var d=0;d<this.highlightOffsets.length;d++){var e=
this.highlightOffsets[d];c=this.getWorldCoordinates(b.x+e.x,b.y+e.y);var f=this.getTileHighlightObject(d);f.setPosition(c);f.setVisible(!0);f.tilemap.gridCoords.x=b.x+e.x;f.tilemap.gridCoords.y=b.y+e.y}else this.hideTileHighlightObjects();wade.app.onTilemapTerrainMouseMove&&wade.app.onTilemapTerrainMouseMove(wade.extend({},a,{gridCoords:b}))};this.sortingFunction=function(a,b){return b.customSortIndex-a.customSortIndex||a.customSortOrder-b.customSortOrder};this.sort=function(){wade.getLayer(wade.tilemap.getTerrainLayerId()).sort(this.sortingFunction)};
this.getTileTexture=function(a,b){return this.tileSprites[a]&&this.tileSprites[a][b]&&this.tileSprites[a][b].getImageName()};this.getTileData=function(a,b){return this.tileData[a]&&this.tileData[a][b]&&wade.cloneObject(this.tileData[a][b])};this.getTransitionData=function(a,b){return this.transitionData[a]&&this.transitionData[a][b]&&wade.cloneObject(this.transitionData[a][b])};this.getDetailData=function(a,b){return this.detailData[a]&&this.detailData[a][b]&&wade.cloneObject(this.detailData[a][b])}}
;
