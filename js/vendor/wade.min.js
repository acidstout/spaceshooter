// WADE (Web App Development Engine) - version 3.7.1 - Copyright Clockwork Chilli ltd 2012-2017 - all rights reserved 
...
typeof a.autoResize?a.autoResize:!0,this._offset={x:a.offset&&a.offset.x||0,y:a.offset&&a.offset.y||0},this._image=wade.getImage(this._imageName),this._stopped=!!a.stopped,this._imageArea=a.imageArea||{minX:0,minY:0,maxX:1,maxY:1},a.properties)for(var j in a.properties)if(a.properties.hasOwnProperty(j))try{this[j]=JSON.parse(JSON.stringify(a.properties[j]))}catch(k){}}else this._image=wade.getImage(a),this._imageName=wade.getFullPathAndFileName(a),this._numCells={x:b?b:1,y:c?c:1},this._startFrame=
f?f:0,this._endFrame="undefined"!=typeof g&&!isNaN(g)?g:b*c-1,this._speed="undefined"!=typeof d?d:20,this._looping=e,this._blending=!1,this._playMode="forward",this._stopped=!1,this._autoResize="undefined"!=typeof i?i:!0,this._offset=h||{x:0,y:0},this._offset.x=this._offset.x||0,this._offset.y=this._offset.y||0,this._imageArea={minX:0,minY:0,maxX:1,maxY:1};this._currentFrame=this._startFrame;this._playing=!1;this._time=0;this._direction=1;this._frameFraction=0;this._frameSize={x:this._image.width*
(this._imageArea.maxX-this._imageArea.minX)/this._numCells.x,y:this._image.height*(this._imageArea.maxY-this._imageArea.minY)/this._numCells.y};this._frameCorner={};try{this._f32AnimFrameInfo=new Float32Array([0,0,this._frameSize.x/this._image.width,this._frameSize.y/this._image.height])}catch(l){}this._updateFrameCorner()}Animation.prototype.getImageSize=function(){return{x:this._image.width,y:this._image.height}};Animation.prototype.getFrameSize=function(){return{x:this._frameSize.x,y:this._frameSize.y}};
Animation.prototype.getFrameCorner=function(){return{x:this._frameCorner.x,y:this._frameCorner.y}};Animation.prototype.getImageName=function(){return wade.getFullPathAndFileName(this._imageName)};Animation.prototype.getRelativeImageName=function(){return this._imageName};Animation.prototype.getNumCells=function(){return{x:this._numCells.x,y:this._numCells.y}};
...
this.name)this.sprite.onAnimationEnd(this.name);this._updateFrameCorner();this.sprite&&this.sprite.isVisible()&&this.sprite.getSceneObject()&&this.sprite.getSceneObject().isInScene()&&this.sprite.setDirtyArea()}};Animation.prototype.isPlaying=function(){return this._playing};Animation.prototype.setBlending=function(a){"undefined"==typeof a&&(a=!0);this.draw=a?this._drawBlended:this._drawSingle;this._blending=a};
...
this.sprite.getScaleFactor();this.sprite.setSize(this._frameSize.x*a.x,this._frameSize.y*a.y)}};Animation.prototype._drawSingle=function(a,b,c){wade.numDrawCalls++;a.drawImage(this._image,this._frameCorner.x,this._frameCorner.y,this._frameSize.x,this._frameSize.y,b.x-c.x/2+this._offset.x,b.y-c.y/2+this._offset.y,c.x,c.y)};
Animation.prototype._drawBlended=function(a,b,c){var d=0<this._frameFraction?this._currentFrame+this._direction:this._currentFrame-this._direction;if(d<this._startFrame){if("ping-pong"==this._playMode||!this._looping){this._drawSingle(a,b,c);return}d=this._endFrame}else if(d>this._endFrame){if("ping-pong"==this._playMode||!this._looping){this._drawSingle(a,b,c);return}d=this._startFrame}var e=d%this._numCells.x*this._frameSize.x+this._image.width*this._imageArea.minX,d=Math.floor(d/this._numCells.x)*
this._frameSize.y+this._image.height*this._imageArea.minY;wade.numDrawCalls+=2;var f=b.x-c.x/2+this._offset.x,b=b.y-c.y/2+this._offset.y,g=a.globalAlpha,i=a.globalCompositeOperation;a.globalAlpha=g*(1-this._frameFraction);a.drawImage(this._image,this._frameCorner.x,this._frameCorner.y,this._frameSize.x,this._frameSize.y,f,b,c.x,c.y);a.globalCompositeOperation="lighter";a.globalAlpha=g*this._frameFraction;a.drawImage(this._image,e,d,this._frameSize.x,this._frameSize.y,f,b,c.x,c.y);a.globalAlpha=g;
a.globalCompositeOperation=i;this.sprite&&this.sprite.isVisible()&&this.sprite.getSceneObject()&&this.sprite.getSceneObject().isInScene()&&this.sprite.setDirtyArea()};Animation.prototype.draw=Animation.prototype._drawSingle;
Animation.prototype.draw_gl=function(a,b,c){a.isWebGl?(wade.numDrawCalls++,a.uniform4fv(a.currentShader.uniforms.uPositionAndSize,b),a.uniform4fv(a.currentShader.uniforms.uAnimFrameInfo,this._f32AnimFrameInfo),a.uniform2fv(a.currentShader.uniforms.uRotationAlpha,c),a.setTextureImage(this._image),a.drawArrays(a.TRIANGLE_STRIP,0,4)):this.draw(a,{x:b[0],y:b[1]},{x:b[2],y:b[3]})};
...
this._imageArea.minY)+this._imageArea.minY)};Animation.prototype.mirror=function(){this._f32AnimFrameInfo&&(this._f32AnimFrameInfo[2]*=-1)};Animation.prototype.flip=function(){this._f32AnimFrameInfo&&(this._f32AnimFrameInfo[3]*=-1)};
...
this.response,h=new FileReader;h.onloadend=function(){var e=document.createElement("style");e.id="__wade_font_"+f;e.appendChild(document.createTextNode("@font-face {font-family: '"+f+"';src: url('"+h.result+"') format('woff');}"));document.head.appendChild(e);var i=document.createElement("span");i.innerHTML="giItT1WQy@!-/#";i.style.position="absolute";i.style.left="-10000px";i.style.top="-10000px";i.style.fontSize="300px";i.style.fontFamily="sans-serif";i.style.fontVariant="normal";i.style.fontStyle=
"normal";i.style.fontWeight="normal";i.style.letterSpacing="0";document.body.appendChild(i);var l=i.offsetWidth;i.style.fontFamily=f;var n,r=0;n=setInterval(function(){if(i&&i.offsetWidth!=l)return i.parentNode.removeChild(i),i=null,clearInterval(n),g.loadedFonts[a]=h.result,g.fontLoaded(a,c)(),!0;if(15E3<(r+=50))clearInterval(n),g.fontLoadingError(a,c,d)();return!1},50)};h.readAsDataURL(e)}};e.send()}};this.fontLoaded=function(a,c){var d=this;return function(){"ok"!=d.loadingStatus[a]&&(d.loadingSuccess.fonts++,
...
window.onblur=window.onfocus=null);window.DeviceOrientationEvent&&window.removeEventListener("deviceorientation",this.event_deviceOrientation);window.DeviceMotionEvent&&window.removeEventListener("deviceorientation",this.event_deviceMotion);m=!1}};this.enableGamepads=function(a){"undefined"==typeof a&&(a=!0);if(a)if(wade.areGamepadsSupported()){var b=navigator.getGamepads||navigator.webkitGetGamepads;wade.setMainLoop(function(){for(var a=b.call(navigator),c=0;c<a.length;c++){var d=a[c];r[c]||(r[c]=
[]);if(d)for(var e=0;e<d.buttons.length;e++){if(r[c][e]&&d.buttons[e].pressed!=r[c][e].pressed){var p=d.buttons[e].pressed?"onGamepadButtonDown":"onGamepadButtonUp",f={gamepadIndex:d.index,gamepadId:d.id,button:e};wade.app&&wade.isAppInitialized()&&!wade.processEvent(p,f)&&wade.app[p]&&wade.app[p](f)}r[c][e]={pressed:d.buttons[e].pressed,value:d.buttons[e].value}}}n=a},"__wade_gamepads")}else wade.log("Warning - Gamepads aren't supported in this browser");else wade.setMainLoop(null,"__wade_gamepads")};
this.getGamepadData=function(){return n};this.event_mouseDown=function(c){var g={screenPosition:G(c,D)};if(Math.abs(g.screenPosition.x)>wade.getScreenWidth()/2||Math.abs(g.screenPosition.y)>wade.getScreenHeight()/2)return!1;a._setLastMousePosition(g.screenPosition.x,g.screenPosition.y);var m=(new Date).getTime();if(!p&&f.mouseDown&&e.mouseDown&&m-e.mouseDown<f.mouseDown||!p&&f.mouseUp&&e.mouseUp&&m-e.mouseUp<f.mouseUp)return!1;if(p||!b){b=p?b+1:!0;h.push({x:g.screenPosition.x,y:g.screenPosition.y});
g.button=c.button;j[g.button]=1;d=c;if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onMouseDown",g))&&wade.app.onMouseDown)wade.app.onMouseDown(g);s(c);e.mouseDown=m;t.length=0;v="";t.push({x:g.screenPosition.x,y:g.screenPosition.y})}return!1};this.event_mouseUp=function(c){var g={screenPosition:G(c,D)};if(Math.abs(g.screenPosition.x)>wade.getScreenWidth()/2||Math.abs(g.screenPosition.y)>wade.getScreenHeight()/2)return!1;a._setLastMousePosition(g.screenPosition.x,g.screenPosition.y);var m=
(new Date).getTime();if(!p&&f.mouseUp&&e.mouseUp&&m-e.mouseUp<f.mouseUp)return!1;if(p||b){b=p?b-1:!1;g.button=c.button;j[g.button]=0;d=c;if(h.length){for(var i=0;i<h.length;i++){var q=g.screenPosition.x-h[i].x,y=g.screenPosition.y-h[i].y;if(q*q+y*y<=k*k){a.event_click(g);break}}h.length--}if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onMouseUp",g))&&wade.app.onMouseUp)wade.app.onMouseUp(g);!e.mouseUp&&(navigator&&navigator.userAgent.match(/(iPod|iPhone|iPad)/)&&navigator.userAgent.match(/AppleWebKit/))&&
wade.playSilentSound();s(c);e.mouseUp=m;t.length=0;v=""}return!1};this.event_mouseMove=function(b){var c={screenPosition:G(b,D)};if(Math.abs(c.screenPosition.x)>wade.getScreenWidth()/2||Math.abs(c.screenPosition.y)>wade.getScreenHeight()/2)return!1;a._setLastMousePosition(c.screenPosition.x,c.screenPosition.y);var g=(new Date).getTime();if(!p&&f.mouseMove&&e.mouseMove&&g-e.mouseMove<f.mouseMove)return!1;d=b;if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onMouseMove",c))&&wade.app.onMouseMove)wade.app.onMouseMove(c);
e.mouseMove=g;s(b);a.isMouseDown()&&(t.push({x:c.screenPosition.x,y:c.screenPosition.y}),a.detectGestures())};this.event_mouseWheel=function(b){var b=b?b:window.event,c={screenPosition:G(b,D)};if(Math.abs(c.screenPosition.x)>wade.getScreenWidth()/2||Math.abs(c.screenPosition.y)>wade.getScreenHeight()/2)return!1;a._setLastMousePosition(c.screenPosition.x,c.screenPosition.y);var g=(new Date).getTime();if(p||!f.mouseWheel||!(e.mouseWheel&&g-e.mouseWheel<f.mouseWheel)){c.value=b.detail?-1*b.detail:b.wheelDelta/
40;d=c;if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onMouseWheel",c))&&wade.app.onMouseWheel)wade.app.onMouseWheel(c);e.mouseWheel=g;s(b)}};this.event_click=function(a){var b=(new Date).getTime();if(p||!f.onClick||!(e.onClick&&b-e.onClick<f.onClick)){if(wade.app&&(wade.isAppInitialized()&&!wade.processEvent("onClick",a))&&wade.app.onClick)wade.app.onClick(a);e.onClick=b}};this.event_touchStart=function(b){var d=b.touches||i;if(2==d.length){var e=d[0].pageX-d[1].pageX,f=d[0].pageY-d[1].pageY;
c=Math.sqrt(e*e+f*f);p&&a.event_mouseDown(d[1])}else 1==d.length?a.event_mouseDown(d[0]):p&&a.event_mouseDown(d[d.length-1]);s(b)};this.event_touchEnd=function(b){if(b.changedTouches&&b.changedTouches.length)for(var c=0;c<b.changedTouches.length;c++)a.event_mouseUp(b.changedTouches[c]);else a.event_mouseUp(d);s(b)};this.event_touchMove=function(b){var d;d=b.touches||i;if(2==d.length){var e=d[0].pageX-d[1].pageX,f=d[0].pageY-d[1].pageY;if(e=Math.sqrt(e*e+f*f))f=c-e,Math.abs(f)>wade.c_epsilon&&(f=-30*
f/Math.max(wade.getScreenWidth(),wade.getScreenHeight()),a.event_mouseWheel({clientX:d[0].pageX,clientY:d[0].pageY,detail:-f}));c=e;if(p&&b.changedTouches)for(d=0;d<b.changedTouches.length;d++)a.event_mouseMove({clientX:b.changedTouches[d].pageX,clientY:b.changedTouches[d].pageY})}else if(1==d.length)a.event_mouseMove({clientX:d[0].pageX,clientY:d[0].pageY});else if(p&&b.changedTouches)for(d=0;d<b.changedTouches.length;d++)a.event_mouseMove({clientX:b.changedTouches[d].pageX,clientY:b.changedTouches[d].pageY});
s(b)};this.event_keyDown=function(a){var b={keyCode:"which"in a?a.which:a.keyCode,shift:a.shiftKey,ctrl:a.ctrlKey,alt:a.altKey,meta:a.metaKey};b.keyName=x[b.keyCode];w[b.keyCode]=!0;wade.app&&wade.isAppInitialized()&&!wade.processEvent("onKeyDown",b)?wade.app.onKeyDown&&wade.app.onKeyDown(b)&&s(a):s(a)};this.event_keyUp=function(a){var b={keyCode:"which"in a?a.which:a.keyCode,shift:a.shiftKey,ctrl:a.ctrlKey,alt:a.altKey,meta:a.metaKey};b.keyName=x[b.keyCode];w[b.keyCode]=!1;wade.app&&wade.isAppInitialized()&&
!wade.processEvent("onKeyUp",b)?wade.app.onKeyUp&&wade.app.onKeyUp(b)&&s(a):s(a)};this.event_keyPress=function(a){var b={charCode:"charCode"in a?a.charCode:a.keyCode};b.charName=String.fromCharCode(b.charCode);wade.app&&wade.isAppInitialized()&&!wade.processEvent("onKeyPress",b)?wade.app.onKeyPress&&wade.app.onKeyPress(b)&&s(a):s(a)};this.isKeyDown=function(a){return"string"==typeof a?!!w[this.getKeyCode(a)]:!!w[a]};this.event_pointerDown=function(b){g[b.pointerId]||(g[b.pointerId]=1,i.push({pageX:b.pageX,
pageY:b.pageY,clientX:b.clientX,clientY:b.clientY,pointerId:b.pointerId}),a.event_touchStart(b))};this.event_pointerUp=function(b){if(g[b.pointerId]){for(var c=0;c<i.length;c++)if(i[c].pointerId==b.pointerId){wade.removeObjectFromArrayByIndex(c,i);break}g[b.pointerId]=0;a.event_touchEnd({changedTouches:[b]})}};this.event_pointerMove=function(b){if(g[b.pointerId]){for(var c=0;c<i.length;c++)if(i[c].pointerId==b.pointerId){i[c].pageX=b.pageX;i[c].pageY=b.pageY;i[c].clientX=b.clientX;i[c].clientY=b.clientY;
b.changedTouches=[i[c]];break}a.event_touchMove(b)}};this.event_deviceMotion=function(a){if(a.acceleration&&null!==a.acceleration.x){var b={acceleration:a.acceleration,accelerationIncludingGravity:a.accelerationIncludingGravity,rotation:a.rotationRate,refreshInterval:a.interval};wade.app&&wade.isAppInitialized()&&!wade.processEvent("onDeviceMotion",b)?wade.app.onDeviceMotion&&wade.app.onDeviceMotion(b)&&s(a):s(a)}};this.event_deviceOrientation=function(a){if(null!==a.alpha){var b={alpha:a.alpha,beta:a.beta,
gamma:a.gamma};wade.app&&wade.isAppInitialized()&&!wade.processEvent("onDeviceOrientation",b)?wade.app.onDeviceOrientation&&wade.app.onDeviceOrientation(b)&&s(a):s(a)}};this.event_gamepadConnected=function(a){wade.app.onGamepadConnected&&wade.app.onGamepadConnected({gamepadId:a.gamepad.id})};this.event_gamepadDisconnected=function(a){wade.app.onGamepadDisconnected&&wade.app.onGamepadDisconnected({gamepadId:a.gamepad.id})};this.event_blur=function(a){var b={};wade.app&&wade.isAppInitialized()&&!wade.processEvent("onBlur",
b)?wade.app.onBlur&&wade.app.onBlur(b)&&s(a):s(a)};this.event_focus=function(a){var b={};wade.app&&wade.isAppInitialized()&&!wade.processEvent("onFocus",b)?wade.app.onFocus&&wade.app.onFocus(b)&&s(a):s(a)};this.noEvent=function(a){s(a)};this.isMouseDown=function(a){return"undefined"==typeof a?!!b:!!j[a]};this.setMinimumIntervalBetweenEvents=function(a,b){f[a]=b};this.setClickTolerance=function(a){k=a};this.getMousePosition=function(){return{x:l.x,y:l.y}};this.enableMultitouch=function(a){p=a};this.isMultitouchEnabled=
function(){return p};this.cancelEvents=function(a){"undefined"==typeof a&&(a=!0);q=a};this._setLastMousePosition=function(a,b){if(a!=l.x||b!=l.y)wade.updateMouseInOut(l,{x:a,y:b}),l.x=a,l.y=b};this.detectGestures=function(){var a=0,b=0,c=0,d=0;if(!v&&t.length<3*u){for(var e=1;e<t.length&&!v;e++){var f=t[e].x-t[e-1].x||wade.c_epsilon,p=t[e].y-t[e-1].y||wade.c_epsilon,g=f/Math.abs(p),f=p/Math.abs(f);-1>g&&Math.abs(f)<=y&&++a==u&&!b&&!c&&!d?v="onSwipeLeft":1<g&&Math.abs(f)<=y&&++b==u&&!a&&!c&&!d?v="onSwipeRight":
-1>f&&Math.abs(g)<=y&&++c==u&&!a&&!b&&!d?v="onSwipeUp":1<f&&(Math.abs(g)<=y&&++d==u&&!a&&!c&&!b)&&(v="onSwipeDown")}if(v&&(a=t[0],a={screenPosition:{x:a.x,y:a.y},screenPositions:t},wade.app&&(wade.isAppInitialized()&&!wade.processEvent(v,a))&&wade.app[v]))wade.app[v](a)}};this.setSwipeTolerance=function(a,b){y=a;u=b};this.getKeyName=function(a){return x[a]};this.getKeyCode=function(a){return F[a]}}
function Layer(a,b){this.id=a;this._sprites=[];this._movingSprites=[];this._transform={scale:1,translate:1};this._sorting="none";this._dirtyAreas=[];this._smoothing=this._clearCanvas=this._needsFullRedraw=!0;this._resolutionFactor=wade.getResolutionFactor();this._cameraPosition=wade.getCameraPosition();this._useQuadtree=!0;this._opacity=1;this._postProcessUniforms={};this._postProcessShaderProgram=null;this._customProperties={};this._renderMode=b||"webgl";"webgl"==this._renderMode&&!wade.isWebGlSupported()&&
(this._renderMode="2d",wade.log("WebGL is not supported in this environment, layer "+a+" is falling back to a canvas-based renderer."));this._useOffScreenTarget=!1;this._alwaysDrawSprites=[];this._updateScaleConversionFactor();try{this._f32ViewportSize=new Float32Array([0,0]),this._f32CameraScaleTranslateTime=new Float32Array([0,0,0,0])}catch(c){}this.initCanvas();var d=wade.getScreenWidth()/2,e=wade.getScreenHeight()/2;this._worldBounds={minX:-d,minY:-e,maxX:d,maxY:e};this._initQuadTree()}
Layer.prototype.getScaleFactor=function(){return this._transform.scale};Layer.prototype.getTranslateFactor=function(){return this._transform.translate};Layer.prototype.setTransform=function(a,b){this._transform.scale=a;this._transform.translate=b;this._updateScaleConversionFactor();this._needsFullRedraw=!0};Layer.prototype.getSorting=function(){return this._sorting};
...
this._resolutionFactor,g=e/2,i=f/2;if("none"!=this._sorting)if(this._needsFullSorting=this._needsFullSorting||this._movingSprites.length*this._movingSprites.length>this._sprites.length)this._sprites.sort(this._sortingFunction);else for(b=0;b<this._movingSprites.length;b++){var h=0,j=this._movingSprites[b];for(c=0;c<this._sprites.length&&j!=this._sprites[c];c++);if(c<this._sprites.length){for(a=c+1;a<this._sprites.length;a++)if(0<this._sortingFunction(j,this._sprites[a]))this._sprites[a].setDirtyArea(),
this._sprites[a-1]=this._sprites[a],this._sprites[a]=j,h++;else break;if(!h)for(a=c-1;0<=a;a--)if(0>this._sortingFunction(j,this._sprites[a]))this._sprites[a].setDirtyArea(),this._sprites[a+1]=this._sprites[a],this._sprites[a]=j,h++;else break}}this._needsFullSorting=!1;this._movingSprites.length=0;h="webgl"==this._renderMode?"draw_gl":"draw";"webgl"==this._renderMode&&(d.bindFramebuffer(d.FRAMEBUFFER,this._useOffScreenTarget?this._mainRenderTarget:null),d.uniform2fv(d.currentShader.uniforms.uViewportSize,
this._f32ViewportSize),d.uniform4fv(d.currentShader.uniforms.uCameraScaleTranslateTime,this._f32CameraScaleTranslateTime));if(this._useQuadtree){b=this.canvasBoxToWorld({minX:-g,minY:-i,maxX:g,maxY:i});this._needsFullRedraw?(a=this._scaleConversionFactor,c=g-this._cameraPosition.x*this._transform.translate*a,j=i-this._cameraPosition.y*this._transform.translate*a,"2d"==this._renderMode?(d.restore(),d.save(),d.setTransform(a,0,0,a,Math.round(c),Math.round(j))):"webgl"==this._renderMode&&(this._f32CameraScaleTranslateTime[0]=
a,this._f32CameraScaleTranslateTime[1]=this._cameraPosition.x*this._transform.translate*a,this._f32CameraScaleTranslateTime[2]=this._cameraPosition.y*this._transform.translate*a,this._f32CameraScaleTranslateTime[3]=wade.getAppTime(),d.uniform4fv(d.currentShader.uniforms.uCameraScaleTranslateTime,this._f32CameraScaleTranslateTime)),j=wade.cloneObject(b)):j=this._joinDirtyAreas();if(!j){this.clearDirtyAreas();"webgl"==this._renderMode&&this._useOffScreenTarget&&this.drawRenderTargetToScreen();return}for(a=
0;a<this._sprites.length;a++)this._sprites[a].needsDrawing=0;for(a=0;a.minX!=j.minX||a.minY!=j.minY||a.maxX!=j.maxX||a.maxY!=j.maxY;){if(isNaN(j.minX)||isNaN(j.minY)||isNaN(j.maxX)||isNaN(j.maxY)){wade.warn("Warning: it isn't possible to render this frame");a=wade.getCameraPosition();(isNaN(a.x)||isNaN(a.y)||isNaN(a.z))&&wade.warn("*** Invalid camera coodinates: "+a.x+", "+a.y+", "+a.z);for(a=0;a<this._sprites.length;a++)if(d=this._sprites[a].getPosition(),f=this._sprites[a].getSize(),g=isNaN(d.x)||
isNaN(d.y),i=isNaN(f.x)||isNaN(f.y),g||i){h=(e=this._sprites[a].getSceneObject())&&e.getName()||"";c=this._sprites[a].getName();if(!c)if(e)for(b=0;b<e.getSpriteCount();b++){if(e.getSprite(b)==this._sprites[a]){c="Sprite"+b;break}}else c="Unnamed Sprite";e=(h?h+".":"")+c;g&&wade.warn("*** "+e+" has an invalid position: "+d.x+", "+d.y);i&&wade.warn("*** "+e+" has an invalid size: "+f.x+", "+f.y)}return}this._quadTree.flagObjects(j,"needsDrawing");a=wade.cloneObject(j);for(c=0;c<this._sprites.length;c++)(this._sprites[c].needsDrawing||
this._sprites[c].isAlwaysDrawing)&&this._sprites[c].isVisible()&&wade.expandBox(j,this._sprites[c].boundingBox);wade.clampBoxToBox(j,b)}this._clearCanvas&&("2d"==this._renderMode?(d.save(),d.setTransform(1,0,0,1,0,0),this._needsFullRedraw?d.clearRect(0,0,Math.round(e),Math.round(f)):(a=this.worldBoxToCanvas(j),d.clearRect(Math.floor(a.minX+g-1),Math.floor(a.minY+i-1),Math.ceil(a.maxX-a.minX+2),Math.ceil(a.maxY-a.minY+2))),d.restore()):"webgl"==this._renderMode&&(this._needsFullRedraw?d.clear(d.COLOR_BUFFER_BIT):
(a=this.worldBoxToCanvas(j),d.enable(d.SCISSOR_TEST),d.scissor(Math.floor(a.minX+g-1),f-Math.floor(a.minY+i-1)-Math.ceil(a.maxY-a.minY+2),Math.ceil(a.maxX-a.minX+2),Math.ceil(a.maxY-a.minY+2)),d.clear(d.COLOR_BUFFER_BIT),d.disable(d.SCISSOR_TEST))));this.clearDirtyAreas();"2d"==this._renderMode?this._canvas.style.opacity!=this._opacity&&(this._canvas.style.opacity=this._opacity):1!=this._canvas.style.opacity&&(this._canvas.style.opacity=1);for(b=0;b<this._sprites.length;b++)if(this._sprites[b].needsDrawing||
this._sprites[b].isAlwaysDrawing())this._sprites[b][h](d)}else{a=this._scaleConversionFactor;c=g-this._cameraPosition.x*this._transform.translate*a;j=i-this._cameraPosition.y*this._transform.translate*a;"webgl"==this._renderMode?(this._hasOwnCanvas&&d.clear(d.COLOR_BUFFER_BIT),this._f32CameraScaleTranslateTime[0]=a,this._f32CameraScaleTranslateTime[1]=this._cameraPosition.x*this._transform.translate*a,this._f32CameraScaleTranslateTime[2]=this._cameraPosition.y*this._transform.translate*a,d.uniform4fv(d.currentShader.uniforms.uCameraScaleTranslateTime,
this._f32CameraScaleTranslateTime)):"2d"==this._renderMode&&(d.save(),d.setTransform(1,0,0,1,0,0),d.clearRect(0,0,Math.round(e),Math.round(f)),d.restore(),d.setTransform(a,0,0,a,Math.round(c),Math.round(j)));this.clearDirtyAreas();"2d"==this._renderMode&&this._canvas.style.opacity!=this._opacity&&(this._canvas.style.opacity=this._opacity);for(b=0;b<this._sprites.length;b++)this._sprites[b][h](d)}"webgl"==this._renderMode&&this._useOffScreenTarget&&this.drawRenderTargetToScreen()}};
Layer.prototype.drawRenderTargetToScreen=function(){var a=this._context;this.setShaderProgram(this._postProcessShaderProgram||a.defaultShaderProgram);a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);this._f32CameraScaleTranslateTime[0]=1;this._f32CameraScaleTranslateTime[1]=0;this._f32CameraScaleTranslateTime[2]=0;this._f32CameraScaleTranslateTime[3]=wade.getAppTime();a.bindFramebuffer(a.FRAMEBUFFER,null);this._hasOwnCanvas&&a.clear(a.COLOR_BUFFER_BIT);a.uniform4fv(a.currentShader.uniforms.uCameraScaleTranslateTime,
this._f32CameraScaleTranslateTime);a.uniform4fv(a.currentShader.uniforms.uPositionAndSize,this._mainRenderTarget.uniformValues.positionAndSize);a.uniform4fv(a.currentShader.uniforms.uAnimFrameInfo,this._mainRenderTarget.uniformValues.animFrameInfo);a.uniform4fv(a.currentShader.uniforms.uImageArea,this._mainRenderTarget.uniformValues.imageArea);a.uniform2fv(a.currentShader.uniforms.uRotationAlpha,this._mainRenderTarget.uniformValues.rotationAlpha);a.bindTexture(a.TEXTURE_2D,this._mainRenderTarget.texture);
if(this._postProcessUniforms){var b=1,c=Sprite.prototype.uniformTypeNames,d;for(d in this._postProcessUniforms){var e=this._postProcessUniforms[d],f=c[e];if(f)if(this._typedPostProcessUniforms&&this._typedPostProcessUniforms[d]){for(e=0;e<this._typedPostProcessUniforms[d].length;e++)this._typedPostProcessUniforms[d][e]=this._customProperties[d]&&this._customProperties[d][e]||0;a[f](this._postProcessShaderProgram.uniforms[d],this._typedPostProcessUniforms[d])}else a[f](this._postProcessShaderProgram.uniforms[d],
...
Layer.prototype.resize=function(a,b){if(this._canvas){if("webgl"!=this._renderMode||this._hasOwnCanvas)this._canvas.width=Math.round(a*this._resolutionFactor),this._canvas.height=Math.round(b*this._resolutionFactor);"webgl"==this._renderMode&&(this._f32ViewportSize[0]=this._canvas.width,this._f32ViewportSize[1]=this._canvas.height,this._mainRenderTarget.uniformValues.positionAndSize[2]=this._canvas.width,this._mainRenderTarget.uniformValues.positionAndSize[3]=this._canvas.height,this._hasOwnCanvas&&
(this._context.viewport(0,0,this._canvas.width,this._canvas.height),this._context.uniform2fv(this._context.currentShader.uniforms.uViewportSize,this._f32ViewportSize),this._context.currentImage=[]),this._context.bindTexture(this._context.TEXTURE_2D,this._mainRenderTarget.texture),this._context.texImage2D(this._context.TEXTURE_2D,0,this._context.RGBA,this._canvas.width,this._canvas.height,0,this._context.RGBA,this._context.UNSIGNED_BYTE,null),this._context.bindTexture(this._context.TEXTURE_2D,null))}this._needsFullRedraw=
!0;this._smoothing||(this._smoothing=!0,this.setSmoothing(!1))};Layer.prototype.setCanvasClearing=function(a){this._clearCanvas=a};Layer.prototype.getContext=function(){return this._context};Layer.prototype.bringSpriteToFront=function(a){a.setDirtyArea();wade.removeObjectFromArray(a,this._sprites);this._sprites.push(a)};Layer.prototype.pushSpriteToBack=function(a){a.setDirtyArea();wade.removeObjectFromArray(a,this._sprites);this._sprites.splice(0,0,a)};
Layer.prototype.putSpriteBehindSprite=function(a,b){var c=this._sprites.indexOf(b);wade.removeObjectFromArray(a,this._sprites);this._sprites.splice(c,0,a)};Layer.prototype.setCanvasStyleSize=function(a,b){if(this._canvas&&(a!=this._canvas.style.width||b!=this._canvas.style.height))this._canvas.style.width=a,this._canvas.style.height=b};Layer.prototype.compareSprites=function(a,b){return this._sortingFunction?this._sortingFunction(a,b):a.id-b.id};
...
a.getCanvas(),this._context=a.getContext(),this._setupMainRenderTarget(this._context,this._canvas),this._f32ViewportSize[0]=this._canvas.width,this._f32ViewportSize[1]=this._canvas.height,a.id<this.id?(this._hasOwnCanvas=!0,a.disownCanvas()):(this._hasOwnCanvas=!1,this._useOffScreenTarget=!0),this._context.currentImage)for(a=0;a<this._context.currentImage.length;a++)this._context.currentImage[a]=null}else this._createCanvas(),this._setupMainRenderTarget(this._context,this._canvas),this._hasOwnCanvas=
!0};Layer.prototype.disownCanvas=function(){this._hasOwnCanvas=!1;this._needsFullRedraw=this._useOffScreenTarget=!0};Layer.prototype.ownCanvas=function(){this._needsFullRedraw=this._hasOwnCanvas=!0;this._canvas.style.zIndex=-this.id};Layer.prototype.hasOwnCanvas=function(){return this._hasOwnCanvas};
...
this._renderMode?this._context=this._canvas.getContext("2d"):this._renderMode="webgl";this._context.imageSmoothingEnabled=this._context.imageSmoothingEnabled=this._context.msImageSmoothingEnabled=this._context.oImageSmoothingEnabled=this._smoothing;"2d"==this._renderMode&&this._context.save();this._needsFullRedraw=!0}};Layer.prototype.getCanvas=function(){return this._canvas};
...
Layer.prototype.setSmoothing=function(a){a!=this._smoothing&&(this._smoothing=a,this._context.restore(),this._context.imageSmoothingEnabled=this._context.imageSmoothingEnabled=this._context.msImageSmoothingEnabled=this._context.oImageSmoothingEnabled=a,this._context.save(),this._needsFullRedraw=!0)};Layer.prototype.getSmoothing=function(){return this._smoothing};
Layer.prototype.addSpritesInAreaToArray=function(a,b,c){if(c&&this._sortingFunction){c=[];this._quadTree.addObjectsInAreaToArray(a,c);c.sort(this._sortingFunction);for(a=c.length-1;0<=a;a--)b.push(c[a])}else this._quadTree.addObjectsInAreaToArray(a,b)};Layer.prototype.toDataURL=function(){return this._canvas.toDataURL()};Layer.prototype.forceRedraw=function(){this._needsFullRedraw=!0};
Layer.prototype.setOpacity=function(a){a!=this._opacity&&(this._opacity=a,this._mainRenderTarget&&(this._mainRenderTarget.uniformValues.rotationAlpha[1]=a),this._needsFullRedraw=!0)};Layer.prototype.getOpacity=function(){return this._opacity};
...
Layer.prototype.getShaderProgram=function(a,b,c){if("webgl"!=this._renderMode)wade.log("cannot use shader programs in canvas mode");else{var b=b||a.defaultVertexShader,c=c||a.defaultPixelShader,d=a.shaderPrograms[b.hash+c.hash];if(d)return d;d=a.createProgram();a.attachShader(d,b);a.attachShader(d,c);a.linkProgram(d);if(a.getProgramParameter(d,a.LINK_STATUS)){d.vertexPositionAttribute=a.getAttribLocation(d,"aVertexPosition");d.uniforms={};d.uniforms.uCameraScaleTranslateTime=a.getUniformLocation(d,
"uCameraScaleTranslateTime");d.uniforms.uViewportSize=a.getUniformLocation(d,"uViewportSize");d.uniforms.uPositionAndSize=a.getUniformLocation(d,"uPositionAndSize");d.uniforms.uAnimFrameInfo=a.getUniformLocation(d,"uAnimFrameInfo");d.uniforms.uRotationAlpha=a.getUniformLocation(d,"uRotationAlpha");d.uniforms.uDiffuseSampler=a.getUniformLocation(d,"uDiffuseSampler");if(c.customUniforms)for(var e in c.customUniforms)d.uniforms[e]=a.getUniformLocation(d,e);return a.shaderPrograms[b.hash+c.hash]=d}wade.log("Unable to link a WebGl shader program")}};
Layer.prototype.getDefaultPixelShaderSource=function(){return"highp vec4 color = texture2D(uDiffuseSampler, uvAlphaTime.xy); \ncolor.w *= uvAlphaTime.z; \ngl_FragColor = color;"};Layer.prototype.setShaderProgram=function(a){var b=this._context;b.currentShader!=a&&(b.useProgram(b.currentShader=a),b.uniform2fv(b.currentShader.uniforms.uViewportSize,this._f32ViewportSize),b.uniform4fv(b.currentShader.uniforms.uCameraScaleTranslateTime,this._f32CameraScaleTranslateTime))};
Layer.prototype._setupWebGl=function(a,b){a.clearColor(0,0,0,0);a.clear(a.COLOR_BUFFER_BIT);a.vertexShaders={};a.pixelShaders={};a.shaderPrograms={};var c=a.defaultVertexShader=this.getVertexShader(a,"attribute vec3 aVertexPosition;\nuniform vec4 uCameraScaleTranslateTime;\nuniform vec2 uViewportSize;\nuniform vec4 uPositionAndSize;\nuniform vec4 uAnimFrameInfo;\nuniform vec2 uRotationAlpha;\nvarying highp vec4 uvAlphaTime;\nvoid main(void) {\nfloat s = sin(uRotationAlpha.x);\nfloat c = cos(uRotationAlpha.x);\nvec2 pos = aVertexPosition.xy * uPositionAndSize.zw;\npos = vec2(pos.x * c - pos.y * s, pos.y * c + pos.x * s);\npos += uPositionAndSize.xy * 2.0;\npos *= uCameraScaleTranslateTime.x;\npos -= uCameraScaleTranslateTime.yz * 2.0;\npos /= uViewportSize;\npos.y *= -1.0;\nuvAlphaTime.xy = (aVertexPosition.xy + 1.0) * 0.5;\nuvAlphaTime.x = (uAnimFrameInfo.z < 0.0)? 1.0 - uvAlphaTime.x : uvAlphaTime.x;\nuvAlphaTime.y = (uAnimFrameInfo.w < 0.0)? 1.0 - uvAlphaTime.y : uvAlphaTime.y;\nuvAlphaTime.xy *= abs(uAnimFrameInfo.zw);\nuvAlphaTime.xy += uAnimFrameInfo.xy;\nuvAlphaTime.z = uRotationAlpha.y;\nuvAlphaTime.w = uCameraScaleTranslateTime.w;\ngl_Position = vec4(pos, 0.0, 1.0);\n}"),
d=this.getDefaultPixelShaderSource(),d=a.defaultPixelShader=this.getPixelShader(a,d);(c=this.getShaderProgram(a,c,d))?(a.defaultShaderProgram=this._postProcessShaderProgram=c,this.setShaderProgram(c),d=a.createBuffer(),a.enableVertexAttribArray(c.vertexPositionAttribute),a.bindBuffer(a.ARRAY_BUFFER,d),a.bufferData(a.ARRAY_BUFFER,new Float32Array([1,1,0,-1,1,0,1,-1,0,-1,-1,0]),a.STATIC_DRAW),a.vertexAttribPointer(c.vertexPositionAttribute,3,a.FLOAT,!1,0,0),a.activeTexture(a.TEXTURE0),a.uniform1i(c.uniforms.uDiffuseSampler,
0),a.disable(a.DEPTH_TEST),a.enable(a.BLEND),a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),a.textures={},a.setTextureImage=function(b,c,d){var i=b&&b.imageName||"",d=d||0;if(a.currentImage[d]!=i){if(a.textures[i])c||a.bindTexture(a.TEXTURE_2D,a.textures[i]);else if(b){var h=a.createTexture();a.bindTexture(a.TEXTURE_2D,h);wade.texImage2D(a,{width:b&&b.width||0,height:b&&b.height||0,image:b});a.textures[i]=h;wade.addImageUser(i,
this);c&&(a.bindTexture(a.TEXTURE_2D,null),a.currentImage[d]=null)}else a.currentImage[d]=null;c||(a.currentImage[d]=i)}},a.setActiveImage=function(b){a.bindTexture(a.TEXTURE_2D,a.textures[b]);b=wade.getImage(b);wade.texImage2D(a,{width:b.width,height:b.height,image:b})},a.onImageUnloaded=function(b){a.deleteTexture(a.textures[b]);delete a.textures[b]},a.currentImage=[],a.globalAlpha=1,this._f32ViewportSize[0]=this._canvas.width,this._f32ViewportSize[1]=this._canvas.height,a.viewport(0,0,b.width,
b.height),a.uniform2fv(c.uniforms.uViewportSize,this._f32ViewportSize)):wade.error("Unable to compile default shader")};
Layer.prototype._setupMainRenderTarget=function(a,b){"webgl"==this._renderMode&&(this._mainRenderTarget=a.createFramebuffer(),a.bindFramebuffer(a.FRAMEBUFFER,this._mainRenderTarget),a.disable(a.DEPTH_TEST),this._mainRenderTarget.texture=a.createTexture(),a.bindTexture(a.TEXTURE_2D,this._mainRenderTarget.texture),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MAG_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE),a.texParameteri(a.TEXTURE_2D,
a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE),a.texImage2D(a.TEXTURE_2D,0,a.RGBA,b.width,b.height,0,a.RGBA,a.UNSIGNED_BYTE,null),a.framebufferTexture2D(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,this._mainRenderTarget.texture,0),a.bindTexture(a.TEXTURE_2D,null),a.bindFramebuffer(a.FRAMEBUFFER,null),this._mainRenderTarget.uniformValues={positionAndSize:new Float32Array([0,0,b.width,b.height]),animFrameInfo:new Float32Array([0,0,1,-1]),rotationAlpha:new Float32Array([0,this._opacity]),imageArea:new Float32Array([0,
0,1,1])})};
...
"webgl"==this._renderMode))for(a=0;a<this._sprites.length;a++)this._sprites[a].refreshShader()};Layer.prototype.getRenderMode=function(){return this._renderMode};Layer.prototype.getF32ViewportSize=function(){return this._f32ViewportSize};
...
this._nodes[c].position){var d=new Sprite("__wade_pathNode_",b);d.nodeIndex=c;d.isNodeSprite=!0;var e={x:this._nodes[c].position.x,y:this._nodes[c].position.y,angle:this._nodes[c].rotation||0},f=new TextSprite(c.toString(),"16px Arial","#FFF","center",b);f.setOutline(1,"#FFF");f.nodeIndex=c;f.isNodeSprite=!0;if(this._nodes[c+1]&&this._nodes[c+1].position){var g={x:this._nodes[c].position.x,y:this._nodes[c].position.y},i=this._nodes[c+1].position,h=wade.vec2.sub(i,g),j=Math.floor(wade.vec2.length(h)/
32),k=new Sprite("__wade_pathLine_",b);k.setSize(wade.vec2.length(h),2);var l=wade.vec2.add(g,wade.vec2.scale(h,0.5));l.angle=Math.atan2(g.y-i.y,g.x-i.x);this._debugDraw.addSprite(k,l);i=this._getInterpolationFunction(c);for(k=0;k<j;k++)if(l={x:i(k/(j-1),g.x,h.x),y:i(k/(j-1),g.y,h.y)},k!=j-1){var n=new Sprite("__wade_pathSubNode_",b);n.nodeIndex=c;n.isIntermediateSprite=!0;this._debugDraw.addSprite(n,l)}}this._debugDraw.addSprite(d,e);e.y+=10;this._debugDraw.addSprite(f,{x:e.x,y:e.y-4,angle:e.angle})}}else wade.removeSceneObject(this._debugDraw),
...
g,e,c,d),f=0;f<a.getSpriteCount();f++)a.getSprite(f).setSize(h.x,h.y);if("undefined"!=typeof c.opacity)for(var j=this._evaluateProperty("opacity",g,e,c,d),f=0;f<a.getSpriteCount();f++){for(var h=a.getSprite(f),k=h.getDrawModifiers(),l=k.length-1;0<=l;l--){var n=k[l];("alpha"==n.type||"fadeOpacity"==n.type)&&wade.removeObjectFromArrayByIndex(l,k)}k.push({type:"alpha",alpha:j});l=h instanceof TextSprite?TextSprite.prototype:Sprite.prototype;l="webgl"==wade.getLayer(h.getLayerId()).getRenderMode()?l.draw_gl:
l.draw;h.setDrawFunction(l);h.setDrawModifiers(k)}if(c.properties&&d.properties)for(var r in c.properties){j=this._evaluateProperty(r,g,e,c.properties,d.properties);a[r]=j;for(f=0;f<a.getSpriteCount();f++)h=a.getSprite(f),h[r]=j}return i};
...
function Renderer(){var a={},b=[],c=0,d=0,e=0,f="full",g=1920,i=1080,h=0,j=0,k={x:0,y:0,z:1},l={},n=!0,r=!1,t=0,v=0;this._createLayerIfNeeded=function(c,d){a[c]||(a[c]=new Layer(c,d),n||a[c].setSmoothing(n),b.push(a[c]),b.sort(this._layerSorter))};this.removeLayer=function(c){a[c]&&(wade.removeObjectFromArray(a[c],b),b.sort(this._layerSorter),a[c].removeCanvas(),a[c]=null)};this.removeUnusedLayers=function(a){for(var c=b.length-1;0<=c;c--)!b[c].getSpriteCount()&&(!a||-1==a.indexOf(b[c].id))&&this.removeLayer(b[c].id)};
this.getActiveLayerIds=function(){return wade.cloneArray(b)};this.init=function(a){e=a;a=document.getElementById(wade.getContainerName());c=parseInt(a.getAttribute("width"));d=parseInt(a.getAttribute("height"))};this.draw=function(a,m){var q,k,l;if(e.getSimulationDirtyState()||a||m){wade.numDrawCalls=0;var n=wade.logDrawTime&&console.time&&console.timeEnd&&0.02>Math.random();n&&console.time("Draw");var w=document.getElementById(wade.getContainerName()),x=wade.getForcedOrientation();q=wade.getContainerWidth();
k=wade.getContainerHeight();var F=r;switch(x){case "landscape":k>q&&(r=!r);break;case "portrait":q>k&&(r=!r);break;default:r=!1}if(r!=F){var z=r?"rotateZ(90deg)":"translate3d(0, 0, 0)";w.style.MozTransform=z;w.style.msTransform=z;w.style.OTransform=z;w.style.webkitTransform=z;w.style.transform=z}z=!1;q=wade.getContainerWidth();k=wade.getContainerHeight();var G=t!=q||v!=k;if(G){var s={width:q,height:k};e.processEvent("onContainerResize",s)||wade.app.onContainerResize&&wade.app.onContainerResize(s)}var A,
C;if("full"==f){var s=c,B=d;c=Math.max(Math.min(q,g),h);d=Math.max(Math.min(k,i),j);c>q||d>k?c/q>d/k?(d=Math.max(Math.min(Math.min(d,k)*c/q,i),j),A=q+"px",C=Math.floor(q*d/c)+"px"):(c=Math.max(Math.min(Math.min(c,q)*d/k,g),h),A=Math.floor(k*c/d)+"px",C=k+"px"):c<q&&d<k?c/q>d/k?(C=Math.floor(q*d/c)+"px",A=q+"px"):(C=k+"px",A=Math.floor(k*c/d)+"px"):(C=d+"px",A=c+"px");if(s!=c||B!=d)w.setAttribute("width",c.toString()),w.setAttribute("height",d.toString()),e.onResize(s,B,c,d),z=!0}else"stretch to fit"==
f?q/c>k/d?(A=Math.floor(k*c/d)+"px",C=q+"px"):(A=q+"px",C=Math.floor(q*d/c)+"px"):"container"==f&&(s=c,B=d,c=w.getAttribute("width"),d=w.getAttribute("height"),z=s!=c||B!=d,A=c+"px",C=d+"px",z&&(l=!0,e.onResize(s,B,c,d)));if(l=l||A&&C&&(A!=w.style.width||C!=w.style.height)||r!=F||r&&G)w.style.width=A,w.style.height=C,r?"landscape"==x?(x=getComputedStyle(w),x=(parseInt(x.marginLeft)+parseInt(x.marginRight))/2,w.style.marginLeft=x+"px",w.style.marginTop="auto"):"portrait"==x&&(x=getComputedStyle(w),
x=(parseInt(x.marginTop)+parseInt(x.marginBottom))/2,w.style.marginTop=x+"px",w.style.marginLeft="auto"):w.style.margin="auto";v=k;t=q;x={};for(q=0;q<b.length;q++)if(k=b[q],1!=k.getResolutionFactor()&&A&&C&&A==C&&"auto"==A?k.setCanvasStyleSize(w.getAttribute("width")+"px",w.getAttribute("height")+"px"):l&&k.setCanvasStyleSize(A,C),z&&k.resize(c,d),!a||!("number"==typeof a&&a!=k.id||a.indexOf&&-1==a.indexOf(k.id)))F=k.getCanvas().id,x[F]=x[F]||m||k.hasAnythingChanged();for(q=0;q<b.length;q++)k=b[q],
x[k.getCanvas().id]&&k.draw(m);n&&(console.timeEnd("Draw"),console.log("Number of draw calls: "+wade.numDrawCalls));e.clearSimulationDirtyState()}};this.addSprite=function(a){a.getLayer().addSprite(a)};this.removeSprite=function(a){a.getLayer().removeSprite(a)};this._layerSorter=function(a,b){return b.id-a.id};this.getLayer=function(b,c){this._createLayerIfNeeded(b,c);return a[b]};this.getLayerSorting=function(b){return a[b].getSorting()};this.setLayerSorting=function(b,c){this._createLayerIfNeeded(b);
...
(l[a].length=0)};this.getImageUsers=function(a){return l[a]};this.updateImageUsers=function(a){var b=l[a];if(b){for(var c=0;c<b.length;c++)if(b[c].setDirtyArea&&b[c].setDirtyArea(),b[c].setActiveImage(a),b[c].isUsingPixelPerfectMouseEvents&&b[c].isUsingPixelPerfectMouseEvents())var d=!0;d&&wade.getImageData(a)}};this.getLayerSettings=function(a){for(var c=[],d=0;d<b.length;d++){var e=b[d];if(!a||e.getSpriteCount()){var f={};try{f=JSON.parse(JSON.stringify(e.getCustomProperties()))}catch(g){}c[e.id]=
{scaleFactor:e.getScaleFactor(),translateFactor:e.getTranslateFactor(),renderMode:e.getRenderMode(),useQuadtree:e.isUsingQuadtree(),resolutionFactor:e.getResolutionFactor(),postProcessShader:e.getPostProcessShader()!=e.getDefaultPixelShaderSource()?e.getPostProcessShader():"",postProcessShaderUniforms:e.getPostProcessShaderUniforms(),properties:f}}}return c};this.getAllLayers=function(){return b}}
function SceneManager(){var a=[],b=[],c={onMouseDown:[],onMouseUp:[],onMouseMove:[],onMouseWheel:[],onClick:[],onMouseIn:[],onMouseOut:[],onKeyDown:[],onKeyUp:[],onKeyPress:[],onAppTimer:[],onSimulationStep:[],onUpdate:[],onResize:[],onContainerResize:[],onDeviceMotion:[],onDeviceOrientation:[],onSwipeLeft:[],onSwipeRight:[],onSwipeUp:[],onSwipeDown:[],onBlur:[],onFocus:[],onOverlap:[],onCameraMove:[],onGamepadButtonDown:[],onGamepadButtonUp:[]},d=wade.cloneObject(c),e=0,f=!1,g={},i={},h=0;this.init=
function(){this.renderer=new Renderer;this.renderer.init(this);wade.isUsingGlobalUnderscore()&&(_=g)};this.addSceneObject=function(b,d,e){a.push(b);b.autoListen=d;b.addToSceneParams=e?wade.extend(!0,{},e):null;b.addSpritesToRenderer(this.renderer);this.addNamedObject(b);if(d&&!b.isTemplate())for(var f in c)if(c.hasOwnProperty(f)){var g=b[f];if(!g)for(var h=b.getBehaviors(),d=0;d<h.length&&!g;d++)g=h[d][f];g&&wade.addEventListener(b,f)}if(b.isTemplate()){f=b.getSpriteCount();for(d=0;d<f;d++)b.getSprite(d).setVisible(!1)}!b.simulated&&
b.needsSimulation()&&wade.simulateSceneObject(b,!0);wade.isImportingScene()?setTimeout(function(){b.processEvent("onAddToScene",e)},0):b.processEvent("onAddToScene",e);var i=b.getFlowChart();i&&wade.setTimeout(function(){b.isInScene()&&wade.runFlowChart(i,null,!0,0,b)},0)};this.addPath=function(a){b.push(a);this.addNamedObject(a);a.onAddToScene()};this.addNamedObject=function(a){var b=a.getName();b?g[b]?wade.warn("Warning: an object named "+b+" is already present in the scene. Duplicate names can cause unexpected behavior."):
g[b]=a:(b="__wade_unnamed_sceneObject_"+h++,a.setName(b))};this.removeNamedObject=function(a){a&&delete g[a]};this.changeObjectName=function(a,b){this.removeNamedObject(b);this.addNamedObject(a)};this.getObjectByName=function(a){return g[a]};this.getObjects=function(a,b,c){if(a){var d=[],e;if("undefined"==typeof b)for(e=0;e<c.length;e++)"undefined"!=typeof c[e][a]&&d.push(c[e]);else for(e=0;e<c.length;e++)c[e][a]==b&&d.push(c[e]);return d}return wade.cloneArray(c)};this.getSceneObjects=function(b,
c){return this.getObjects(b,c,a)};this.getPaths=function(a,c){return this.getObjects(a,c,b)};this.removeEventListener=function(a,b){wade.removeObjectFromArray(a,c[b])};this.removeGlobalEventListener=function(a,b){wade.removeObjectFromArray(a,d[b])};this.removeSceneObject=function(b){if(b){b.processEvent("onRemoveFromScene");wade.removeObjectFromArray(b,a);var e=b.getName();e&&this.removeNamedObject(e);for(var f in c)c.hasOwnProperty(f)&&(c[f].length&&this.removeEventListener(b,f),d[f].length&&this.removeGlobalEventListener(b,
f));b.removeSpritesFromRenderer();b.flowChartStatus&&(b.flowChartStatus.cancelled=!0)}};this.removePath=function(a){if(a){wade.removeObjectFromArray(a,b);var c=a.getName();c&&this.removeNamedObject(c);a.onRemoveFromScene()}};this.clear=function(){for(var c=a.length-1;0<=c;c--)this.removeSceneObject(a[c]);for(c=b.length-1;0<=c;c--)this.removePath(b[c])};this.step=function(){var a=wade.logSimulationTime&&console.time&&console.timeEnd&&0.02>Math.random();a&&console.time("Simulation");for(var b=c.onSimulationStep,
d=0;d<b.length;d++)b[d].step();e+=wade.c_timeStep;this.processEvent("onUpdate");b=c.onOverlap;for(d=0;d<b.length;d++)if(b[d].isInScene()){var g=b[d].getOverlappingObjects(),h=b[d].getName(),t={};i[h]||(i[h]={});for(var v=0;v<g.length;v++){var p=g[v].getName();i[h][p]||b[d].processEvent("onOverlap",{otherObject:g[v]});t[p]=!0}i[h]=t}a&&console.timeEnd("Simulation");f=!0};this.addEventListener=function(a,b){!c[b]&&(c[b]=[]);!d[b]&&(d[b]=[]);-1==c[b].indexOf(a)&&c[b].push(a)};this.addGlobalEventListener=
function(a,b){!c[b]&&(c[b]=[]);!d[b]&&(d[b]=[]);-1==d[b].indexOf(a)&&d[b].push(a)};this.getEventListeners=function(a,b){var d=[],e,f;switch(a){case "onMouseDown":case "onMouseUp":case "onMouseMove":case "onMouseWheel":case "onClick":case "onMouseIn":case "onMouseOut":case "onSwipeLeft":case "onSwipeRight":case "onSwipeUp":case "onSwipeDown":var g={x:b.screenPosition.x,y:b.screenPosition.y};for(e=c[a].length-1;0<=e;e--){f=c[a][e];var h=f.getSpriteAtPosition(g);h.isPresent&&(f.eventResponse={spriteIndex:h.spriteIndex,
position:h.relativeWorldPosition,screenPosition:g,topLayer:h.topLayer,button:b.button,value:b.value},d.push(f))}d.sort(this.eventListenersSorter);break;default:for(e=c[a].length-1;0<=e;e--)f=c[a][e],f.eventResponse=b,d.push(f)}return d};this.eventListenersSorter=function(a,b){return a.eventResponse.topLayer-b.eventResponse.topLayer||-wade.getLayer(a.eventResponse.topLayer).compareSprites(a.getSprite(a.eventResponse.spriteIndex),b.getSprite(b.eventResponse.spriteIndex))};this.isObjectListeneningForEvent=
function(a,b){var d=c[b];return!!(d&&0<=d.indexOf(a))};this.onResize=function(b,c,d,e){for(var f=0;f<a.length;f++){var g=a[f],h=g.getPosition(),i=g.getAlignment(),m=0,q=0;switch(i.x){case "right":m=(d-b)/2;break;case "left":m=-(d-b)/2}switch(i.y){case "top":q=-(e-c)/2;break;case "bottom":q=(e-c)/2}g.setPosition(h.x+m,h.y+q);if(g.isMoving()&&(m||q))(h=g.getTargetPosition())&&g.moveTo(h.x+m,h.y+q,g.getMovementSpeed())}b={width:d,height:e};this.processEvent("onResize",b)||wade.app.onResize&&wade.app.onResize(b)};
this.processEvent=function(a,b){for(var c=this.getEventListeners(a,b),e=!1,f=0;f<c.length;f++){var g=c[f];if(g.processEvent(a,g.eventResponse)){e=!0;break}}c=b&&wade.cloneObject(b)||{};c.global=!0;for(f=0;f<d[a].length;f++)d[a][f].processEvent(a,c);return e};this.appTimerEvent=function(){for(var a=0;a<c.onAppTimer.length;a++)c.onAppTimer[a].processEvent("onAppTimer");wade.app&&wade.app.onAppTimer&&wade.app.onAppTimer()};this.updateMouseInOut=function(a,b){var c,d,e="undefined"!=typeof a.x;if(e){var f=
this.getEventListeners("onMouseOut",{screenPosition:a});for(c=0;c<f.length&&!(d=f[c],!d.getSpriteAtPosition(b).isPresent&&d.processEvent("onMouseOut",d.eventResponse));c++);}f=this.getEventListeners("onMouseIn",{screenPosition:b});for(c=0;c<f.length&&!(d=f[c],(!e||!d.getSpriteAtPosition(a).isPresent)&&d.processEvent("onMouseIn",d.eventResponse));c++);};this.getAppTime=function(){return e};this.getSimulationDirtyState=function(){return f};this.clearSimulationDirtyState=function(){f=!1};this.setSimulationDirtyState=
function(){f=!0};this.draw=function(a,b){this.renderer.draw(a,b)};this.exportSceneObjects=function(b,c){for(var d=[],e=0;e<a.length;e++)b&&(-1!=b.indexOf(a[e])||a[e].getName()&&-1!=b.indexOf(a[e].getName()))||a[e].noExport||d.push(a[e].serialize(!1,null,c));return d};this.exportPaths=function(a){for(var c=[],d=0;d<b.length;d++)(!a||!(-1!=a.indexOf(b[d])||b[d].getName()&&-1!=a.indexOf(b[d].getName())))&&c.push(b[d].serialize(!1));return c};this.getSceneObjectIndex=function(b){return a.indexOf(b)};
this.getPathIndex=function(a){return b.indexOf(a)};this.setObjectIndex=function(a,b,c){var d=c.indexOf(a);return-1!=d&&b!=d?(wade.removeObjectFromArrayByIndex(d,c),c.length>b?(c.splice(b,0,a),b):c.push(a)-1):-1};this.setSceneObjectIndex=function(b,c){return this.setObjectIndex(b,c,a)};this.setPathIndex=function(a,c){return this.setObjectIndex(a,c,b)}}
function SceneObject(a,b,c,d,e){this._behaviors=[];this._spriteOffsets=[];this._moving=!1;this._linearVelocity={x:0,y:0};this._animationsPlaying=this._targetPosition=0;this._inScene=!1;this._pathTime=this._angularVelocity=this._renderer=0;this._pathSpeed=1;this._pathNodeIndex=-1;this._isTemplate=!1;this._rotationTarget={valid:!1,value:0};this._timeouts=[];this.addToSceneParams=this._flowChart=null;this.autoListen=!1;var f="object"==typeof a&&!wade.isArray(a)&&!(a instanceof Sprite)&&!(a instanceof
...
c._behaviorClasses=wade.cloneArray(this._behaviorClasses);c._behaviors=[];if(c._behaviorClasses)for(d=0;d<c._behaviorClasses.length;d++){if("function"==typeof this._behaviors[d].clone)c._behaviors[d]=this._behaviors[d].clone(c);else{c._behaviors[d]=new this._behaviorClasses[d];for(var f in this._behaviors[d])this._behaviors[d].hasOwnProperty(f)&&(c._behaviors[d][f]="object"==typeof this._behaviors[d][f]?wade.isArray(this._behaviors[d][f])?wade.cloneArray(this._behaviors[d][f]):wade.cloneObject(this._behaviors[d][f]):
this._behaviors[d][f])}c._behaviors[d].owner=c}if("undefined"!=typeof a||"undefined"!=typeof b)"undefined"==typeof a&&(a=this._position.x),"undefined"==typeof b&&(b=this._position.y),c.setPosition(a,b);this.simulated&&(c.simulated=!1,wade.simulateSceneObject(c,!0));return c};
SceneObject.prototype.toGrid=function(a,b,c,d){var e,f,c=c||0,d=d||0,g=this._position,i=Infinity;f=Infinity;var h=-Infinity,j=-Infinity;for(e=0;e<this.getSpriteCount();e++){var k=this.getSprite(e),l=this.getSpriteOffset(e),k=k.getSize(),i=Math.min(i,l.x-k.x/2);f=Math.min(f,l.y-k.y/2);h=Math.max(h,l.x+k.x/2);j=Math.max(j,l.y+k.y/2)}i=h-i;j-=f;h=[[this]];for(e=1;e<=a;e++){h[e-1]=h[e-1]||[];for(f=1;f<=b;f++)1==e&&1==f||(l=this.clone(g.x+(e-1)*(i+c),g.y+(f-1)*(j+d)),wade.addSceneObject(l),h[e-1].push(l))}return h};
SceneObject.prototype.serialize=function(a,b,c){for(var d=0;d<this._behaviors.length;d++)this._behaviors[d].preSerialize&&this._behaviors[d].preSerialize();var e={type:"SceneObject",position:{x:this._position.x,y:this._position.y},rotation:this._rotation,behaviors:[],sprites:[],spriteOffsets:[],flowChart:this._flowChart&&wade.cloneObject(this._flowChart),alignment:{x:this._alignment.x||"center",y:this._alignment.y||"center"},name:this._name,isTemplate:this._isTemplate,path:this._path?this._path.getName():
"",addToScene:this._inScene?{autoListen:this.autoListen,params:this.addToSceneParams}:null,properties:{}};if(this._behaviorClasses)for(d=0;d<this._behaviorClasses.length;d++){var f=this._behaviors[d].name||this._behaviorClasses[d].name;if(!f){for(var g in window)try{if(window.hasOwnProperty(g)&&"function"==typeof window[g]&&window[g]==this._behaviorClasses[d]){f=g;break}}catch(i){}f||wade.warn("Warning - Trying to export a scene object with an unnamed behavior, which will be skipped. Add a 'name' property to your behaviors to correct this.")}if(f){var h;
if(this._behaviors[d].serialize)h=this._behaviors[d].serialize();else{h={};for(var j in this._behaviors[d])if(this._behaviors[d].hasOwnProperty(j)&&"_"!=j[0]&&"name"!=j)try{var k=JSON.stringify(this._behaviors[d][j]);h[j]=JSON.parse(k)}catch(l){}}f={name:f};h&&(f.properties=h);e.behaviors.push(f)}}for(d=0;d<this._spriteOffsets.length;d++)e.spriteOffsets.push({x:"number"==typeof this._spriteOffsets[d].originalX?this._spriteOffsets[d].originalX:this._spriteOffsets[d].x,y:"number"==typeof this._spriteOffsets[d].originalY?
this._spriteOffsets[d].originalY:this._spriteOffsets[d].y,angle:this._spriteOffsets[d].angle});for(d=0;d<this._sprites.length;d++)e.sprites.push(this._sprites[d].serialize());d=["autoListen","addToSceneParams","simulated","eventResponse","flowChartStatus"];b&&(d=d.concat(b));for(var n in this)if(this.hasOwnProperty(n)&&"_"!=n[0]&&-1==d.indexOf(n))if(c&&"function"==typeof this[n])e.functions=e.functions||{},e.functions[n]=this[n].toString();else try{var r=JSON.stringify(this[n]);e.properties[n]=JSON.parse(r)}catch(t){}for(d=
this._behaviors.length-1;0<=d;d--)this._behaviors[d].postSerialize&&this._behaviors[d].postSerialize();return a?JSON.stringify(e,null,"\t"):e};SceneObject.prototype.getOverlappingObjects=function(a,b){for(var c=[],d=0;d<this._sprites.length;d++)for(var e=this._sprites[d].getOverlappingObjects(a,b),f=0;f<e.length;f++)(0==d||-1==c.indexOf(e[f]))&&c.push(e[f]);return c};
...
g.drawToImage(a,b);c={x:(c+e)/2,y:(d+f)/2};for(g=0;g<this._sprites.length;g++)this._sprites[g].drawToImage(a,!1,wade.vec2.sub(this._spriteOffsets[g],c))}else b&&wade.setImage(a,wade.getImage(),!0)};SceneObject.prototype.setFlowChart=function(a){this._flowChart=wade.cloneObject(a)};SceneObject.prototype.getFlowChart=function(){return this._flowChart};SceneObject.prototype.isOnScreen=function(){for(var a=0;a<this._sprites.length;a++)if(this._sprites[a].isOnScreen())return!0;return!1};
SceneObject.prototype.addSpritesToRenderer=function(a){this._inScene=!0;this._renderer=a;for(var b=0;b<this._sprites.length;b++)a.addSprite(this._sprites[b])};SceneObject.prototype.removeSpritesFromRenderer=function(){if(this._inScene){this._inScene=!1;for(var a=0;a<this._sprites.length;a++)this._sprites[a].isVisible()&&this._sprites[a].setDirtyArea(),this._renderer.removeSprite(this._sprites[a])}};
SceneObject.prototype.needsSimulation=function(){return this._animationsPlaying||this._moving||this._angularVelocity||this._path||this._timeouts.length};SceneObject.prototype.unscheduleAll=function(){wade.warn("Warning - SceneObject.unscheduleAll() is now deprecated and will be removed in future versions of WADE. Use unschedule with no parameters instead");this._timeouts.length=0};
function Sprite(a,b){this._animations={};this._currentAnimation="default";var c=new Animation(a&&("string"==typeof a?a:a.image));c.sprite=this;c.name=this._currentAnimation;c.isDefault=!0;this._animations[this._currentAnimation]=c;this._numAnimations=1;this._scaleFactor={x:1,y:1};this._imageArea={minX:0,minY:0,maxX:1,maxY:1};this._name="";this._alwaysDraw=!1;this._drawModifiers=[];this.draw=this.drawStatic;this.draw_gl=this.drawStatic_gl;var d;if(c="object"==typeof a&&a){var e=a;this._sortPoint=e.sortPoint||
{x:0,y:0};this._layer=wade.getLayer(e.layer||wade.defaultLayer);d=this._animations[this._currentAnimation].getFrameSize();this._size=e.size?{x:e.size.x,y:e.size.y}:d;this._sizeWasSet=!e.autoResize;this._name=e.name||"";this._alwaysDraw=!!e.alwaysDraw;this._staticImageName=e.image;this._visible="undefined"==typeof e.visible?!0:e.visible;this._pixelPerfectMouseEvents=!!e.pixelPerfectMouseEvents;d=e.image;if(e.animations)for(var f in e.animations)e.animations.hasOwnProperty(f)&&this.addAnimation(new Animation(e.animations[f]),
...
Sprite.prototype.containsScreenPoint=function(a){var b;if(this._rotation)b=wade.screenPositionToWorld(this._layer.id,a),b=wade.orientedBoxContainsPoint(this.orientedBoundingBox,b);else{b=this.getScreenPositionAndExtents();var c=b.position.y-b.extents.y,d=b.position.x+b.extents.x,e=b.position.y+b.extents.y;b=a.x>=b.position.x-b.extents.x&&a.x<=d&&a.y>=c&&a.y<=e}if(!b||!this.isUsingPixelPerfectMouseEvents||!this.isUsingPixelPerfectMouseEvents()||!this._image)return b;b=this._animations[this._currentAnimation];
c=b.getFrameCorner();d=b.getFrameSize();e=b.getOffset_ref();a=wade.screenPositionToWorld(this.getLayerId(),a);wade.vec2.subInPlace(a,this.getPosition());wade.vec2.subInPlace(a,e);this._rotation&&wade.vec2.rotateInPlace(a,-this._rotation);wade.vec2.addInPlace(a,wade.vec2.scale(this._size,0.5));a.x=Math.floor(a.x*d.x/this._size.x+c.x);a.y=Math.floor(a.y*d.y/this._size.y+c.y);b=wade.getImageData(b.getRelativeImageName());return!!b.data[4*(a.y*b.width+a.x)+3]};
...
a.boundingBox):wade.orientedBoxIntersectsBox(a.orientedBoundingBox,this.boundingBox);if("pixel"==b){var g,i,h,j,k,l,n;this instanceof TextSprite?(this.isCached()||this.cache(),e={x:0,y:0},i=this.getSize(),h={x:0,y:0},g=this.getImageName(),wade.setImage(g,this.getCachedImage()),g=wade.getImageData(g)):(g=this._animations[this._currentAnimation],e=g.getFrameCorner(),i=g.getFrameSize(),h=g.getOffset_ref(),g=wade.getImageData(g.getRelativeImageName()));a instanceof TextSprite?(a.isCached()||a.cache(),
k={x:0,y:0},l=a.getSize(),n={x:0,y:0},j=a.getImageName(),wade.setImage(j,a.getCachedImage()),j=wade.getImageData(j)):(j=a.getCurrentAnimation(),k=j.getFrameCorner(),l=j.getFrameSize(),n=j.getOffset(),j=wade.getImageData(j.getRelativeImageName()));for(var r=a.getPosition(),t=a.getSize(),v=k.y;v<k.y+l.y;v++)for(var p=k.x;p<k.x+l.x;p++)if(j.data[4*(p+v*j.width)+3]){var m={x:p-k.x,y:v-k.y};wade.vec2.mulInPlace(m,wade.vec2.div(t,l));wade.vec2.subInPlace(m,wade.vec2.scale(t,0.5));f&&wade.vec2.rotateInPlace(m,
f);wade.vec2.addInPlace(m,n);wade.vec2.addInPlace(m,r);c!=d&&(m=wade.worldPositionToScreen(d,m),m=wade.screenPositionToWorld(c,m));wade.vec2.subInPlace(m,this.getPosition());wade.vec2.subInPlace(m,h);this._rotation&&wade.vec2.rotateInPlace(m,-this._rotation);wade.vec2.addInPlace(m,wade.vec2.scale(this._size,0.5));m.x=Math.floor(m.x*i.x/this._size.x+e.x);m.y=Math.floor(m.y*i.y/this._size.y+e.y);if(0<=m.x&&0<=m.y&&m.x<g.width&&m.y<g.height&&g.data[4*(m.y*g.width+m.x)+3])return!0}return!1}};
...
"",pixelShaderUniforms:this._pixelShaderUniforms?wade.cloneObject(this._pixelShaderUniforms):null,pixelPerfectMouseEvents:!!this._pixelPerfectMouseEvents,properties:{}};this._sizeWasSet&&!(1==this._size.x&&1==this._size.y)&&(c.size={x:this._size.x,y:this._size.y});for(var d in this._animations)this._animations.hasOwnProperty(d)&&!this._animations[d].isDefault&&(c.animations[d]=this._animations[d].serialize());d="sceneObject boundingBox orientedBoundingBox id needsDrawing uniformTypeNames".split(" ");
...
this._rotation?"orientedBox":"box",f=this._rotation?this.orientedBoundingBox:this.boundingBox,g=0;g<c.length;g++){var i=c[g];if(i!=this){var h=i.getRotation(),j=h?i.orientedBoundingBox:i.boundingBox,h=h?wade[e+"IntersectsOrientedBox"]:wade[e+"IntersectsBox"];this._layer.id!=i.getLayerId()&&(j=wade.screenBoxToWorld(this._layer.id,wade.worldBoxToScreen(i.getLayerId(),j)));h.call(wade,f,j)&&d.push(i)}}for(e=c.length=0;e<d.length;e++)f=d[e].getSceneObject(),-1==c.lastIndexOf(f)&&("pixel"!=b||this.overlapsSprite(d[e],
...
Sprite.prototype.draw_gl;this.setDirtyArea()};Sprite.prototype.getIndexInLayer=function(){return this._layer.getIndexOfSprite(this)};Sprite.prototype.setIndexInLayer=function(a){this.setDirtyArea();return this._layer.setIndexOfSprite(this,a)};
...
Sprite.prototype.getImageArea=function(){return{minX:this._imageArea.minX,minY:this._imageArea.minY,maxX:this._imageArea.maxX,maxY:this._imageArea.maxY}};Sprite.prototype.fadeIn=function(a,b){"undefined"==typeof a&&(a=1);this.setVisible(!0);var c=Sprite.prototype.drawAnimated;this instanceof TextSprite&&(c=TextSprite.prototype.draw,this.cache());this.setDrawFunction(wade.drawFunctions.fadeOpacity_(0,1,a,c,function(){setTimeout(function(){b&&b()},0)}))};
Sprite.prototype.fadeOut=function(a,b){"undefined"==typeof a&&(a=1);var c=this;this.setDrawFunction(wade.drawFunctions.fadeOpacity_(1,0,a,this instanceof TextSprite?TextSprite.prototype.draw:Sprite.prototype.drawAnimated,function(){setTimeout(function(){c.setVisible(!1);b&&b()},0)}))};Sprite.prototype.isUsingPixelPerfectMouseEvents=function(){return!!this._pixelPerfectMouseEvents};Sprite.prototype.usePixelPerfectMouseEvents=function(a){"undefined"==typeof a&&(a=!0);this._pixelPerfectMouseEvents=!!a};
Sprite.prototype.isOnScreen=function(){if(!this.boundingBox||!this._sceneObject||!this._sceneObject.isInScene()||!this._visible)return!1;var a=wade.getScreenWidth()/2,b=wade.getScreenHeight()/2;return wade.boxIntersectsBox({minX:-a,minY:-b,maxX:a,maxY:b},wade.worldBoxToScreen(this._layer.id,this.boundingBox))};Sprite.prototype.getLayer=function(){return this._layer};Sprite.prototype.onAnimationStart=function(a,b){this._sceneObject&&this._sceneObject.processEvent("onAnimationStart",{name:a,restarting:b})};
...
Sprite.prototype.updateOrientedBoundingBox=function(){var a=this._size.x/2,b=this._size.y/2,c=Math.cos(this._rotation),d=Math.sin(this._rotation),e=a*c,f=a*d,d=b*d,c=b*c,g=e+d,i=f-c,h=e-d,j=f+c;this.orientedBoundingBox.rx=Math.max(Math.abs(g),Math.abs(h));this.orientedBoundingBox.ry=Math.max(Math.abs(i),Math.abs(j));this.orientedBoundingBox.rx0=g;this.orientedBoundingBox.ry0=i;this.orientedBoundingBox.rx1=h;this.orientedBoundingBox.ry1=j;this.orientedBoundingBox.axisXx=e;this.orientedBoundingBox.axisXy=
...
Sprite.prototype.drawStatic=function(a){if(a.isWebGl)return this.drawStatic_gl(a);if(this._visible){wade.numDrawCalls++;this._rotation&&(a.save(),a.translate(this._position.x,this._position.y),a.rotate(this._rotation),a.translate(-this._position.x,-this._position.y));var b=this._image.width,c=this._image.height,d=this._imageArea.minX,e=this._imageArea.minY;a.drawImage(this._image,d*b,e*c,(this._imageArea.maxX-d)*b,(this._imageArea.maxY-e)*c,this._cornerX,this._cornerY,this._size.x,this._size.y);this._rotation&&
a.restore()}};
Sprite.prototype.drawStatic_gl=function(a){if(!a.isWebGl)return this.drawStatic(a);if(this._visible){wade.numDrawCalls++;this._f32RotationAlpha[1]=a.globalAlpha;"lighter"==a.globalCompositeOperation&&a.blendFuncSeparate(a.SRC_ALPHA,a.ONE,a.SRC_ALPHA,a.ONE);var b=this._shaderProgram||a.defaultShaderProgram;this._layer.setShaderProgram(b);a.uniform4fv(b.uniforms.uPositionAndSize,this._f32PositionAndSize);a.uniform4fv(b.uniforms.uAnimFrameInfo,this._f32AnimFrameInfo);a.uniform2fv(b.uniforms.uRotationAlpha,this._f32RotationAlpha);
this._setPixelShaderUniforms(a,b);a.setTextureImage(this._image);a.drawArrays(a.TRIANGLE_STRIP,0,4);a.globalCompositeOperation&&"sourceOver"!=a.globalCompositeOperation&&a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA)}else a.setTextureImage(this._image,!0)};
...
Sprite.prototype.drawAnimated_gl=function(a){if(a.isWebGl){var b=this._animations[this._currentAnimation];if(b)if(this._visible){"lighter"==a.globalCompositeOperation&&a.blendFuncSeparate(a.SRC_ALPHA,a.ONE,a.SRC_ALPHA,a.ONE);this._f32RotationAlpha[1]=a.globalAlpha;var c=this._shaderProgram||a.defaultShaderProgram;this._layer.setShaderProgram(c);this._setPixelShaderUniforms(a,c);b.draw_gl(a,this._f32PositionAndSize,this._f32RotationAlpha);a.globalCompositeOperation&&"sourceOver"!=a.globalCompositeOperation&&
a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA)}else a.setTextureImage(wade.getImage(b.getImageName()),!0)}else this.drawAnimated(a)};Sprite.prototype.draw=Sprite.prototype.drawAnimated;Sprite.prototype.draw_gl=Sprite.prototype.drawAnimated_gl;
Sprite.prototype.setActiveImage=function(a){var b=this._activeImage;this._activeImage&&b!=a&&wade.removeImageUser(this._activeImage,this);this._activeImage=a;this._image=wade.getImage(a,"");a&&(b!=a&&wade.addImageUser(a,this),"ok"!=wade.getLoadingStatus(a)&&wade.isAutoLoadingImages()?(wade.log("Loading "+a),wade.preloadImage(a)):(this.isUsingPixelPerfectMouseEvents()&&wade.getImageData(a),(a=this._animations[this._currentAnimation].getImageName()==wade.getFullPathAndFileName(a))&&this._animations[this._currentAnimation].refreshImage(),
...
c),a.uniform1i(b.uniforms[d],c),f=a.textures[this[d]]?{imageName:this[d]}:wade.getImage(wade.getFullPathAndFileName(this[d])),a.setTextureImage(f,!1,c),c++,a.activeTexture(a.TEXTURE0))}}};Sprite.prototype.uniformTypeNames={vec4:"uniform4fv",vec3:"uniform3fv",vec2:"uniform2fv","float":"uniform1f",ivec4:"uniform4iv",ivec3:"uniform3iv",ivec2:"uniform2iv","int":"uniform1i"};
...
this._maxLines=b.maxLines||0,this._outlineColor=b.outlineColor||"#000",this._outlineWidth=b.outlineWidth||0,this._boundsScale={x:b.boundsScale&&b.boundsScale.x,y:b.boundsScale&&b.boundsScale.y},this._sortPoint={x:b.sortPoint&&b.sortPoint.x,y:b.sortPoint&&b.sortPoint.y},this._fixedSize="undefined"==typeof b.fixedSize?!1:b.fixedSize,this._name=b.name||"",this._alwaysDraw=!!b.alwaysDraw):(this._font=b||"12px Arial",this._alignment=d||"left",this._color=c||"#000",this._visible=!0,this._layer=wade.getLayer(e||
wade.defaultLayer),this._maxWidth=0,this._shadowColor="#000",this._shadowBlur=0,this._shadowOffset={x:0,y:0},this._lineSpacing=1,this._maxLines=0,this._outlineColor="#000",this._outlineWidth=0,this._boundsScale={x:1,y:1},this._sortPoint={x:0,y:0},this._fixedSize=!1,this._name="",this._alwaysDraw=!1);this._sceneObject=this._cornerY=this._cornerX=this._image=0;this._position={x:0,y:0};this._centerOffset={x:0,y:0};this._size={x:0,y:0};this._numLines=1;this._lines=[];this._drawModifiers=[];this._lineHeight=
12;this._imageArea={minX:0,minY:0,maxX:1,maxY:1};this._rotation=0;this.orientedBoundingBox={};this.boundingBox={minX:0,minY:0,maxX:0,maxY:0};try{this._f32PositionAndSize=new Float32Array([0,0,0,0]),this._f32AnimFrameInfo=new Float32Array([0,0,1,1]),this._f32RotationAlpha=new Float32Array([0,0])}catch(f){}this.setText(a||"")}TextSprite.prototype.setPosition=Sprite.prototype.setPosition;TextSprite.prototype.getPosition=Sprite.prototype.getPosition;TextSprite.prototype.setSortPoint=Sprite.prototype.setSortPoint;
TextSprite.prototype.getSortPoint=Sprite.prototype.getSortPoint;TextSprite.prototype.getLayer=Sprite.prototype.getLayer;TextSprite.prototype.getLayerId=Sprite.prototype.getLayerId;TextSprite.prototype.getScreenBox=Sprite.prototype.getScreenBox;TextSprite.prototype.containsScreenPoint=Sprite.prototype.containsScreenPoint;TextSprite.prototype.getWorldOffset=Sprite.prototype.getWorldOffset;TextSprite.prototype.updateOrientedBoundingBox=Sprite.prototype.updateOrientedBoundingBox;
TextSprite.prototype.setVisible=Sprite.prototype.setVisible;TextSprite.prototype.isVisible=Sprite.prototype.isVisible;TextSprite.prototype.bringToFront=Sprite.prototype.bringToFront;TextSprite.prototype.pushToBack=Sprite.prototype.pushToBack;TextSprite.prototype.putBehindSprite=Sprite.prototype.putBehindSprite;TextSprite.prototype.getDrawFunction=Sprite.prototype.getDrawFunction;TextSprite.prototype.setDrawFunction=Sprite.prototype.setDrawFunction;TextSprite.prototype.overlapsSprite=Sprite.prototype.overlapsSprite;
TextSprite.prototype.getRotation=Sprite.prototype.getRotation;TextSprite.prototype.setRotation=Sprite.prototype.setRotation;TextSprite.prototype.getSceneObject=Sprite.prototype.getSceneObject;TextSprite.prototype.getOverlappingObjects=Sprite.prototype.getOverlappingObjects;TextSprite.prototype.setName=Sprite.prototype.setName;TextSprite.prototype.getName=Sprite.prototype.getName;TextSprite.prototype.getIndexInLayer=Sprite.prototype.getIndexInLayer;TextSprite.prototype.setIndexInLayer=Sprite.prototype.setIndexInLayer;
TextSprite.prototype.setDrawModifiers=Sprite.prototype.setDrawModifiers;TextSprite.prototype.getDrawModifiers=Sprite.prototype.getDrawModifiers;TextSprite.prototype.alwaysDraw=Sprite.prototype.alwaysDraw;TextSprite.prototype.isAlwaysDrawing=Sprite.prototype.isAlwaysDrawing;TextSprite.prototype.fadeIn=Sprite.prototype.fadeIn;TextSprite.prototype.fadeOut=Sprite.prototype.fadeOut;TextSprite.prototype.refreshShader=Sprite.prototype.refreshShader;TextSprite.prototype._setPixelShaderUniforms=Sprite.prototype._setPixelShaderUniforms;
...
JSON.stringify(c,null,"\t"):c};TextSprite.prototype.scaleBounds=function(a,b){this._boundsScale={x:a,y:b};this._updateSize();this._image=0};TextSprite.prototype.setFixedSize=function(a){"undefined"==typeof a&&(a=!0);this._fixedSize=a};TextSprite.prototype.getSize=function(){return{x:this._size.x,y:this._size.y}};
...
g[i].split(" "),j=1,k;0<h.length&&j<=h.length;)if(k=h.slice(0,j).join(" "),c.measureText(k).width+this._outlineWidth>this._maxWidth&&0<this._maxWidth){1==j&&(j=2);k=h.slice(0,j-1).join(" ");if(!this._maxLines||f<this._maxLines)a&&(c.fillText(k,this._position.x,this._position.y+this._lineHeight*this._lineSpacing*f),this._outlineWidth&&c.strokeText(this._text,this._position.x,this._position.y)),b&&b.push({width:c.measureText(k).width+this._outlineWidth,text:k});f++;h=h.splice(j-1);j=1}else j++;if(0<
j&&(!this._maxLines||f<this._maxLines))k=h.join(" "),a&&(c.fillText(k,this._position.x,this._position.y+this._lineHeight*this._lineSpacing*f),this._outlineWidth&&c.strokeText(this._text,this._position.x,this._position.y)),b&&b.push({width:c.measureText(k).width+this._outlineWidth,text:k}),f++}this._numLines=f}this._shadowColor&&(c.shadowColor="rgba(0, 0, 0, 0)");this._outlineWidth&&(c.strokeStyle=d,c.lineWidth=e);this._rotation&&c.restore()};TextSprite.prototype.getCachedImage=function(){return this._image};
function Wade(){var a=this,b=0,c=0,d=0,e=0,f=0,g=0,i=!1,h=!1,j="",k=1,l=[],n=[],r=0,t=1,v="none",p=new Image,m=[],q={},y=[],u,D,w,x,F,z,G,s,A=!0,C=!0,B={},E=[],H=0,L=!0,N={}.hasOwnProperty.toString,P=N.call(Object),M=1,I="wade_main_div",J=!1,O={straight:[{x:-1,y:-1},{x:-1,y:1},{x:1,y:-1},{x:1,y:1}],diagonal:[{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}],both:[{x:-1,y:-1},{x:-1,y:1},{x:1,y:-1},{x:1,y:1},{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}]};p.src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVQIW2NkAAIAAAoAAggA9GkAAAAASUVORK5CYII=";
this.app=0;this.c_timeStep=1/60;this.defaultLayer=1;this._appData=0;this.c_epsilon=1E-4;this.init=function(a,K,f){var f=f||{},g=f.forceReload,h=f.updateCallback;z=f.forceWebGl;var i=f.container;C="undefined"!=typeof f.globalUnderscore?!!f.globalUnderscore:!0;I=i||"wade_main_div";var p=function(){var a=window.applicationCache;if(a)if(a.status==a.UPDATEREADY)wade.log("a new version of the app is available"),h?h():(alert("A new version is available.\nPlease press OK to restart."),a.swapCache(),window.location.reload(!0),
window.location=window.location);else{try{a.update()}catch(b){}a.addEventListener("updateready",p,!1)}};p();a&&(j=a.substr(0,Math.max(a.lastIndexOf("/"),a.lastIndexOf("\\"))+1));for(var q=0,i=["ms","moz","webkit","o"],m=0;m<i.length&&!window.requestAnimationFrame;m++)window.requestAnimationFrame=window[i[m]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[i[m]+"CancelAnimationFrame"]||window[i[m]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=
function(a){var b=(new Date).getTime(),c=Math.max(0,16-(b-q)),d=window.setTimeout(function(){a(b+c)},c);q=b+c;return d});window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)});i="undefined"==typeof f.audio||f.audio;s=f.audioContext;if(i&&!s){try{window.AudioContext=window.AudioContext||window.webkitAudioContext;s=new AudioContext;var k=XMLHttpRequest&&"string"===typeof(new XMLHttpRequest).responseType}catch(y){}k||wade.warn("Warning: the WebAudio API is not supported in this environment. Audio functionality will be limited")}c=
new AssetLoader;c.init(!1);d=new AssetLoader;d.init(!0);b=new SceneManager;b.init();e=new InputManager;("undefined"==typeof f.input||f.input)&&e.init();w=document.createElement("canvas");w.width=w.height=256;x=w.getContext("2d");this.proceduralImages.init();G=!!f.debug;this._appData=K?K:{};a?c.loadAppScript(a,g):window.App?this.instanceApp():wade.warn("Warning - App is not defined.");this.event_mainLoop()};this.stop=function(){f&&cancelAnimationFrame(f);g&&clearTimeout(g);this.setLoadingImages([]);
wade.stopInputEvents()};this.stopInputEvents=function(){e.deinit()};this.restartInputEvents=function(){e.init()};this.cancelInputEvents=function(a){e.cancelEvents(a)};this.getBasePath=function(){return j};this.setBasePath=function(a){j=a||""};this.getFullPathAndFileName=function(a){if(!a||"procedural_"==a.substr(0,11)||j&&a.substr(0,j.length)==j)return a;var b=a[0];return"\\"==b||"/"==b||-1!=a.indexOf(":")?a:j+a};this.loadScript=function(a,b,d,e,f){a=this.getFullPathAndFileName(a);c.loadScript(a,
b,d,e,f)};this.preloadScript=function(a,b,c,e,f){a=this.getFullPathAndFileName(a);d.loadScript(a,b,c,e,f)};this.getScript=function(a){a=this.getFullPathAndFileName(a);return c.getScript(a)};this.setScript=function(a,b,e){a=this.getFullPathAndFileName(a);c.setScript(a,b);e&&d.setScript(a,b)};this.loadJson=function(a,b,d,e,f){a=this.getFullPathAndFileName(a);c.loadJson(a,b,d,e,f)};this.preloadJson=function(a,b,c,e,f){a=this.getFullPathAndFileName(a);d.loadJson(a,b,c,e,f)};this.getJson=function(a){a=
this.getFullPathAndFileName(a);return c.getJson(a)};this.setJson=function(a,b,e){a=this.getFullPathAndFileName(a);c.setJson(a,b);e&&d.setJson(a,b)};this.loadText=function(a,b,d,e,f){a=this.getFullPathAndFileName(a);c.loadText(a,b,d,e,f)};this.preloadText=function(a,b,c,e,f){a=this.getFullPathAndFileName(a);d.loadText(a,b,c,e,f)};this.getText=function(a){a=this.getFullPathAndFileName(a);return c.getText(a)};this.setText=function(a,b,e){a=this.getFullPathAndFileName(a);c.setText(a,b);e&&d.setText(a,
b)};this.loadImage=function(a,b,d){a=this.getFullPathAndFileName(a);c.loadImage(a,b,d)};this.loadImages=function(a){for(var b=0;b<a.length;b++)this.loadImage(a[b])};this.preloadImage=function(a,b,c){a=this.getFullPathAndFileName(a);d.loadImage(a,b,c)};this.unloadImage=function(a){a=this.getFullPathAndFileName(a);c.unloadImage(a);d.unloadImage(a);delete B[a]};this.unloadAllImages=function(){c.unloadAllImages();d.unloadAllImages();B=[]};this.getImage=function(a,b){if(a){var d=this.getFullPathAndFileName(a);
return c.getImage(d,b)}return p};this.setImage=function(a,e,f){a=this.getFullPathAndFileName(a);c.setImage(a,e);f&&d.setImage(a,e);delete B[a];b.renderer.updateImageUsers(a)};this.loadAudio=function(a,b,d,e,f){a=this.getFullPathAndFileName(a);c.loadAudio(a,b,d,e,f)};this.preloadAudio=function(a,b,c,e,f){a=this.getFullPathAndFileName(a);d.loadAudio(a,b,c,e,f)};this.unloadAudio=function(a){a=this.getFullPathAndFileName(a);c.unloadAudio(a);d.unloadAudio(a)};this.unloadAllAudio=function(){c.unloadAllAudio();
d.unloadAllAudio()};this.setAudio=function(a,b,e,f){a=this.getFullPathAndFileName(a);c.setAudio(a,b,e);f&&d.setAudio(a,b,e)};this.playAudio=function(a,b,c){if("ok"!=this.getLoadingStatus(this.getFullPathAndFileName(a)))return-1;var d=this.getAudio(a);if(s){var e=s.createBufferSource();e.buffer=d;e.loop=!!b;e.connect(s.destination);e.endEventFired=!1;e.onended=function(){e.endEventFired=!0;c&&(c(),c=null)};e.start(0);m.push(e);if(c&&!b){var f=function(){e.playbackState!=e.FINISHED_STATE?setTimeout(f,
wade.c_timeStep):e.onended&&!e.endEventFired&&(e.endEventFired=!0,e.onended())};e.checkEnded=setTimeout(f,1E3*e.buffer.duration+wade.c_timeStep)}}else d.alreadyPlayed&&!d.ended&&(d=new Audio(d.src),this.setAudio(a,d)),d.loop=b,d.alreadyPlayed=!0,b&&d.addEventListener("ended",function(){this.currentTime=0;this.play()},!1),d.play(),m.push(d);return m.length};this.stopAudio=function(a){if("undefined"==typeof a)for(a=0;a<m.length;a++)m[a]&&(m[a].stop(),m[a].checkEnded&&clearTimeout(m[a].checkEnded));
else if(a=m[a-1])a.stop(),a.checkEnded&&clearTimeout(a.checkEnded)};this.playAudioSegment=function(a,b,c,d){if("ok"!=this.getLoadingStatus(this.getFullPathAndFileName(a)))return-1;b=b||0;a=this.getAudio(this.getFullPathAndFileName(a));if(s){var e=s.createBufferSource();e.buffer=a;e.connect(s.destination);e.endEventFired=!1;e.onended=function(){e.endEventFired=!0;d&&(d(),d=null)};e.start(b);if(d){var f=function(){e.playbackState!=e.FINISHED_STATE?setTimeout(f,wade.c_timeStep):e.onended&&!e.endEventFired&&
(e.endEventFired=!0,e.onended())};e.checkEnded=setTimeout(f,1E3*(e.buffer.duration-b)+wade.c_timeStep)}c&&e.stop(c);m.push(e)}else c=c||a.duration,a.alreadyPlayed&&!a.ended&&(a=new Audio(a.src)),a.addEventListener("timeupdate",function(){this.currentTime>=c&&(this.pause(),this.ended=!0,d&&d())},!1),a.alreadyPlayed=!0,a.play(),m.push(a);return m.length-1};this.loadFont=function(a,b,d){a=this.getFullPathAndFileName(a);c.loadFont(a,b,d)};this.preloadFont=function(a,b,c){a=this.getFullPathAndFileName(a);
d.loadFont(a,b,c)};this.getFont=function(a){a=this.getFullPathAndFileName(a);return c.getFont(a)};this.setFont=function(a,b,e){a=this.getFullPathAndFileName(a);c.setFont(a,b);e&&d.setFont(a,b)};this.getLoadingStatus=function(a){a=this.getFullPathAndFileName(a);return c.getLoadingStatus(a)};this.instanceApp=function(){this.app=new App;this.app.appData=this._appData;this.app.load&&this.app.load();i=!1;h=!0};this.initializeApp=function(){i=!0;this.app.init?this.app.init():wade.warn("Warning: Unable to initialize app. App.init function is missing.");
g=setTimeout(function(){wade.event_appTimerEvent()},1E3*k)};this.getGamepadData=function(){return e.getGamepadData()};this.processEvent=function(a,c){return b.processEvent(a,c)};this.addEventListener=function(a,c){b.addEventListener(a,c)};this.removeEventListener=function(a,c){b.removeEventListener(a,c)};this.isEventListener=function(a,c){return b.isObjectListeneningForEvent(a,c)};this.addGlobalEventListener=function(a,c){b.addGlobalEventListener(a,c)};this.removeGlobalEventListener=function(a,c){b.removeGlobalEventListener(a,
c)};this.getCameraPosition=function(){return b.renderer.getCameraPosition()};this.setCameraPosition=function(a){b.renderer.setCameraPosition(a)};this.getAppTime=function(){return b.getAppTime()};this.getClockTime=function(){return window.performance&&window.performance.now?window.performance.now():(new Date).getTime()};this.setAppTimerInterval=function(a){k=a};this.removeObjectFromArrayByIndex=function(a,b){if(0<=a){var c=b.slice(a+1||b.length);b.length=a;return b.push.apply(b,c)}return b};this.removeObjectFromArray=
function(a,b){var c=b.lastIndexOf(a);return-1!=c?this.removeObjectFromArrayByIndex(c,b):b};this.addSceneObject=function(a,c,d){"undefined"==typeof c&&(c=!0);b.addSceneObject(a,c,d);return a};this.removeSceneObject=function(a){b.removeSceneObject("string"==typeof a?this.getSceneObject(a):a)};this.removeSceneObjects=function(a){for(var c=0;c<a.length;c++)b.removeSceneObject(a[c])};this.clearScene=function(){b.clear()};this.getLayerSorting=function(a){return b.renderer.getLayerSorting(a)};this.setLayerSorting=
function(a,c){b.renderer.setLayerSorting(a,c)};this.setLayerTransform=function(a,c,d){b.renderer.setLayerTransform(a,c,d)};this.setLayerResolutionFactor=function(a,c){b.renderer.setLayerResolutionFactor(a,c)};this.getLayerResolutionFactor=function(a){return b.renderer.getLayerResolutionFactor(a)};this.setResolutionFactor=function(a){t=a;b.renderer.setResolutionFactor(t)};this.getResolutionFactor=function(){return t};this.getScreenWidth=function(){return b.renderer.getScreenWidth()};this.getScreenHeight=
function(){return b.renderer.getScreenHeight()};this.setScreenSize=function(a,c){b.renderer.setScreenSize(a,c)};this.getContainerWidth=function(){return this.isScreenRotated()?window.innerHeight:window.innerWidth};this.getContainerHeight=function(){return this.isScreenRotated()?window.innerWidth:window.innerHeight};this.setCanvasClearing=function(a,c){b.renderer.setCanvasClearing(a,c)};this.setWindowMode=function(a){b.renderer.setWindowMode(a)};this.getWindowMode=function(){return b.renderer.getWindowMode()};
this.loadPage=function(a){window.self.location=a};this.cloneObject=function(a){return wade.extend(!0,{},a)};this.cloneArray=function(a){return wade.extend(!0,[],a)};this.simulateSceneObject=function(a,c){c?a.simulated||(b.addEventListener(a,"onSimulationStep"),a.simulated=!0):a.simulated&&(b.removeEventListener(a,"onSimulationStep"),a.simulated=!1)};this.setMaxScreenSize=function(a,c){b.renderer.setMaxScreenSize(a,c)};this.getMaxScreenWidth=function(){return b.renderer.getMaxScreenWidth()};this.getMaxScreenHeight=
function(){return b.renderer.getMaxScreenHeight()};this.setMinScreenSize=function(a,c){return b.renderer.setMinScreenSize(a,c)};this.getMinScreenWidth=function(){return b.renderer.getMinScreenWidth()};this.getMinScreenHeight=function(){return b.renderer.getMinScreenHeight()};this.createCanvas=function(a){var a=a||1,b=document.getElementById(I),c=document.getElementById(I),d=parseInt(c.getAttribute("width")),c=parseInt(c.getAttribute("height")),e=document.createElement("canvas");e.width=Math.round(d*
a);e.height=Math.round(c*a);e.style.position=b.style.position;e.style.margin="auto";e.style.top=0;e.style.left=0;e.style.right=0;e.style.bottom=0;e.style.backfaceVisibility=e.style.WebkitBackfaceVisibility=e.style.MozBackfaceVisibility=e.style.OBackfaceVisibility="hidden";var a=e.style.width.toString().toLowerCase(),f=e.style.height.toString().toLowerCase();a==f&&"auto"==a?(e.style.width=d+"px",e.style.height=c+"px"):(e.style.width=b.style.width,e.style.height=b.style.height);e.style.MozTransform=
e.style.msTransform=e.style.OTransform=e.style.WebkitTransform=e.style.transform="translate3d(0,0,0)";b.appendChild(e);return e};this.deleteCanvases=function(){b.renderer.removeCanvases()};this.recreateCanvases=function(){b.renderer.recreateCanvases()};this.isAppInitialized=function(){return i};this.boxContainsBox=function(a,b){return a.minX<b.minX&&a.maxX>b.maxX&&a.minY<b.minY&&a.maxY>b.maxY};this.boxIntersectsBox=function(a,b){return!(a.maxX<b.minX||a.minX>b.maxX||a.maxY<b.minY||a.minY>b.maxY)};
this.boxContainsPoint=function(a,b){return b.x>=a.minX&&b.x<=a.maxX&&b.y>=a.minY&&b.y<=a.maxY};this.orientedBoxContainsPoint=function(a,b){var c=Math.sin(a.rotation),d=Math.cos(a.rotation),e=b.x-a.centerX,f=b.y-a.centerY,g=d*e+c*f,c=d*f-c*e;return g>=-a.halfWidth&&g<=a.halfWidth&&c>=-a.halfHeight&&c<=a.halfHeight};this.orientedBoxIntersectsOrientedBox=function(a,b){var c=b.centerX-a.centerX,d=b.centerY-a.centerY,e=a.axisXx,f=a.axisXy,g=a.axisYx,h=a.axisYy,i=b.axisXx,p=b.axisXy,q=b.axisYx,m=b.axisYy;
return!(Math.abs(c*e+d*f)>e*e+f*f+Math.abs(i*e+p*f)+Math.abs(q*e+m*f)||Math.abs(c*g+d*h)>g*g+h*h+Math.abs(i*g+p*h)+Math.abs(q*g+m*h)||Math.abs(c*i+d*p)>i*i+p*p+Math.abs(i*e+p*f)+Math.abs(i*g+p*h)||Math.abs(c*q+d*m)>q*q+m*m+Math.abs(q*e+m*f)+Math.abs(q*g+m*h))};this.boxIntersectsOrientedBox=function(a,b){var c=(a.minX+a.maxX)/2-b.centerX,d=(a.minY+a.maxY)/2-b.centerY,e=(a.maxX-a.minX)/2,f=(a.maxY-a.minY)/2,g=b.axisXx,h=b.axisXy,i=b.axisYx,p=b.axisYy;return!(Math.abs(c*e)>e*e+Math.abs(g*e)+Math.abs(i*
e)||Math.abs(d*f)>f*f+Math.abs(h*f)+Math.abs(p*f)||Math.abs(c*g+d*h)>g*g+h*h+Math.abs(g*e)+Math.abs(h*f)||Math.abs(c*i+d*p)>i*i+p*p+Math.abs(i*e)+Math.abs(p*f))};this.orientedBoxIntersectsBox=function(a,b){return this.boxIntersectsOrientedBox(b,a)};this.expandBox=function(a,b){a.minX=Math.min(a.minX,b.minX);a.minY=Math.min(a.minY,b.minY);a.maxX=Math.max(a.maxX,b.maxX);a.maxY=Math.max(a.maxY,b.maxY)};this.clampBoxToBox=function(a,b){a.minX=Math.min(b.maxX,Math.max(a.minX,b.minX));a.minY=Math.min(b.maxY,
Math.max(a.minY,b.minY));a.maxX=Math.max(b.minX,Math.min(a.maxX,b.maxX));a.maxY=Math.max(a.minY,Math.min(a.maxY,b.maxY))};this.postObject=function(a,b,c,d){b={data:JSON.stringify(b)};d&&wade.extend(b,d);b=JSON.stringify(b);this.ajax({type:"POST",url:a,data:b,success:c,dataType:"json"})};this.setGlobalLoadingCallback=function(a){c.setGlobalCallback(a)};this.setMainLoop=function(a,b,c){for(var b=b||"_wade_default",d=0;d<n.length&&n[d].name!=b;d++);n[d]={func:a,name:b,priority:c||0};n.sort(function(a,
b){return b.priority-a.priority})};this.setLoadingImages=function(a,b){for(var c=0;c<l.length;c++)document.body.removeChild(l[c]);l.length=0;wade.isArray(a)||(a=[a]);for(c=0;c<a.length;c++){var d=document.createElement("img");d.className="loadingImage_class";d.style.display="none";var e=document.getElementById("container");document.body.insertBefore(d,e);d.src=this.getFullPathAndFileName(a[c]);l.push(d);b&&d.addEventListener("click",function(){window.open(b,"_blank")})}};this.worldPositionToScreen=
function(a,c){return b.renderer.worldPositionToScreen(a,c)};this.worldDirectionToScreen=function(a,c){return b.renderer.worldDirectionToScreen(a,c)};this.worldBoxToScreen=function(a,c){return b.renderer.worldBoxToScreen(a,c)};this.worldUnitToScreen=function(a){return b.renderer.worldUnitToScreen(a)};this.screenPositionToWorld=function(a,c){return b.renderer.screenPositionToWorld(a,c)};this.screenDirectionToWorld=function(a,c){return b.renderer.screenDirectionToWorld(a,c)};this.screenBoxToWorld=function(a,
c){return b.renderer.screenBoxToWorld(a,c)};this.screenUnitToWorld=function(a){return b.renderer.screenUnitToWorld(a)};this.worldPositionToCanvas=function(a,c){return b.renderer.worldPositionToCanvas(a,c)};this.worldDirectionToCanvas=function(a,c){return b.renderer.worldDirectionToCanvas(a,c)};this.worldBoxToCanvas=function(a,c){return b.renderer.worldBoxToCanvas(a,c)};this.worldUnitToCanvas=function(a){return b.renderer.worldUnitToCanvas(a)};this.canvasPositionToWorld=function(a,c){return b.renderer.canvasPositionToWorld(a,
c)};this.canvasDirectionToWorld=function(a,c){return b.renderer.canvasDirectionToWorld(a,c)};this.canvasBoxToWorld=function(a,c){return b.renderer.canvasBoxToWorld(a,c)};this.canvasUnitToWorld=function(a){return b.renderer.canvasUnitToWorld(a)};this.setMinimumInputEventInterval=function(a,b){e.setMinimumIntervalBetweenEvents(a,b)};this.isMouseDown=function(a){return e.isMouseDown(a)};this.isKeyDown=function(a){return e.isKeyDown(a)};this.unpackSpriteSheet=function(a,b,c,d,e){for(var c=c||1,d=d||1,
f=this.getImage(a),g=f.width/c,f=f.height/d,h=0;h<b.length&&h<c*d;h++){var i=document.createElement("canvas");i.width=g;i.height=f;(new Animation(a,c,d,1,!1,h,h)).draw(i.getContext("2d"),{x:g/2,y:f/2},{x:g,y:f});wade.setImage(b[h]||a+"_"+h,i)}e&&this.unloadImage(a)};this.storeLocalObject=function(a,b){localStorage.setItem(a,JSON.stringify(b))};this.retrieveLocalObject=function(a){return(a=localStorage.getItem(a))&&JSON.parse(a)};this.setFullScreen=function(a){var b=document.documentElement;a||"undefined"==
typeof a?a=b.requestFullScreen||b.requestFullscreen||b.mozRequestFullScreen||b.mozRequestFullscreen||b.webkitRequestFullScreen||b.webkitRequestFullscreen||b.msRequestFullScreen||b.msRequestFullscreen:(b=document,a=b.exitFullscreen||b.msExitFullscreen||b.mozCancelFullScreen||b.webkitCancelFullScreen);a&&a.call(b)};this.setLayerSmoothing=function(a,c){"undefined"==typeof c&&(c=!0);b.renderer.setLayerSmoothing(a,c)};this.getLayerSmoothing=function(a){return b.renderer.getLayerSmoothing(a)};this.setSmoothing=
function(a){"undefined"==typeof a&&(a=!0);b.renderer.setSmoothing(a)};this.getSmoothing=function(){return b.renderer.getSmoothing()};this.setClickTolerance=function(a){e.setClickTolerance(a)};this.getMousePosition=function(){return e.getMousePosition()};this.isWebAudioSupported=function(){return!!s};this.forceOrientation=function(a){if(v!=a){switch(a){case "landscape":v="landscape";break;case "portrait":v="portrait";break;default:v="none"}b.setSimulationDirtyState();b.draw()}};this.getForcedOrientation=
function(){return v};this.isScreenRotated=function(){return b.renderer.isScreenRotated()};this.moveCamera=function(a,b,c){"object"!=typeof a||"number"!=typeof a.x||"number"!=typeof a.y||"number"!=typeof a.z?wade.log("Warning - invalid destination for wade.moveCamera(). It needs to be an object with x, y, and z fields."):"number"!=typeof b&&"function"!=typeof b?wade.log("Warning - invalid speed for wade.moveCamera(). It needs to be a number, or a function that returns a number."):this.setMainLoop(function(){var d=
wade.getCameraPosition(),e=a.x-d.x,f=a.y-d.y,g=a.z-d.z,h=Math.sqrt(e*e+f*f+g*g),i="number"==typeof b?b:b(h)||0;h<=i*wade.c_timeStep?(wade.setCameraPosition(a),wade.setMainLoop(0,"_wade_camera"),c&&c(),d={cameraPosition:wade.getCameraPosition()},wade.processEvent("onCameraMove",d)||wade.app.onCameraMoveComplete&&wade.app.onCameraMoveComplete(d)):wade.setCameraPosition({x:d.x+e*i*wade.c_timeStep/h,y:d.y+f*i*wade.c_timeStep/h,z:d.z+g*i*wade.c_timeStep/h})},"_wade_camera")};this.setCameraTarget=function(a,
b,c){a?(b=b||0,c=c||{x:0,y:0},this.setMainLoop(function(){if(a.isInScene()){var d=a.getPosition(),e=wade.getCameraPosition();d.x+=c.x;d.y+=c.y;d.z=e.z;if(b){var e={x:d.x*(1-b)+e.x*b,y:d.y*(1-b)+e.y*b,z:d.z*(1-b)+e.z*b},f=e.x-d.x,g=e.y-d.y,h=e.z-d.z;f*f+g*g+h*h>b*b&&(d=e)}wade.setCameraPosition(d)}},"_wade_cameraTarget")):this.setMainLoop(0,"_wade_cameraTarget")};this.setCameraBounds=function(a,b,c,d,e,f){var g="undefined"==typeof a||null===a,h="undefined"==typeof c||null===c,i="undefined"==typeof e||
null===e,p="undefined"==typeof b||null===b,q="undefined"==typeof d||null===d,m="undefined"==typeof f||null===f;g&&h&&i&&p&&q&&m?this.setMainLoop(null,"_wade_cameraBounds"):this.setMainLoop(function(){var j=wade.getCameraPosition();!g&&(j.x=Math.max(a,j.x));!h&&(j.y=Math.max(c,j.y));!i&&(j.z=Math.max(e,j.z));!p&&(j.x=Math.min(b,j.x));!q&&(j.y=Math.min(d,j.y));!m&&(j.z=Math.min(f,j.z));wade.setCameraPosition(j)},"_wade_cameraBounds",-1)};this.getObjectsInArea=function(a,c){var d=[];b.renderer.addObjectsInAreaToArray(a,
d,c);return d};this.getObjectsInScreenArea=function(a){var c=[];b.renderer.addObjectsInScreenAreaToArray(a,c);return c};this.getSpritesInArea=function(a,c,d){var e=[];b.renderer.addSpritesInAreaToArray(a,e,c,d);return e};this.getSpritesInScreenArea=function(a){var c=[];b.renderer.addSpritesInScreenAreaToArray(a,c);return c};this.getSceneObject=function(a){return(a=b.getObjectByName(a))&&a instanceof SceneObject?a:null};this.getSceneObjects=function(a,c){return b.getSceneObjects(a,c)};this.getImageData=
function(a,b,d,e,f){var g=this.getFullPathAndFileName(a);if(B[g]&&!b&&!d&&!e&&!f)return B[g];var h=c.getImage(g),i;if(h.getContext)i=h.getContext("2d");else{var p=h,h=document.createElement("canvas");h.width=p.width;h.height=p.height;i=h.getContext("2d");i.drawImage(p,0,0);wade.setImage(a,h)}b=b||0;d=d||0;e=e||h.width;f=f||h.height;a=!b&&!d&&e==h.width&&f==h.height;if(B[g]&&a)return B[g];b=i.getImageData(b,d,e,f);B[g]=a?b:i.getImageData(0,0,h.width,h.height);return b};this.putImageData=function(a,
d,e,f,g,h,i,p){var e=e||0,f=f||0,g=g||0,h=h||0,i=i||d.width,p=p||d.height,q=this.getFullPathAndFileName(a),m,j;if("ok"==c.getLoadingStatus(q))if(m=c.getImage(q),m.getContext)j=m.getContext("2d");else{var k=m;m=document.createElement("canvas");m.width=k.width;m.height=k.height;j=m.getContext("2d");j.drawImage(k,0,0);wade.setImage(a,m)}else m=document.createElement("canvas"),m.width=i,m.height=p,j=m.getContext("2d"),wade.setImage(a,m);j.putImageData(d,g,h,e,f,i,p);B[q]=j.getImageData(0,0,m.width,m.height);
b.renderer.updateImageUsers(q)};this.enableMultitouch=function(a){"undefined"==typeof a&&(a=!0);e.enableMultitouch(a)};this.isMultitouchEnabled=function(){return e.isMultitouchEnabled()};this.getVersion=function(){return"3.7.1"};this.requireVersion=function(a,b,c){for(var d=["3","7","1"],e=a.split("."),f=0;f<e.length;f++){var g=d[f]||0;if(g>e[f])break;else if(g<e[f]){c=c||"A newer version of WADE is required ("+a+")";switch(b){case "alert":alert(c);break;case "console":wade.log(c)}return!1}}return!0};
this.getLoadingPercentage=function(){return c.getPercentageComplete()};this.setLoadingBar=function(a,b,c,d){if(a){var a=document.createElement("div"),e=document.createElement("div");a.style.backgroundColor=c||"red";a.style.borderRadius="13px";a.style.padding="3px";a.style.width="50%";a.style.height="20px";a.style.position="absolute";a.style.left=b?2*b.x+"px":0;a.style.right=0;a.style.top=b?2*b.y+"px":0;a.style.bottom=0;a.style.margin="auto";e.style.backgroundColor=d||"orange";e.style.borderRadius=
"10px";e.style.height="20px";e.style.width=0;a.appendChild(e);a.id="__wade_loading_bar";u=a;u.inner=e;document.body.appendChild(a)}else u&&document.body.removeChild(u),u=null};this.areGamepadsSupported=function(){return!(!navigator.webkitGetGamepads&&!navigator.getGamepads)};this.enableGamepads=function(){e.enableGamepads()};this.getImageDataURL=function(a){var b=wade.getImage(a);if(b.toDataURL)return b.toDataURL();(new Sprite(a)).drawToImage(a,!0);return wade.getImage(a).toDataURL()};this.getLayerDataURL=
function(a){return this.getLayer(a).toDataURL()};this.log=function(a){console.log(a)};this.warn=function(a){console.warn(a)};this.error=function(a){console.error(a)};this.forceRedraw=function(a){b.setSimulationDirtyState();b.renderer.forceRedraw(a)};this.forEachPixel=function(a,b,c){for(var d=this.getImageData(a),e=0;e<d.width;e++)for(var f=0;f<d.height;f++){var g=4*(e+f*d.width),h=b(d.data[g],d.data[g+1],d.data[g+2],d.data[g+3],e,f);h&&(d.data[g]=h.r||0,d.data[g+1]=h.g||0,d.data[g+2]=h.b||0,d.data[g+
3]=h.a||0)}wade.putImageData(c||a,d)};this.getLayerCanvas=function(a){return wade.getLayer(a||1).getCanvas()};this.drawLayerToImage=function(a,b,c,d,e,f,g){var h=wade.getLayerCanvas(a),i="__wade_layer"+a;wade.draw(a);var p=function(){var p=h;h=this;wade.setImage(i,h);var q=new Sprite(i),m=1,j=1;if(wade.isSharedCanvas(p)||"2d"==wade.getLayerRenderMode(a))m=wade.getLayerOpacity(a),j=wade.getLayerResolutionFactor(a);1!=m&&q.setDrawFunction(wade.drawFunctions.alpha_(m,q.draw));e||(e={horizontalScale:1/
j,verticalScale:1/j,horizontalSkew:0,verticalSkew:0,horizontalTranslate:0,verticalTranslate:0});q.drawToImage(b,c,d,e,f,"2d");g&&setTimeout(g,0)};if("webgl"==wade.getLayerRenderMode(a)){var q=h.toDataURL(),m=new Image;m.onload=p;m.src=q}else p.call(h)};this.screenCapture=function(a,c){wade.draw();wade.createTransparentImage(a,wade.getScreenWidth(),wade.getScreenHeight());var d=b.renderer.getActiveLayerIds();if(d.length){var e=0,f=0,g=function(b){return function(){p[b].canvas=this;if(++e==f){for(var d in p){var g=
"__wade_layer_"+d;wade.setImage(g,p[d].canvas);var h=new Sprite(g),i=p[d].opacity;1!=i&&h.setDrawFunction(wade.drawFunctions.alpha_(i,h.draw));i=p[d].resolution;h.drawToImage(a,!1,null,{horizontalScale:1/i,verticalScale:1/i,horizontalSkew:0,verticalSkew:0,horizontalTranslate:0,verticalTranslate:0},"","2d");wade.unloadImage(g)}c&&setTimeout(c,0)}}},h,i,p={};for(h=0;h<d.length;h++)if(i=wade.getLayerCanvas(d[h]),!p[i.id]){f++;var q=1,m=1;if(wade.isSharedCanvas(i)||"2d"==wade.getLayerRenderMode(d[h]))q=
wade.getLayerOpacity(d[h]),m=wade.getLayerResolutionFactor(d[h]);p[i.id]={canvas:i,opacity:q,resolution:m}}for(var j in p)i=p[j].canvas,d=i.toDataURL(),h=new Image,h.onload=g(j),h.src=d}else setTimeout(c,0)};this.setLayerOpacity=function(a,b){this.getLayer(a).setOpacity(b)};this.getLayerOpacity=function(a){a=parseFloat(this.getLayer(a).getOpacity());return isNaN(a)?1:a};this.getContainerName=function(){return I};this.fadeInLayer=function(a,b,c){var d="__wade_fadeLayer_"+a;wade.setLayerOpacity(a,0);
this.setMainLoop(function(){var e=wade.getLayerOpacity(a),e=Math.min(1,e+wade.c_timeStep/b);1-e<wade.c_epsilon&&(e=1);wade.setLayerOpacity(a,e);1==e&&(wade.setMainLoop(null,d),c&&c())},d)};this.fadeOutLayer=function(a,b,c){var d="__wade_fadeLayer_"+a;wade.setLayerOpacity(a,1);this.setMainLoop(function(){var e=wade.getLayerOpacity(a),e=Math.max(0,e-wade.c_timeStep/b);e<wade.c_epsilon&&(e=0);wade.setLayerOpacity(a,e);0==e&&(wade.setMainLoop(null,d),c&&c())},d)};this.clearCanvas=function(a){this.getLayer(a).clear()};
this.draw=function(a){b.draw(a,!0)};this.exportScene=function(a,c,d){c={sceneObjects:b.exportSceneObjects(c,d),paths:b.exportPaths(c)};c.layers=b.renderer.getLayerSettings(!0);c.minScreenSize={x:wade.getMinScreenWidth(),y:wade.getMinScreenHeight()};c.maxScreenSize={x:wade.getMaxScreenWidth(),y:wade.getMaxScreenHeight()};c.orientation=wade.getForcedOrientation();c.windowMode=wade.getWindowMode();c.defaultLayer=wade.defaultLayer||1;return a?JSON.stringify(c):c};this.importScene=function(a,b,c,d,e){J=
!0;b&&wade.setLoadingBar(!0,b.position,b.backColor,b.foreColor);var f=a.sceneObjects,g=a.paths,b=a.images||[];if(f)for(var h=0;h<f.length;h++)if(f[h].sprites)for(var i=0;i<f[h].sprites.length;i++)if(f[h].sprites[i].image&&-1==b.indexOf(f[h].sprites[i].image)&&"procedural_"!=f[h].sprites[i].image.substr(0,11)&&b.push(f[h].sprites[i].image),f[h].sprites[i].animations)for(var p in f[h].sprites[i].animations)if(f[h].sprites[i].animations.hasOwnProperty(p)){var q=f[h].sprites[i].animations[p].image;q&&
"procedural_"!=q.substr(0,11)&&-1==b.indexOf(q)&&b.push(q)}var m=0,j=b.length,k=function(){if(++m==j){e&&wade.clearScene();if(a.scripts)for(var b=0;b<a.scripts.length;b++)try{eval.call(window,wade.getScript(a.scripts[b]))}catch(c){wade.error("Unable to execute script "+a.scripts[b]+" - "+c.message)}a.minScreenSize&&wade.setMinScreenSize(a.minScreenSize.x,a.minScreenSize.y);a.maxScreenSize&&wade.setMaxScreenSize(a.maxScreenSize.x,a.maxScreenSize.y);a.windowMode&&wade.setWindowMode(a.windowMode);a.orientation&&
wade.forceOrientation(a.orientation);if(a.layers)for(b=0;b<a.layers.length;b++)if(a.layers[b]){var d="number"!=typeof a.layers[b].scaleFactor?1:a.layers[b].scaleFactor,h="number"!=typeof a.layers[b].translateFactor?1:a.layers[b].translateFactor,p="undefined"!=typeof a.layers[b].useQuadtree?a.layers[b].useQuadtree:!0,q="number"!=typeof a.layers[b].resolutionFactor?1:a.layers[b].resolutionFactor,k=a.layers[b].postProcessShader||"",K=a.layers[b].postProcessShaderUniforms,l=a.layers[b].properties||{};
wade.setLayerRenderMode(b,"2d"==a.layers[b].renderMode?"2d":"webgl",{offScreenTarget:!!k});wade.setLayerTransform(b,d,h);wade.useQuadtree(b,p);wade.setLayerResolutionFactor(b,q);wade.setPostProcessShader(b,k,K);wade.setLayerCustomProperties(b,l)}a.defaultLayer&&(wade.defaultLayer=a.defaultLayer);if(g)for(b=0;b<g.length;b++)d=new Path(g[b]),wade.addPath(d);if(f){d={};for(b=0;b<f.length;b++)if(h=new SceneObject(f[b]),a.loadGlTextures)for(i=0;i<h.getSpriteCount();i++)if(q=h.getSprite(i),p=q.getLayerId(),
"webgl"==wade.getLayerRenderMode(p)){d[p]=d[p]||[];q=q.getAllImageNames();for(k=0;k<q.length;k++)-1==d[p].indexOf(q[k])&&d[p].push(q[k])}for(var u in d){h=wade.getLayer(u).getContext();for(b=0;b<d[u].length;b++)h.setTextureImage(wade.getImage(d[u][b]),!0)}}if(a.modules)if(b=function(){++m==j&&y()},Object.keys(a.modules).length)for(var n in a.modules)a.modules.hasOwnProperty(n)&&(wade[n]&&wade[n].importScene?(j++,wade[n].importScene(a.modules[n],b)):(wade.error("The scene being imported contains data for module "+
n+", but the module isn't available or not up to date"),j++,setTimeout(b,0)));else y();else y()}},y=function(){setTimeout(function(){J=!1;a.timeline&&wade.startTimeline(a.timeline);a.flowChart&&wade.runFlowChart(a.flowChart);c&&c()},0)},l=function(a){return function(){wade.error(a);k()}},u=d?"pre":"";if(a.json){var j=j+a.json.length,n={};a.json.forEach(function(a){if("object"==typeof a)var b=a.resource,c=a.target;else b=a;a=b+"___"+c;n[a]?j--:(wade[u+"loadJson"](b,null,function(a){c&&(wade.app[c]=
wade.isArray(a)?wade.cloneArray(a):wade.cloneObject(a));k()},!1,l("Failed to load JSON file "+b)),n[a]=!0)})}if(a.text){var j=j+a.text.length,x={};a.text.forEach(function(a){if("object"==typeof a)var b=a.resource,c=a.target;else b=a;a=b+"___"+c;x[a]?j--:(wade[u+"loadText"](b,null,function(a){c&&(wade.app[c]=a);k()},!1,l("Failed to load text file "+b)),x[a]=!0)})}if(a.audio&&(!a.webAudioOnly||wade.isWebAudioSupported())){j+=a.audio.length;for(h=0;h<a.audio.length;h++)if(a.audio.indexOf(a.audio[h])==
h)wade[u+"loadAudio"](a.audio[h],!1,!1,k,l("Failed to load audio file "+a.audio[h]));else j--}if(a.fonts){j+=a.fonts.length;for(h=0;h<a.fonts.length;h++)if(a.fonts.indexOf(a.fonts[h])==h)wade[u+"loadFont"](a.fonts[h],k,l("Failed to load font file "+a.fonts[h]));else j--}if(a.scripts){j+=a.scripts.length;for(h=0;h<a.scripts.length;h++)if(a.scripts.indexOf(a.scripts[h])==h)wade[u+"loadScript"](a.scripts[h],k,!1,l("Failed to load script file "+a.scripts[h]),!0);else j--}if(b.length)for(h=0;h<b.length;h++)if(b.indexOf(b[h])==
h)wade[u+"loadImage"](b[h],k,l("Failed to load image file "+b[h]));else j--;j||(j=1,k())};this.loadScene=function(a,b,c,d){wade.loadJson(a,null,function(a){wade.importScene(a,b,c,!1,d)})};this.preloadScene=function(a,b,c,d){wade.preloadJson(a,null,function(a){wade.importScene(a,b,c,!0,d)})};this.useQuadtree=function(a,b){"undefined"==typeof b&&(b=!0);this.getLayer(a).useQuadtree(b)};this.isUsingQuadtree=function(a){return this.getLayer(a).isUsingQuadtree()};this.pauseSimulation=function(a){if(a)for(var b=
0;b<n.length;b++){if(n[b].name==a){n[b].paused=!0;break}}else D=!0};this.resumeSimulation=function(a){var b;if(a)for(b=0;b<n.length;b++){if(n[b].name==a){n[b].paused=!1;break}}else{for(b=0;b<n.length;b++)n[b].paused=!1;D=!1}};this.setCatchUpBuffer=function(a){M=a};this.getCatchUpBuffer=function(){return M};this.preventIframe=function(){if(!window.location||!window.top.location||!location||!top.location||window.location!==window.top.location||location!==top.location)wade=0};this.siteLock=function(a){var b=
...
b&&-1!=c.indexOf(b.toLowerCase())&&(wade=0)}};this.removeLayer=function(a){b.renderer.removeLayer(a)};this.removeUnusedLayers=function(a){b.renderer.removeUnusedLayers(a)};this.setLayer3DTransform=function(a,b,c,d,e){this.getLayer(a).set3DTransform(b||"translate3d(0, 0, 0)",c||"50% 50%",d,e)};this.skipMissedFrames=function(){r=(new Date).getTime()};this.getSceneObjectIndex=function(a){return b.getSceneObjectIndex(a)};this.setSceneObjectIndex=function(a,c){return b.setSceneObjectIndex(a,c)};this.setSwipeTolerance=
function(a,b){e.setSwipeTolerance(a,b||3)};this.setLayerRenderMode=function(a,b,c){this.getLayer(a,b).setRenderMode(b,c)};this.getLayerRenderMode=function(a){return this.getLayer(a).getRenderMode()};this.isWebGlSupported=function(){if("undefined"!=typeof F)return!!F;try{var a=document.createElement("canvas"),b=a.getContext("webgl",{failIfMajorPerformanceCaveat:!z})||a.getContext("experimental-webgl",{failIfMajorPerformanceCaveat:!z})}catch(c){return F=!1}return F=!!b};this.isDebugMode=function(){return!!G};
...
"length",{enumerable:!0,set:function(a){for(var d=c.length-1;d>=a;d--)b(d);c.length=a},get:function(){return c.length}});d.push=function(){for(var a=0;a<arguments.length;a++){var d=c.push(arguments[a])-1;b(d,arguments[a],!0)}};return d};this.autoLoadImages=function(a){"undefined"==typeof a&&(a=!0);A=a};this.isAutoLoadingImages=function(){return A};this.addPath=function(a){b.addPath(a)};this.removePath=function(a){b.removePath("string"==typeof a?this.getPath(a):a)};this.getPaths=function(a,c){return b.getPaths(a,
c)};this.getPath=function(a){return(a=b.getObjectByName(a))&&a instanceof Path?a:null};this.getKeyName=function(a){return e.getKeyName(a)};this.getKeyCode=function(a){return e.getKeyCode(a)};this.isArray=function(a){return Array.isArray(a)};this.ajax=function(a){var a=a||{},b=a.type||"GET",c=a.url;if(c){"undefined"!=typeof a.cache&&!a.cache&&(c+=/\?/.test(c)?"&":"?"+(new Date).getTime());var d=function(){a.error&&a.error(this.responseText)},e=new XMLHttpRequest;e.addEventListener("load",function(){var b=
this.responseText;if(a.dataType)switch(a.dataType){case "json":try{b=JSON.parse(b)}catch(c){wade.error("Failed to load JSON data from "+a.url+" : "+c);a.error&&a.error(b);return}}a.success&&a.success(b)});e.addEventListener("error",d);e.open(b,c);a.timeout&&(e.addEventListener("timeout",d),e.timeout=a.timeout);a.contentType&&e.setRequestHeader("Content-type",a.contentType);e.send(a.data||null)}else wade.error("Invalid ajax request - url was not specified")};this.startTimeline=function(b,c,d){b.events||
(b.events=[]);c=c||0;d||(d=this.timelineUid=this.timelineUid+1||1,d="__wade_timeline_"+d,q[d]={timeline:b,time:c,active:!0});var e="clock"==b.referenceTime?this.getClockTime()/1E3:this.getAppTime(),f=function(){var f=("clock"==b.referenceTime?a.getClockTime()/1E3:a.getAppTime())-e+c;q[d].time=f;for(var h=0,g=0;g<b.events.length;g++)if(!b.events[g].processed&&b.events[g].code&&(h++,f>=b.events[g].time)){b.events[g].processed=!0;var i="(function(){"+b.events[g].code+"})()";if(G){var p=y.length;y.push({time:b.events[g].time,
code:b.events[g].code});i+="\n//# sourceURL=timeline_event_"+p+"_"+b.events[g].time+"s.js"}eval.call(window,i)}h||a.setMainLoop(null,d)};this.setMainLoop(f,d);f();return d};this.stopTimeline=function(a){q[a]&&(q[a].active=!1);this.setMainLoop(null,a)};this.resumeTimeline=function(a){q[a].active=!0;this.startTimeline(q[a].timeline,q[a].time,a)};this.getProcessedTimelineEvent=function(a){return!G?(wade.error("Cannot call wade.getProcessedTimelineEvent when not in debug mode"),{time:0,code:""}):y[a||
0]};this.clearTimelines=function(){for(var a in q)this.stopTimeline(a);q={}};this.createTransparentImage=function(a,b,c){var d=new Sprite;d.setDrawFunction(wade.doNothing);d.setSize(b,c);d.drawToImage(a,!0,null,null,"","2d")};this.getTimelines=function(){return q};this.setPostProcessShader=function(a,b,c){this.getLayer(a).setPostProcessShader(b,c)};this.getPostProcessShader=function(a){return this.getLayer(a).getPostProcessShader()};this.getPostProcessShaderUniforms=function(a){return this.getLayer(a).getPostProcessShaderUniforms()};
this.setLayerCustomProperty=function(a,b,c){this.getLayer(a).setCustomProperty(b,c)};this.setLayerCustomProperties=function(a,b){this.getLayer(a).setCustomProperties(b)};this.getLayerCustomProperty=function(a,b){return this.getLayer(a).getCustomProperty(b)};this.getLayerCustomProperties=function(a){return this.getLayer(a).getCustomProperties()};this.setTimeout=function(b,c){if("function"==typeof c&&"number"==typeof b)var d=c,c=b,b=d;E.push({f:b,time:1E3*a.getAppTime()+c,uid:++H});return H};this.setInterval=
function(b,c){if("function"==typeof c&&"number"==typeof b)var d=c,c=b,b=d;E.push({f:b,time:1E3*a.getAppTime()+c,repeat:c,uid:++H});return H};this.clearTimeout=function(a){for(var b=0;b<E.length;b++)if(E[b].uid==a&&!E[b].repeat)return wade.removeObjectFromArrayByIndex(b,E),!0;return!1};this.clearInterval=function(a){for(var b=0;b<E[b];b++)if(E[b].uid==a&&E[b].repeat)return wade.removeObjectFromArrayByIndex(b,E),!0;return!1};this.clearAllTimeoutsAndIntervals=function(){var a=E.length;E.length=0;return!!a};
this.runFlowChart=function(a,b,c,d,e){"undefined"==typeof c&&(c=!0);var d=d||0,f={visitedNodes:[],startTime:wade.getAppTime(),flowChartData:wade.cloneObject(a)},h=function(a){e&&e.isInScene&&!e.isInScene()||f.cancelled?(f.running=!1,e&&delete e.next):(a.func||(a.func=p(a)),f.visitedNodes.push(a.uid),e&&(e.next=g),a.func.call(e||i))},g=function(a){var b=f.currentNode.children&&f.currentNode.children[Object.keys(f.currentNode.children)[0]],a="undefined"==typeof a?b:f.currentNode.children&&f.currentNode.children[a];
f.currentNode=(a||"number"==typeof a)&&q[a];f.currentNode?wade.setTimeout(function(){h(f.currentNode)},d||0):(f.currentNode=null,f.running=!1,a={flowChartData:f.flowChartData},e&&e.process("onFlowChartEnd",a),wade.app.onFlowChartEnd&&wade.app.onFlowChartEnd(a))},i={next:g},p=function(a){var b=a.code;a.func=b?eval.call(window,"(function(){"+b+"})"):wade.doNothing},q=f.flowChartData.boxes,m;for(m in q)if(q.hasOwnProperty(m)&&(c&&p(q[m]),!f.currentNode)){if(!b&&(q[m].startNode&&"number"!=typeof b)&&
(f.currentNode=q[m],!c))break;if((b||"number"==typeof b)&&(q[m].title==b||m==b))if(f.currentNode=q[m],!c)break}f.currentNode=f.currentNode||q[Object.keys(q)[0]];if(!f.currentNode)return wade.warn("Unable to run flow chart - no start node was found"),null;f.running=!0;h(f.currentNode);e&&(e.flowChartStatus=f);return f};this.mergeGlLayers=function(a){"undefined"==typeof a&&(a=!0);if(!!a!==!!L){L=!!a;for(var a=this.getAllLayers(),b=0;b<a.length;b++)"webgl"==a[b].getRenderMode()&&(a[b].removeCanvas(),
a[b].initCanvas())}};this.areGlLayersMerged=function(){return L};this.findPath=function(a){var b={x:a.start.x,y:a.start.y},c=a.target.x,d=a.target.y,e=a.collisionMap,f=a.boundaries||{minX:0,minY:0,maxX:e[0].length-1,maxY:e[0][0].length-1},h=a.heightMap,g=a.movementOffsets||O.straight;"string"==typeof g&&(g=O[g]);var i=a.maxPathLength||0,p=a.maxStepHeight,q="undefined"!=typeof p,m,j=[],k=[b];b.gScore=0;b.hScore=Math.abs(b.x-c)+Math.abs(b.y-d);for(b.fScore=b.hScore;k.length;){for(var y=k[0].fScore,
u=k[0],l=0,a=1;a<k.length;a++){m=k[a];var n=m.fScore;n<y&&(u=m,y=n,l=a)}if(u.x==c&&u.y==d){c=[];for(a=u;a.cameFrom;)c.push(a),a=a.cameFrom;c.push(b);b=[];for(a=0;a<c.length;a++)b.push(c[c.length-1-a]);return b}wade.removeObjectFromArrayByIndex(l,k);j.push(u);if(!(i&&u.gScore>=i)){y=h&&h[u.x]&&h[u.x][u.y]||0;for(a=0;a<g.length;a++)if(l=g[a],l={x:u.x+l.x,y:u.y+l.y},!(l.x<f.minX||l.y<f.minY||l.x>f.maxX||l.y>f.maxY))if(!(q&&Math.abs((h[l.x]&&h[l.x][l.y]||0)-y)>p)&&(!e[l.x]||!e[l.x][l.y])){n=!1;for(m=
0;m<j.length;m++){var x=j[m];if(x.x==l.x&&x.y==l.y){n=!0;break}}if(!n){n=u.gScore+1;x=!1;for(m=0;m<k.length;m++){var D=k[m];if(D.x==l.x&&D.y==l.y){x=!0;l=D;break}}m=!1;x?n<l.gScore&&(m=!0):(k.push(l),l.hScore=Math.abs(l.x-c)+Math.abs(l.y-d),m=!0);m&&(l.cameFrom=u,l.gScore=n,l.fScore=l.gScore+l.hScore)}}}}return[]};this.getPathIndex=function(a){return b.getPathIndex(a)};this.setPathIndex=function(a,c){return b.setPathIndex(a,c)};this.doNothing=function(){};this.isImportingScene=function(){return!!J};
this.getAudio=function(a){a=this.getFullPathAndFileName(a);return c.getAudio(a)};this.playSilentSound=function(){if(s){var a=s.createOscillator();a.frequency.value=440;var b=s.createGainNode();b.gain.value=0;a.connect(b);b.connect(s.destination);a.start?a.start(0):a.noteOn(0);a.stop?a.stop(0.001):a.noteOff(0.001)}else{a=new Audio;a.src="data:audio/wav;base64,UklGRjoAAABXQVZFZm10IBAAAAABAAEA6AcAANAPAAACABAAZGF0YQYAAAAAAAAAAAA%3D";try{a.play()}catch(c){}}};this.event_mainLoopCallback_=function(){return function(){a.event_mainLoop()}};
this.event_mainLoop=function(){var d,e;f=requestAnimationFrame(this.event_mainLoopCallback_());if(!J)if(c.isFinishedLoading()){for(d=0;d<l.length;d++)"none"!=l[d].style.display&&(l[d].style.display="none");u&&"none"!=u.style.display&&(u.style.display="none");if(i){b.draw();d=(new Date).getTime();var g=0;e=Math.round((d-r)/(1E3*wade.c_timeStep));r?g=Math.min(3,e):r=d;g&&(e>M/wade.c_timeStep?(g=1,r=d):r+=1E3*g*wade.c_timeStep);for(d=0;d<g&&!D;d++){b.step();var p=1E3*a.getAppTime();for(e=E.length-1;0<=
e;e--)if(p>=E[e].time){var q=E[e];q.repeat?q.time+=q.repeat:a.removeObjectFromArrayByIndex(e,E);q.f()}for(e=0;e<n.length;e++)n[e].paused||(p=n[e].func)&&p()}D&&b.setSimulationDirtyState()}else h&&this.initializeApp()}else{r=(new Date).getTime();for(d=0;d<l.length;d++)l[d].src&&(l[d].style.display="inline");u&&(u.inner.style.width=this.getLoadingPercentage()+"%")}};this.event_appTimerEvent=function(){g=setTimeout("wade.event_appTimerEvent();",1E3*k);b.appTimerEvent()};this.onObjectNameChange=function(a,
c){a.isInScene()&&b.changeObjectName(a,c)};this.getLayer=function(a,c){return b.renderer.getLayer(a,c)};this.getAllLayers=function(){return b.renderer.getAllLayers()};this.isSharedCanvas=function(a){for(var b=this.getAllLayers(),c=0,d=0;d<b.length;d++)if(b[d].getCanvas()==a&&2==++c)return!0;return!1};this.updateMouseInOut=function(a,c){b.updateMouseInOut(a,c)};this.addImageUser=function(a,c){b.renderer.addImageUser(a,c)};this.removeImageUser=function(a,c){b.renderer.removeImageUser(a,c)};this.removeAllImageUsers=
function(a){b.renderer.removeAllImageUsers(a)};this.getInternalContext=function(){return x};this.getImageUsers=function(a){return b.renderer.getImageUsers(a)};this.releaseImageReference=function(a){c.releaseImageReference(this.getFullPathAndFileName(a))};this.extend=function(){var a,b,c,d,e,f=arguments[0]||{},g=1,h=arguments.length,i=!1;"boolean"===typeof f&&(i=f,f=arguments[g]||{},g++);"object"!==typeof f&&"function"!==typeof f&&(f={});g===h&&(f=this,g--);for(;g<h;g++)if(null!=(a=arguments[g]))for(b in a)c=
f[b],d=a[b],f!==d&&(i&&d&&(wade.isPlainObject(d)||(e=wade.isArray(d)))?(e?(e=!1,c=c&&wade.isArray(c)?c:[]):c=c&&wade.isPlainObject(c)?c:{},f[b]=wade.extend(i,c,d)):void 0!==d&&(f[b]=d));return f};this.isPlainObject=function(a){if(!a)return!1;try{if("[object Object]"!==toString.call(a))return!1}catch(b){try{if("[object Object]"!==Object.prototype.toString.call(a))return!1}catch(c){}}a=Object.getPrototypeOf(a);if(!a)return!0;a=Object.hasOwnProperty.call(a,"constructor")&&a.constructor;return"function"===
typeof a&&N.call(a)===P};this.texImage2D=function(a,b){var c=b.width,d=b.height,e=!(c&c-1||d&d-1);b.image?a.texImage2D(a.TEXTURE_2D,0,a.RGBA,a.RGBA,a.UNSIGNED_BYTE,b.image):a.texImage2D(a.TEXTURE_2D,0,a.RGBA,c,d,0,a.RGBA,a.UNSIGNED_BYTE,null);e?(a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MAG_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.LINEAR_MIPMAP_NEAREST),a.generateMipmap(a.TEXTURE_2D)):(a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,
a.TEXTURE_MAG_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE))};this.isUsingGlobalUnderscore=function(){return C};this.deprecate=function(b,c){this[b]=function(){a.warn("wade."+b+" is deprecated. Please use wade."+c+" instead");return a[c].apply(a,arguments)}};window.console||(window.console={});window.console.log||(window.console.log=this.doNothing);window.console.warn||(window.console.warn=window.console.log);
window.console.error||(window.console.error=window.console.warn);this.deprecate("playAudioSegmentIfAvailable","playAudioSegment");this.deprecate("playAudioIfAvailable","playAudio");this.deprecate("setMainLoopCallback","setMainLoop")}wade=new Wade;
...
this._size.x-d,this._size.y-d);c.restore()}}};this.solidFade_=function(a,b,c,d,e,f,g,i,h,j){var k=0;return function(l){if(this._visible)if(l.isWebGl)wade.error("wade.drawFunctions.solidFade_ is not available in webgl mode");else{if(!this._animations.__fade){var n=new Animation("",1,1,1,!0);this.addAnimation("__fade",n)}this.playAnimation("__fade");var n=l.fillStyle,r=k/h,t=Math.floor(a*(1-r)+e*r),v=Math.floor(b*(1-r)+f*r),p=Math.floor(c*(1-r)+g*r),r=d*(1-r)+i*r;this._rotation&&(l.save(),l.translate(this._position.x,
this._position.y),l.rotate(this._rotation),l.translate(-this._position.x,-this._position.y));l.fillStyle="rgba("+t+","+v+","+p+","+r+")";t=this._layer?0.5*wade.screenUnitToWorld(this._layer.id):0.5;l.fillRect(this._position.x-this._size.x/2+t,this._position.y-this._size.y/2+t,this._size.x-t,this._size.y-t);l.fillStyle=n;this._rotation&&l.restore();k<h&&(k++,k==h&&j&&j())}}};this.grid_=function(a,b,c,d){return function(e){if(this._visible)if(e.isWebGl)wade.error("wade.drawFunctions.grid_ is not available in webgl mode");
else{d=d||1;e.save();e.lineWidth=d;e.strokeStyle=c;e.lineJoin="round";e.lineCap="round";this._rotation&&(e.translate(this._position.x,this._position.y),e.rotate(this._rotation),e.translate(-this._position.x,-this._position.y));for(var f=(this._layer?0.5*wade.screenUnitToWorld(this._layer.id):0.5)*d,g=(this._size.x-2*f)/a,i=(this._size.y-2*f)/b,h=this._position.x-this._size.x/2+f,j=this._position.y-this._size.y/2+f,k=this._position.x+this._size.x/2-f,f=this._position.y+this._size.y/2-f,l=h,n=j,r=0;r<=
b;r++)e.beginPath(),e.moveTo(h,n),e.lineTo(k,n),e.stroke(),n+=i;for(i=0;i<=a;i++)e.beginPath(),e.moveTo(l,j),e.lineTo(l,f),e.stroke(),l+=g;e.restore()}}};this.alpha_=function(a,b){return function(c){if(this._visible){var d=c.globalAlpha;c.globalAlpha=a;b.call(this,c);c.globalAlpha=d}}};this.blink_=function(a,b,c){var d=1,e=a;return function(f){if(this._visible){if(0>(e-=wade.c_timeStep))e=d?b:a,d=!d;d&&c.call(this,f);this.setDirtyArea()}}};this.additive_=function(a){a=a||Sprite.prototype.draw;return function(b){var c=
b.globalCompositeOperation;b.globalCompositeOperation="lighter";a.call(this,b);b.globalCompositeOperation=c}};this.fadeOpacity_=function(a,b,c,d,e){var f=(b-a)*wade.c_timeStep/c,g=a,d=d||Sprite.prototype.draw,i=function(c){if(this._visible){var j=g;g=Math[b>a?"min":"max"](b,g+f);var k=c.globalAlpha;c.globalAlpha=g;d.call(this,c);c.globalAlpha=k;g==b&&(1==g||0==g)?this.getDrawFunction()==i&&this.setDrawFunction(d):g!=j&&this.setDirtyArea();g==b&&(e&&e(),e=null)}};return i};this.resizeOverTime_=function(a,
b,c,d,e,f,g){var i=(c-a)*wade.c_timeStep/e,h=a,j=(d-b)*wade.c_timeStep/e,k=b,f=f||Sprite.prototype.draw,l=function(e){this._visible&&(h=Math[c>a?"min":"max"](c,h+i),k=Math[d>b?"min":"max"](d,k+j),this.setSize(h,k),f.call(this,e),h==c&&k==d&&(l==this.getDrawFunction()&&this.setDrawFunction(f),g&&g(),g=null))};return l};this.resizePeriodically_=function(a,b,c,d,e,f){var g=1,i=(c-a)*wade.c_timeStep/e,h=a,j=(d-b)*wade.c_timeStep/e,k=b,f=f||Sprite.prototype.draw;return function(e){if(this._visible){var n=
1==g?c:a,r=1==g?b:d,t=1==g?d:b;h=Math[n>(1==g?a:c)?"min":"max"](n,h+i*g);k=Math[t>r?"min":"max"](t,k+j*g);this.setSize(h,k);f.call(this,e);h==n&&k==t&&(g*=-1)}}};this.mirror_=function(a){a=a||Sprite.prototype.draw;return function(b){b.isWebGl?(this._f32AnimFrameInfo[2]*=-1,this._animations[this._currentAnimation].mirror()):b.scale(-1,1);var c=this._position.x,d=this._cornerX;this._position.x*=-1;this._cornerX=this._position.x-this._size.x/2;a.call(this,b);this._position.x=c;this._cornerX=d;b.isWebGl?
(this._f32AnimFrameInfo[2]*=-1,this._animations[this._currentAnimation].mirror()):b.scale(-1,1)}};this.flip_=function(a){a=a||Sprite.prototype.draw;return function(b){b.isWebGl?(this._f32AnimFrameInfo[3]*=-1,this._animations[this._currentAnimation].flip()):b.scale(1,-1);var c=this._position.y,d=this._cornerY;this._position.y*=-1;this._cornerY=this._position.y-this._size.y/2;a.call(this,b);this._position.y=c;this._cornerY=d;b.isWebGl?(this._f32AnimFrameInfo[3]*=-1,this._animations[this._currentAnimation].flip()):
b.scale(1,-1)}};this.composite_=function(a,b){b=b||Sprite.prototype.draw;return function(c){if(a!=c.globalCompositeOperation){var d=c.globalCompositeOperation;c.globalCompositeOperation=a;b.call(this,c);c.globalCompositeOperation=d}else b.call(this,c)}};this.boundingBox_=function(a,b,c){a=a||"red";b=b||"blue";c=c||Sprite.prototype.draw;return function(d){if(this._visible)if(d.isWebGl)wade.error("wade.drawFunctions.boundingBox_ is not available in webgl mode");else{d.save();d.lineWidth=1;var e=this._layer?
0.5*wade.screenUnitToWorld(this._layer.id):0.5;if(this._rotation){d.strokeStyle=b;d.lineJoin="round";d.lineCap="round";d.beginPath();var f=-this.orientedBoundingBox.axisXx-this.orientedBoundingBox.axisYx,g=-this.orientedBoundingBox.axisXx+this.orientedBoundingBox.axisYx,i=this.orientedBoundingBox.axisXx+this.orientedBoundingBox.axisYx,h=this.orientedBoundingBox.axisXx-this.orientedBoundingBox.axisYx,j=-this.orientedBoundingBox.axisXy-this.orientedBoundingBox.axisYy,k=-this.orientedBoundingBox.axisXy+
this.orientedBoundingBox.axisYy,l=this.orientedBoundingBox.axisXy+this.orientedBoundingBox.axisYy,n=this.orientedBoundingBox.axisXy-this.orientedBoundingBox.axisYy,f=f+(0<f?-e:e),g=g+(0<g?-e:e),h=h+(0<h?-e:e),i=i+(0<i?-e:e),j=j+(0<j?-e:e),k=k+(0<k?-e:e),n=n+(0<n?-e:e),l=l+(0<l?-e:e);d.moveTo(this.orientedBoundingBox.centerX+f,this.orientedBoundingBox.centerY+j);d.lineTo(this.orientedBoundingBox.centerX+g,this.orientedBoundingBox.centerY+k);d.lineTo(this.orientedBoundingBox.centerX+i,this.orientedBoundingBox.centerY+
l);d.lineTo(this.orientedBoundingBox.centerX+h,this.orientedBoundingBox.centerY+n);d.lineTo(this.orientedBoundingBox.centerX+f,this.orientedBoundingBox.centerY+j);d.stroke()}d.strokeStyle=a;d.beginPath();d.moveTo(this.boundingBox.minX+e,this.boundingBox.minY+e);d.lineTo(this.boundingBox.maxX-e,this.boundingBox.minY+e);d.lineTo(this.boundingBox.maxX-e,this.boundingBox.maxY-e);d.lineTo(this.boundingBox.minX+e,this.boundingBox.maxY-e);d.lineTo(this.boundingBox.minX+e,this.boundingBox.minY+e);d.stroke();
d.restore();c.call(this,d)}}};this.transparent_=function(){return function(){}}}wade.drawFunctions=new Wade_drawFunctions;
...
a.y)};this.maxComponent=function(a){return Math.max(a.x,a.y)}}wade.vec2=new Wade_vec2;
...
Wade_iso=function(){var a=this,b=1.018,c=30,d=25,e={},f=[],g,i,h,j,k,l,n=function(){g||a.init()};this.init=function(p){g=!0;p=p||{};"number"==typeof p.tileScaleFactor&&(b=p.tileScaleFactor);"number"==typeof p.terrainLayerId&&(c=p.terrainLayerId);"number"==typeof p.objectsLayerId&&(d=p.objectsLayerId);p.dontClearCanvas&&wade.setCanvasClearing(c,!1);wade.setLayerSorting(d,"bottomToTop");i=new SceneObject(0,TerrainBehavior,0,0,"iso_terrain");i.iso={};h=i.getBehavior();"object"==typeof p.tileSize&&(h.c_tileSize=
wade.cloneObject(p.tileSize));if("object"==typeof p.numTiles)var m=p.numTiles.x,q=p.numTiles.z;m=m||0;q=q||0;m&&q&&wade.addSceneObject(i,!1);this.gameObjects=[];this.gridObjects=[];this.collisionMap=[];f=[];k=p.movementDirection||"diagonal";l=t(k);var y=new Sprite(0,c);y.setSize(h.c_tileSize.x,h.c_tileSize.x);y.setDrawFunction(wade.drawFunctions.solidFill_("white"));y.setRotation(Math.PI/4);var u=new Sprite(0,c);u.setSize(h.c_tileSize.x,h.c_tileSize.x);u.setDrawFunction(wade.drawFunctions.grid_(1,
1,"black",2));u.setRotation(Math.PI/4);var n=new Sprite(0,c);n.setDrawFunction(function(){});var w=Math.ceil(h.c_tileSize.x*Math.sqrt(2));n.setSize(w,w);n.drawToImage("_wade_isoDefault",!0);y.drawToImage("_wade_isoDefault",!1,null,null,"","2d");y=new Sprite("_wade_isoDefault",c);y.setSize(h.c_tileSize.x,h.c_tileSize.y);y.drawToImage("_wade_isoDefault",!0,null,null,"","2d");n.drawToImage("_wade_isoGrid",!0,null,null,"","2d");u.drawToImage("_wade_isoGrid",!1,null,null,"","2d");y=new Sprite("_wade_isoGrid",
c);y.setSize(h.c_tileSize.x,h.c_tileSize.y);y.drawToImage("_wade_isoGrid",!0,null,null,"","2d");p.map?(e={},"string"==typeof p.map?wade.loadJson(p.map,null,function(a){j={data:wade.cloneObject(a)};h.loadData_begin(j.data,r("terrain",p.callback));v(j.data,p.callback)}):(j=wade.cloneObject(p.map),h.loadData_begin(j.data,r("terrain",p.callback)),v(j.data,p.callback))):h.setNumTiles(m,q);wade.setMainLoop(function(){for(var b=f.length-1;0<=b;b--){var c=f[b],d=c.getPosition(),e=h.getFlatTileCoordinates(d.x,
d.y),g=h.getFlatWorldCoordinates(e.x,e.z),i=d.x-g.x,g=d.y-g.y,p=h.c_tileSize.x/2,q=h.c_tileSize.y/2,m=wade.c_epsilon;("both"==k||"straight"==k)&&Math.abs(i)<m&&g*g>=q*q-m||Math.abs(g)<m&&i*i>=p*p-m||(a.updateObjectTile(c,e.x,e.z)?(c.iso.previousPosition.x=d.x,c.iso.previousPosition.y=d.y):(c.setPosition(c.iso.previousPosition),c.processEvent("onStuck",{})),c.iso.targetCoords&&(c.iso.targetCoords.x==e.x&&c.iso.targetCoords.z==e.z)&&(c.iso.targetCoords=0,wade.removeObjectFromArray(c,f)))}},"_wade_isoMovingObjects");
!p.map&&p.callback&&p.callback()};this.importScene=function(a,b){n();j={data:a};h.loadData_begin(j.data,r("terrain",b));v(j.data,b)};this.getTileSize=function(){n();return wade.cloneObject(h.c_tileSize)};this.getValidMovementDirections=function(){n();return wade.cloneArray(l)};this.getTileScaleFactor=function(){n();return b};this.setTileHeight=function(a,b,c){h.setTileHeight(a,b,c||0)};this.getTileHeight=function(a,b){return h.getTileHeight(a,b)};this.getNumTiles=function(){return h?{x:h.numTilesX,
z:h.numTilesZ}:{x:0,z:0}};this.getTileSprite=function(a,b){return h&&h.tileSprites[a]&&h.tileSprites[a][b]};this.getTileData=function(a,b){return h&&h.getTileData(a,b)};this.getTransitionSprite=function(a,b){return h&&h.transitionSprites[a]&&h.transitionSprites[a][b]};this.getTransitionData=function(a,b){return h&&h.getTransitionData(a,b)};this.getDetailSprite=function(a,b){return h&&h.detailSprites[a]&&h.detailSprites[a][b]};this.getDetailData=function(a,b){return h&&h.getDetailData(a,b)};this.getTerrainLayerId=
function(){return c};this.getTerrain=function(){n();return i};this.getObjectsLayerId=function(){return d};this.checkCollisionsAtTile=function(a,b){return!(!this.collisionMap||!this.collisionMap[a]||!this.collisionMap[a][b])};this.clearCollisions=function(a,b){var c=this.getNumTiles();if("undefined"==typeof a)for(var d=0;d<c.x;d++)for(var e=0;e<c.z;e++)this.collisionMap[d]&&(this.collisionMap[d][e]=null);else this.collisionMap[a]&&(this.collisionMap[a][b]=null)};this.setCollisionAtTile=function(a,
b,c){this.collisionMap[a]||(this.collisionMap[a]=[]);this.collisionMap[a][b]=c};this.setNumTiles=function(a,b){n();a&&b&&!wade.getSceneObject("iso_terrain")?wade.addSceneObject(i,!0):!a&&(!b&&wade.getSceneObject("iso_terrain"))&&wade.removeSceneObject(i);h.setNumTiles(a,b)};this.createObject=function(a,b,c){n();var a=a||{},c=c?wade.cloneObject(c):{},b=b||{x:0,z:0},e=h.getFlatWorldCoordinates(b.x,b.z);if(a.properties&&Object.keys(a.properties).length){var f={};wade.extend(!0,f,a.properties,c);c=f}var g,
i,j;if(!a.gridMap)if(a.gridSize){a.gridMap=[];for(f=0;f<a.gridSize.x;f++)for(g=0;g<a.gridSize.z;g++)a.gridMap.push({x:f,z:g})}else a.gridMap=[{x:0,z:0}];if(!a.collisionMap&&a.collisionSize){a.collisionMap=[];for(f=0;f<a.collisionSize.x;f++)for(g=0;g<a.collisionSize.z;g++)a.collisionMap.push({x:f,z:g})}g=a.gridMap;var k=a.collisionMap;if(k)for(f=0;f<k.length;f++)if(i=k[f].x+b.x,j=k[f].z+b.z,this.collisionMap[i]){if(this.collisionMap[i][j])return null}else this.collisionMap[i]=[];i=[];j=[];if(a.sprites){k=
wade.isArray(a.sprites)?a.sprites:[a.sprites];for(f=0;f<k.length;f++){var l=k[f];l.layer=d;l.sortPoint||(l.sortPoint={x:0,y:0.5});var r="TextSprite"==l.type?new TextSprite(l):new Sprite(l);i.push(r);r.baseOffset=l.offset||{x:0,y:0};j.push({x:r.baseOffset.x,y:r.baseOffset.y-this.getTileHeight(b.x,b.z)})}}var s=a.behaviors;if(s){wade.isArray(s)||(s=[s]);for(var v=0;v<s.length;v++)"string"==typeof s[v]&&("function"==typeof window[s[v]]?s[v]=window[s[v]]:function(a){s[v]=function(){this.name=a}}(s[v]))}var t=
new SceneObject(i,s,e.x,e.y,c.name);t.setSpriteOffsets(j);t.iso={objectData:a,gridCoords:{x:b.x,z:b.z}};var B=c.flowChart;delete c.flowChart;wade.extend(t,c);delete t.name;t.functions&&(e=t.functions,delete t.functions,t.importFunctions(e));!a.dontAddToScene&&!c.dontAddToScene&&wade.addSceneObject(t,!0);this.gameObjects.push(t);for(f=0;f<g.length;f++)i=g[f].x+b.x,j=g[f].z+b.z,this.gridObjects[i]||(this.gridObjects[i]=[]),this.gridObjects[i][j]||(this.gridObjects[i][j]=[]),this.gridObjects[i][j].push(t);
if(a.collisionMap)for(f=0;f<a.collisionMap.length;f++)i=a.collisionMap[f].x+b.x,j=a.collisionMap[f].z+b.z,this.collisionMap[i]||(this.collisionMap[i]=[]),this.collisionMap[i][j]=t;B&&wade.setTimeout(function(){t.isInScene()&&wade.runFlowChart(B,null,!0,0,t)},0);return t};this.deleteObject=function(a){n();wade.removeObjectFromArray(a,this.gameObjects);var b,c,d,e=a.iso.objectData.collisionMap;if(e)for(b=0;b<e.length;b++)c=e[b].x+a.iso.gridCoords.x,d=e[b].z+a.iso.gridCoords.z,this.collisionMap[c]&&
this.collisionMap[c][d]&&(this.collisionMap[c][d]=0);e=(e=a.iso.objectData.gridMap)||[{x:0,z:0}];for(b=0;b<e.length;b++)c=e[b].x+a.iso.gridCoords.x,d=e[b].z+a.iso.gridCoords.z,this.gridObjects[c]&&this.gridObjects[c][d]&&wade.removeObjectFromArray(a,this.gridObjects[c][d]);wade.removeSceneObject(a)};this.reset=function(){g?(f.length=0,e={},this.setNumTiles(0,0),this.gameObjects.length=this.gridObjects.length=this.collisionMap.length=0):n()};this.deleteObjectByName=function(a){(a=g&&wade.getSceneObject(a))&&
this.deleteObject(a)};this.deleteObjectsInTile=function(a,b){if(!g||!this.gridObjects[a])return!1;var c=this.gridObjects[a][b];if(!c)return!1;if(c.length){for(var d=c.length-1;0<=d;d--)this.deleteObject(c[d]);return!0}return!1};this.constrainCamera=function(a){n();"undefined"==typeof a&&(a=!0);a?wade.setMainLoop(function(){var a=wade.getScreenWidth()/2,b=wade.getScreenHeight()/2,a={minX:-a,minY:-b,maxX:a,maxY:b},b=wade.getLayer(c).screenBoxToWorld(a),a=(b.maxX-b.minX)/2,b=(b.maxY-b.minY)/2,d,e,f,
g;d={x:0,y:0};e=h.getWorldCoordinates(0,h.numTilesZ-1);e.x-=h.c_tileSize.x/2;f=h.getWorldCoordinates(h.numTilesX-1,0);f.x+=h.c_tileSize.x/2;g=h.getWorldCoordinates(h.numTilesX-1,h.numTilesZ-1);g.y-=h.c_tileSize.y/2;var i=function(a,b){var c={};c.start=a;c.end=b;c.slope=(b.y-a.y)/(b.x-a.x);c.intercept=c.start.y-c.start.x*c.slope;c.getX=function(a){return(a-this.intercept)/this.slope};return c},j;j=i(d,f);d=i(d,e);f=i(g,f);e=i(g,e);i=wade.getCameraPosition();i.y+b>-a/2?i.y=-a/2-b:i.y-b<g.y+a/2&&(i.y=
g.y+a/2+b);i.x-=Math.max(0,i.x+a-Math.min(j.getX(i.y+b),f.getX(i.y-b)));i.x+=Math.max(0,Math.max(d.getX(i.y+b),e.getX(i.y-b))-(i.x-a));wade.setCameraPosition(i)},"_wade_isoConstrainCamera"):wade.setMainLoop(null,"_wade_isoConstrainCamera")};this.spawnObjectNearObject=function(a,b,c,d,e,f,g){n();var a="string"==typeof a?wade.getSceneObject(a).gridCoords:a.gridCoords,h;"undefined"==typeof d&&(d=-1);"undefined"==typeof e&&(e=-1);"undefined"==typeof f&&(f=1);for("undefined"==typeof g&&(g=1);d<=f;d++)for(var i=
e;i<=g;i++)if(!this.collisionMap[a.x+d]||!this.collisionMap[a.x+d][a.z+i])h={x:a.x+d,z:a.z+i};return h?this.createObject(b,h,c):null};this.swapObjects=function(a,b){n();var c,d,e,f=a.iso.objectData.gridMap||[{x:0,z:0}],g=b.iso.objectData.gridMap||[{x:0,z:0}],i=a.iso.objectData.collisionMap,j=b.iso.objectData.collisionMap,k=a.iso.gridCoords,l=b.iso.gridCoords;if(i)for(c=0;c<i.length;c++)d=i[c].x+k.x,e=i[c].z+k.z,this.collisionMap[d][e]=0;for(c=0;c<f.length;c++)d=f[c].x+k.x,e=f[c].z+k.z,wade.removeObjectFromArray(a,
this.gridObjects[d][e]);if(j)for(c=0;c<j.length;c++)d=j[c].x+l.x,e=j[c].z+l.z,this.collisionMap[d][e]=0;for(c=0;c<g.length;c++)d=g[c].x+l.x,e=g[c].z+l.z,wade.removeObjectFromArray(b,this.gridObjects[d][e]);c=k;k=l;l=c;a.iso.gridCoords=k;b.iso.gridCoords=l;if(i)for(c=0;c<i.length;c++)d=i[c].x+k.x,e=i[c].z+k.z,this.collisionMap[d]||(this.collisionMap[d]=[]),this.collisionMap[d][e]=a;for(c=0;c<f.length;c++)d=f[c].x+k.x,e=f[c].z+k.z,this.gridObjects[d]||(this.gridObjects[d]=[]),this.gridObjects[d][e]||
(this.gridObjects[d][e]=[]),this.gridObjects[d][e].push(a);if(j)for(c=0;c<j.length;c++)d=j[c].x+l.x,e=j[c].z+l.z,this.collisionMap[d]||(this.collisionMap[d]=[]),this.collisionMap[d][e]=b;for(c=0;c<f.length;c++)d=f[c].x+k.x,e=f[c].z+k.z,this.gridObjects[d]||(this.gridObjects[d]=[]),this.gridObjects[d][e]||(this.gridObjects[d][e]=[]),this.gridObjects[d][e].push(b);a.setPosition(h.getFlatWorldCoordinates(k.x,k.z));b.setPosition(h.getFlatWorldCoordinates(l.x,l.z));f=this.getTileHeight(k.x,k.z);l=this.getTileHeight(l.x,
l.z);for(c=0;c<a.getSpriteCount();c++)a.setSpriteOffset(c,a.getSprite(c).baseOffset-f);for(c=0;c<b.getSpriteCount();c++)b.setHeightOffset(c,b.getSprite(c).baseOffset-l)};this.findPath=function(a,b,c,d,e){n();a={start:{x:a.x,y:a.z},target:{x:b.x,y:b.z},collisionMap:this.collisionMap,movementOffsets:c||k,boundaries:{minX:0,minY:0,maxX:h.numTilesX-1,maxY:h.numTilesZ-1},heightMap:h.getHeightMap(),maxStepHeight:d,maxPathLength:e};a=wade.findPath(a);for(b=0;b<a.length;b++)a[b].z=a[b].y;return a};this.moveObjectToTile=
function(b,c,d,e){n();if("string"==typeof b&&(b=wade.getSceneObject(b),!b))return!1;if(!e)return a.updateObjectTile(b,c,d)?(b.setPosition(h.getFlatWorldCoordinates(c,d)),b.iso.targetCoords=0,wade.removeObjectFromArray(b,f),!0):!1;if(b.iso.gridCoords.x==c&&b.iso.gridCoords.z==d)return!0;b.iso.targetCoords={x:c,z:d};b.iso.previousPosition=b.getPosition();f.push(b);c=h.getFlatWorldCoordinates(c,d);b.moveTo(c.x,c.y,e);return!0};this.setTile=function(a,b,c,d){n();return h.setTile(a,b,c,d)};this.setTransition=
function(a,b,c){n();h.setTransition(a,b,c)};this.setDetail=function(a,b,c){n();h.setDetail(a,b,c)};this.getWorldCoordinates=function(a,b){n();return h.getWorldCoordinates(a,b)};this.getFlatWorldCoordinates=function(a,b){n();return h.getFlatWorldCoordinates(a,b)};this.getTileCoordinates=function(a,b){n();return h.getTileCoordinates(a,b)};this.getFlatTileCoordinates=function(a,b){n();return h.getFlatTileCoordinates(a,b)};this.getTileTexture=function(a,b){return g&&h.getTileTexture(a,b)};this.setHighlight=
function(a,b){n();h.setHighlight(a,b)};this.getHighlightObjects=function(){return g?h.getHighlightObjects():[]};this.getObjectsInTile=function(a,b){n();var c=this.gridObjects[a]&&this.gridObjects[a][b];return c&&wade.cloneArray(c)||[]};this.sortTerrainTiles=function(){n();h.sort()};this.drawGrid=function(a){n();"undefined"==typeof a&&(a=!0);h.drawGrid(a)};this.draw_=function(a,b){b=b||"blue";return function(c){var d=this._position,e=this._size.x/2,f=this._size.y/2,g=c.strokeStyle,h=c.fillStyle;a&&
(c.strokeStyle=a);c.fillStyle=b;c.beginPath();c.moveTo(d.x-e,d.y);c.lineTo(d.x,d.y+f);c.lineTo(d.x+e,d.y);c.lineTo(d.x,d.y-f);g&&c.stroke();h&&c.fill();c.strokeStyle=g;c.fillStyle=h}};this.exportMap=function(a){n();for(var b={version:"1.1",terrain:{numTilesX:h.numTilesX,numTilesZ:h.numTilesZ,tileData:[],tileDataIds:[],transitionData:[],transitionDataIds:[],detailData:[],detailDataIds:[],tileHeight:[]},gameObjectData:[],gameObjects:[]},c=0;c<h.numTilesX;c++){b.terrain.tileDataIds[c]=[];b.terrain.transitionDataIds[c]=
[];b.terrain.tileHeight[c]=[];for(var d=0;d<h.numTilesZ;d++){if(h.tileData[c]&&h.tileData[c][d]){var e=h.tileData[c][d],f=b.terrain.tileData.indexOf(e);-1==f&&(f=b.terrain.tileData.push(e)-1);b.terrain.tileDataIds[c][d]=f;b.terrain.tileHeight[c][d]=h.tileHeight[c]&&h.tileHeight[c][d]||0}else b.terrain.tileDataIds[c][d]=-1;h.transitionData[c]&&h.transitionData[c][d]?(e=h.transitionData[c][d],f=b.terrain.transitionData.indexOf(e),-1==f&&(f=b.terrain.transitionData.push(e)-1),b.terrain.transitionDataIds[c][d]=
f):b.terrain.transitionDataIds[c][d]=-1}}for(c=0;c<h.numTilesX;c++){b.terrain.detailDataIds[c]=[];for(d=0;d<h.numTilesZ;d++)h.detailData[c]&&h.detailData[c][d]?(e=h.detailData[c][d],f=b.terrain.detailData.indexOf(e),-1==f&&(f=b.terrain.detailData.push(e)-1),b.terrain.detailDataIds[c][d]=f):b.terrain.detailDataIds[c][d]=-1}e=this.gameObjects;for(c=0;c<e.length;c++)if(e[c].iso&&e[c].iso.objectData&&e[c].iso.gridCoords){var g=e[c].iso.objectData,f=b.gameObjectData.indexOf(g);-1==f&&(f=b.gameObjectData.push(g)-
1);var f={templateId:f,gridCoords:{x:e[c].iso.gridCoords.x||0,z:e[c].iso.gridCoords.z||0}},i=e[c].serialize(!1,["iso"]);f.instanceData=i.properties||{};f.instanceData.name=e[c].getName();g.behaviors=[];for(d=0;d<i.behaviors.length;d++)g.behaviors.push(i.behaviors[d].name);b.gameObjects.push(f)}if(a)try{b=JSON.stringify(b)}catch(j){wade.log("Unable to convert map data to a string. It may contain circular references.")}return b};this.updateObjectTile=function(b,c,d){n();if(b.iso.gridCoords.x==c&&b.iso.gridCoords.z==
d)return!0;var e,f,g,h=b.iso.objectData.gridMap||[{x:0,z:0}],i=b.iso.objectData.collisionMap;if(i)for(e=0;e<i.length;e++)if(f=i[e].x+c,g=i[e].z+d,a.collisionMap[f]&&a.collisionMap[f][g]&&a.collisionMap[f][g]!=b)return!1;for(e=0;e<h.length;e++)f=h[e].x+b.iso.gridCoords.x,g=h[e].z+b.iso.gridCoords.z,wade.removeObjectFromArray(b,a.gridObjects[f][g]);if(i)for(e=0;e<i.length;e++)f=i[e].x+b.iso.gridCoords.x,g=i[e].z+b.iso.gridCoords.z,a.collisionMap[f]&&a.collisionMap[f][g]&&(a.collisionMap[f][g]=0);for(e=
0;e<h.length;e++)f=h[e].x+c,g=h[e].z+d,a.gridObjects[f]||(a.gridObjects[f]=[]),a.gridObjects[f][g]||(a.gridObjects[f][g]=[]),a.gridObjects[f][g].push(b);if(i)for(e=0;e<i.length;e++)f=i[e].x+c,g=i[e].z+d,a.collisionMap[f]||(a.collisionMap[f]=[]),a.collisionMap[f][g]=b;if(b.iso.gridCoords.x!=c||b.iso.gridCoords.z!=d)var j={x:b.iso.gridCoords.x,z:b.iso.gridCoords.z};b.iso.gridCoords.x=c;b.iso.gridCoords.z=d;for(e=0;e<b.getSpriteCount();e++)f=b.getSprite(e).baseOffset,b.setSpriteOffset(e,{x:f.x,y:f.y-
a.getTileHeight(c,d)});j&&b.process("onIsoTileChange",{previousTile:j,currentTile:{x:c,z:d}});return!0};var r=function(a,b){return function(){e[a]=1;e.terrain&&e.objects&&b&&b()}},t=function(a){switch(a){case "straight":return[{x:-1,z:-1},{x:-1,z:1},{x:1,z:-1},{x:1,z:1}];case "diagonal":return[{x:0,z:-1},{x:0,z:1},{x:-1,z:0},{x:1,z:0}];case "both":return[{x:-1,z:-1},{x:-1,z:1},{x:1,z:-1},{x:1,z:1},{x:0,z:-1},{x:0,z:1},{x:-1,z:0},{x:1,z:0}]}return[]},v=function(b,c){var d,e,f,g,h=[],j={},k=0;if(b.gameObjects){for(d=
0;d<b.gameObjectData.length;d++){for(e=0;e<b.gameObjectData[d].sprites.length;e++){var l=b.gameObjectData[d].sprites[e].image;l&&!j[l]&&(h.push(l),j[l]=1);if(b.gameObjectData[d].sprites[e].animations)for(f=0;f<b.gameObjectData[d].sprites[e].animations.length;f++)l=b.gameObjectData[d].sprites[e].animations[f].image,j[l]||(h.push(l),j[l]=1)}if(e=b.gameObjectData[d].portraits)for(g in e)e.hasOwnProperty(g)&&!j[e[g]]&&(h.push(e[g]),j[e[g]]=1)}if(h.length)for(d=0;d<h.length;d++)wade.loadImage(h[d],function(){if(++k==
h.length){if(b.gameObjects){i.getBehavior("TerrainBehavior");for(var d=0;d<b.gameObjects.length;d++)a.createObject(b.gameObjectData[b.gameObjects[d].templateId],b.gameObjects[d].gridCoords,b.gameObjects[d].instanceData)}r("objects",c)()}});else r("objects",c)()}else r("objects",c)()}};wade.iso=new Wade_iso;
...
!0,c&&c()}};this.loadData_end=function(a){var c,d;this.numTilesX=a.terrain.numTilesX;this.numTilesZ=a.terrain.numTilesZ;for(c=0;c<this.numTilesX;c++){this.tileSprites[c]=[];this.tileData[c]=[];this.transitionSprites[c]=[];this.transitionData[c]=[];for(d=0;d<this.numTilesZ;d++){this.setTile(c,d,a.terrain.tileData[a.terrain.tileDataIds[c][d]],a.terrain.tileHeight&&a.terrain.tileHeight[c]&&a.terrain.tileHeight[c][d]||0);var e=a.terrain.transitionData[a.terrain.transitionDataIds[c][d]];e&&this.setTransition(c,
d,e)}}for(c=0;c<this.numTilesX;c++){this.detailSprites[c]=[];this.detailData[c]=[];for(d=0;d<this.numTilesZ;d++)(e=a.terrain.detailData[a.terrain.detailDataIds[c][d]])&&this.setDetail(c,d,e)}};this.setNumTiles=function(b,c){var d,e;if(a){var f=!0;this.drawGrid(!1)}for(d=b;d<this.numTilesX;d++)for(e=0;e<this.numTilesZ;e++)this.setTile(d,e,0),this.setTransition(d,e,0);for(e=c;e<this.numTilesZ;e++)for(d=0;d<this.numTilesX;d++)this.setTile(d,e,0),this.setTransition(d,e,0);for(d=b;d<this.numTilesX;d++)for(e=
0;e<this.numTilesZ;e++)this.setDetail(d,e,0);for(e=c;e<this.numTilesZ;e++)for(d=0;d<this.numTilesX;d++)this.setDetail(d,e,0);this.tileData.length=this.transitionData.length=this.detailData.length=this.tileSprites.length=this.transitionSprites.length=this.detailSprites.length=this.gridSprites.length=this.tileHeight.length=b;for(d=0;d<b;d++)this.tileData[d]&&(this.tileData[d].length=c),this.transitionData[d]&&(this.transitionData[d].length=c),this.detailData[d]&&(this.detailData[d].length=c),this.tileSprites[d]&&
(this.tileSprites[d].length=c),this.transitionSprites[d]&&(this.transitionSprites[d].length=c),this.detailSprites[d]&&(this.detailSprites[d].length=c),this.gridSprites[d]&&(this.gridSprites[d].length=c),this.tileHeight[d]&&(this.tileHeight[d].length=c);var g={texture:"_wade_isoDefault"};for(d=this.numTilesX;d<b;d++){this.tileSprites[d]=[];this.tileData[d]=[];this.transitionSprites[d]=[];this.transitionData[d]=[];for(e=0;e<c;e++)this.setTile(d,e,g)}for(e=this.numTilesZ;e<c;e++)for(d=0;d<this.numTilesX;d++)this.setTile(d,
e,g);for(d=this.numTilesX;d<b;d++)this.detailSprites[d]=[],this.detailData[d]=[];this.numTilesX=b;this.numTilesZ=c;f&&this.drawGrid(!0)};this.setTile=function(a,c,d,e){var f=wade.iso.collisionMap;if(!d||d.collision){if(f[a]&&f[a][c]&&!f[a][c].isTerrainTile)return!1;f[a]||(f[a]=[]);f[a][c]={isTerrainTile:!0,tileData:d}}else f[a]&&(f[a][c]&&f[a][c].isTerrainTile)&&(f[a][c]=0);this.tileSprites[a]||(this.tileSprites[a]=[]);this.tileData[a]||(this.tileData[a]=[]);this.tileHeight[a]||(this.tileHeight[a]=
[]);if(d){e=e||0;this.tileHeight[a][c]=e;var g,i,h,j,k,l;g=!0;if(f=d.texture)k=wade.getImage(f),j=k.width,k=k.height;d.rotation&&(f+="_iso_rot_"+d.rotation,"ok"!=wade.getLoadingStatus(f)&&(h=new Sprite(d.texture),h.setRotation(d.rotation*Math.PI/2),h.drawToImage(f,!0)));l=d.scale||1;h=this.c_tileSize.x*wade.iso.getTileScaleFactor()*l;var n=i=this.c_tileSize.y*wade.iso.getTileScaleFactor()*l,r={x:this.c_origin.x+(a-c)*this.c_tileSize.x/2,y:this.c_origin.y-(a+c)*this.c_tileSize.y/2};this.tileSprites[a][c]&&
(l=this.tileSprites[a][c],d.animation||this.tileData[a][c].animation?(this.owner.removeSprite(l),this.tileSprites[a][c]=0):(l.setImageFile(f),d.imageArea?(l.setImageArea(d.imageArea.minX,d.imageArea.minY,d.imageArea.maxX,d.imageArea.maxY),d.customHeight&&(g=d.imageArea.maxX-d.imageArea.minX,i=d.imageArea.maxY-d.imageArea.minY,i=this.c_tileSize.x*wade.iso.getTileScaleFactor()*i/g)):d.customHeight&&(j&&k)&&(i=this.c_tileSize.x*wade.iso.getScaleFactor()*k/j),l.setSize(h,i),r.y+=(i-n)/2-e,this.owner.setSpriteOffset(this.owner.getSpriteIndex(l),
r),g=!1));g&&(d.animation?(l=new Sprite(0,wade.iso.getTerrainLayerId()),f=new Animation(f,d.animation.numFrames.x,d.animation.numFrames.y,d.animation.speed,!0),l.addAnimation("default",f),l.playAnimation("default")):l=new Sprite(f,wade.iso.getTerrainLayerId()),l.customSortOrder=0,l.customSortIndex=a+c,l.gridCoords={x:a,z:c},d.imageArea?(l.setImageArea(d.imageArea.minX,d.imageArea.minY,d.imageArea.maxX,d.imageArea.maxY),d.customHeight&&(g=d.imageArea.maxX-d.imageArea.minX,i=d.imageArea.maxY-d.imageArea.minY,
i=this.c_tileSize.x*wade.iso.getTileScaleFactor()*i/g)):d.customHeight&&(j&&k)&&(i=this.c_tileSize.x*wade.iso.getScaleFactor()*k/j),l.setSize(h,i),r.y+=(i-n)/2-e,this.tileSprites[a][c]=l,this.owner.addSprite(l,r));j={x:this.c_origin.x+(a-c)*this.c_tileSize.x/2,y:this.c_origin.y-(a+c)*this.c_tileSize.y/2-e};this.transitionSprites[a]&&this.transitionSprites[a][c]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.transitionSprites[a][c]),j);this.detailSprites[a]&&this.detailSprites[a][c]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.detailSprites[a][c]),
j);j=wade.iso.getObjectsInTile(a,c);for(k=0;k<j.length;k++)for(f=0;f<j[k].getSpriteCount();f++)h=j[k].getSprite(f).baseOffset,j[k].setSpriteOffset(f,{x:h.x,y:h.y-e});this.gridSprites[a]&&this.gridSprites[a][c]&&this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.gridSprites[a][c]),this.getWorldCoordinates(a,c))}else this.tileSprites[a]&&this.tileSprites[a][c]&&this.owner.removeSprite(this.tileSprites[a][c]),this.tileSprites[a][c]=0,this.transitionSprites[a]&&this.transitionSprites[a][c]&&this.setTransition(a,
c,null),this.detailSprites[a]&&this.detailSprites[a][c]&&this.setDetail(a,c,null),this.tileHeight[a]&&this.tileHeight[a][c]&&(this.tileHeight[a][c]=0);this.tileData[a][c]=d;return!0};this.setTransition=function(a,c,d){this.transitionSprites[a]||(this.transitionSprites[a]=[]);this.transitionData[a]||(this.transitionData[a]=[]);if(d){var e=!0,f=d.texture;if(d.rotation&&(f+="_iso_rot_"+d.rotation,"ok"!=wade.getLoadingStatus(f))){var g=new Sprite(d.texture);g.setRotation(d.rotation*Math.PI/2);g.drawToImage(f,
!0)}this.transitionSprites[a][c]&&(d.animation||this.transitionData[a][c].animation?(this.owner.removeSprite(this.transitionSprites[a][c]),this.transitionSprites[a][c]=0):(this.transitionSprites[a][c].setImageFile(f),d.imageArea&&this.transitionSprites[a][c].setImageArea(d.imageArea.minX,d.imageArea.minY,d.imageArea.maxX,d.imageArea.maxY),e=!1));g={x:this.c_origin.x+(a-c)*this.c_tileSize.x/2,y:this.c_origin.y-(a+c)*this.c_tileSize.y/2-this.getTileHeight(a,c)};if(e){var i=d.scale||1,e=this.c_tileSize.x*
wade.iso.getTileScaleFactor()*i,i=this.c_tileSize.y*wade.iso.getTileScaleFactor()*i;if(d.animation){var f=new Sprite(0,wade.iso.getTerrainLayerId()),h=new Animation(d.texture,d.animation.numFrames.x,d.animation.numFrames.y,d.animation.speed,!0);f.addAnimation("default",h);f.playAnimation("default")}else f=new Sprite(f,wade.iso.getTerrainLayerId());f.setPosition(g);f.setSize(e*wade.iso.getTileScaleFactor(),i*wade.iso.getTileScaleFactor());f.customSortOrder=1;f.customSortIndex=a+c;d.imageArea&&f.setImageArea(d.imageArea.minX,
d.imageArea.minY,d.imageArea.maxX,d.imageArea.maxY);this.owner.addSprite(f);this.transitionSprites[a][c]=f}this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.transitionSprites[a][c]),g)}else this.transitionSprites[a][c]&&this.owner.removeSprite(this.transitionSprites[a][c]),this.transitionSprites[a][c]=0;this.transitionData[a][c]=d};this.setDetail=function(a,c,d){this.detailSprites[a]||(this.detailSprites[a]=[]);this.detailData[a]||(this.detailData[a]=[]);if(d){var e=!0,f=d.texture;if(d.rotation&&
(f+="_iso_rot_"+d.rotation,"ok"!=wade.getLoadingStatus(f))){var g=new Sprite(d.texture);g.setRotation(d.rotation*Math.PI/2);g.drawToImage(f,!0)}this.detailSprites[a][c]&&(d.animation||this.detailData[a][c].animation?(this.owner.removeSprite(this.transitionSprites[a][c]),this.transitionSprites[a][c]=0):(this.detailSprites[a][c].setImageFile(f),d.imageArea&&this.detailSprites[a][c].setImageArea(d.imageArea.minX,d.imageArea.minY,d.imageArea.maxX,d.imageArea.maxY),e=!1));g={x:this.c_origin.x+(a-c)*this.c_tileSize.x/
2,y:this.c_origin.y-(a+c)*this.c_tileSize.y/2-this.getTileHeight(a,c)};if(e){var e=d.scale||1,i=this.c_tileSize.x*wade.iso.getTileScaleFactor()*e,h=this.c_tileSize.y*wade.iso.getTileScaleFactor()*e;if(d.animation){var f=new Sprite(0,wade.iso.getTerrainLayerId()),j=new Animation(d.texture,d.animation.numFrames.x,d.animation.numFrames.y,d.animation.speed,!0);f.addAnimation("default",j);f.playAnimation("default")}else f=new Sprite(f,wade.iso.getTerrainLayerId());f.setSize(i*wade.iso.getTileScaleFactor()*
e,h*wade.iso.getTileScaleFactor()*e);f.customSortOrder=2;f.customSortIndex=a+c;d.imageArea&&f.setImageArea(d.imageArea.minX,d.imageArea.minY,d.imageArea.maxX,d.imageArea.maxY);this.owner.addSprite(f);this.detailSprites[a][c]=f}this.owner.setSpriteOffset(this.owner.getSpriteIndex(this.detailSprites[a][c]),g)}else this.detailSprites[a][c]&&this.owner.removeSprite(this.detailSprites[a][c]),this.detailSprites[a][c]=0;this.detailData[a][c]=d};this.getWorldCoordinates=function(a,c){return{x:(a-c)*this.c_tileSize.x/
2,y:-(a+c+1)*this.c_tileSize.y/2-(this.tileHeight[a]&&this.tileHeight[a][c]||0)}};this.getFlatWorldCoordinates=function(a,c){return{x:(a-c)*this.c_tileSize.x/2,y:-(a+c+1)*this.c_tileSize.y/2}};this.getTileCoordinates=function(a,c){for(var d=wade.getSpritesInArea({minX:a,minY:c,maxX:a,maxY:c},wade.iso.getTerrainLayerId(),!0),e=this.c_tileSize.y*wade.iso.getTileScaleFactor(),f=this.c_tileSize.x*wade.iso.getTileScaleFactor()/2,g=e/2,i=f*g,h=0;h<d.length;h++){var j=d[h];if(j.gridCoords){var k=this.tileData[j.gridCoords.x][j.gridCoords.z],
l=j.getPosition(),l=wade.vec2.sub({x:a,y:c},l);if(k&&k.customHeight){var k=k.scale||1,n=j.getSize();if(l.y+n.y/2>e*k)continue;l.y+=(n.y-e)/2}if(Math.abs(l.x)*g+Math.abs(l.y)*f<=i)return{x:j.gridCoords.x,z:j.gridCoords.z,valid:!0}}}d=a/this.c_tileSize.x-c/this.c_tileSize.y;e=-(a/this.c_tileSize.x+c/this.c_tileSize.y);d=Math.floor(d);e=Math.floor(e);return{x:d,z:e,valid:0<=d&&0<=e&&d<this.numTilesX&&e<this.numTilesZ}};this.getFlatTileCoordinates=function(a,c){var d=a/this.c_tileSize.x-c/this.c_tileSize.y,
e=-(a/this.c_tileSize.x+c/this.c_tileSize.y),d=Math.floor(d),e=Math.floor(e);return{x:d,z:e,valid:0<=d&&0<=e&&d<this.numTilesX&&e<this.numTilesZ}};this.onMouseDown=function(a){if(wade.app.onIsoTerrainMouseDown){var c=this.getTileCoordinates(a.position.x,a.position.y);if(c.valid){var d=this.getWorldCoordinates(c.x,c.z);return wade.app.onIsoTerrainMouseDown(wade.extend({gridCoords:c,worldCoords:d},a))}}return!1};this.onClick=function(a){if(wade.app.onIsoTerrainClick){var c=this.getTileCoordinates(a.position.x,
a.position.y);if(c.valid){var d=this.getWorldCoordinates(c.x,c.z);return wade.app.onIsoTerrainClick(wade.extend({gridCoords:c,worldCoords:d},a))}}return!1};this.onMouseUp=function(a){if(wade.app.onIsoTerrainMouseUp){var c=this.getTileCoordinates(a.position.x,a.position.y);if(c.valid){var d=this.getWorldCoordinates(c.x,c.z);return wade.app.onIsoTerrainMouseUp(wade.extend({gridCoords:c,worldCoords:d},a))}}return!1};this.setHighlight=function(a,c){var d;this.highlightOffsets=c||[{x:0,z:0}];if(a instanceof
...
0;d<this.tileHighlightObjects.length;d++)this.getTileHighlightObject(d).getSprite(0).setImageFile(a);else if(this.highlightSprite)for(d=0;d<this.tileHighlightObjects.length;d++)this.getTileHighlightObject(d);else this.hideTileHighlightObjects()};this.onMouseMove=function(a){var c,d;c=this.getTileCoordinates(a.position.x,a.position.y);if(c.valid&&(this.highlightTexture||this.highlightSprite)&&this.highlightOffsets&&this.highlightOffsets.length)for(var e=0;e<this.highlightOffsets.length;e++){var f=
this.highlightOffsets[e];d=this.getWorldCoordinates(c.x+f.x,c.z+f.z);var g=this.getTileHighlightObject(e);g.setPosition(d);g.setVisible(!0);g.iso.gridCoords.x=c.x+f.x;g.iso.gridCoords.z=c.z+f.z}else this.hideTileHighlightObjects();wade.app.onIsoTerrainMouseMove&&wade.app.onIsoTerrainMouseMove(wade.extend({},a,{gridCoords:c}))};this.sort=function(){wade.getLayer(wade.iso.getTerrainLayerId()).sort(this.sortingFunction)};this.drawGrid=function(b){var c,d=wade.iso.getTerrainLayerId();if(b&&!a){for(b=
0;b<this.numTilesX;b++){this.gridSprites[b]=[];for(c=0;c<this.numTilesZ;c++){var e=new Sprite("_wade_isoGrid",d);e.customSortOrder=3;e.customSortIndex=b+c;var f={x:this.c_origin.x+(b-c)*this.c_tileSize.x/2,y:this.c_origin.y-(b+c)*this.c_tileSize.y/2-(this.tileHeight[b]&&this.tileHeight[b][c]||0)};e.setSize(this.c_tileSize.x*wade.iso.getTileScaleFactor(),this.c_tileSize.y*wade.iso.getTileScaleFactor());this.owner.addSprite(e,f);this.gridSprites[b][c]=e}}a=!0}else if(!b&&a){for(b=0;b<this.numTilesX;b++)for(c=
0;c<this.numTilesZ;c++)this.owner.removeSprite(this.gridSprites[b][c]);this.gridSprites.length=0;a=!1}};this.getTileTexture=function(a,c){return this.tileSprites[a]&&this.tileSprites[a][c]&&this.tileSprites[a][c].getImageName()};this.getTileData=function(a,c){return this.tileData[a]&&this.tileData[a][c]&&wade.cloneObject(this.tileData[a][c])};this.getTransitionData=function(a,c){return this.transitionData[a]&&this.transitionData[a][c]&&wade.cloneObject(this.transitionData[a][c])};this.getDetailData=
function(a,c){return this.detailData[a]&&this.detailData[a][c]&&wade.cloneObject(this.detailData[a][c])};this.setTileHeight=function(a,c,d){this.setTile(a,c,this.tileData[a]&&this.tileData[a][c],d)};this.getTileHeight=function(a,c){return this.tileHeight[a]&&this.tileHeight[a][c]||0};this.getHeightMap=function(){return this.tileHeight}}
function IsoCharacter(){var a=this,b=[],c,d="forward",e,f;this.name="IsoCharacter";this.movementSpeed=160;this.maxStepHeight=20;this.variationProbability=0.1;this.setDestination=function(a){var b=this.owner.getPosition(),c=wade.iso.getFlatTileCoordinates(b.x,b.y),d=this.getNextDestination();if(d){var e=d.x-c.x;e&&(e/=Math.abs(e));var n=d.z-c.z;n&&(n/=Math.abs(n));c.x+=e;c.z+=n}e=wade.iso.findPath(c,a,f,this.maxStepHeight);if(e.length){n=wade.iso.getFlatWorldCoordinates(c.x,c.z);this.clearDestinations();
if(Math.abs(b.x-n.x)>wade.c_epsilon||Math.abs(b.y-n.z)>wade.c_epsilon){if(d.x==a.x&&d.z==a.z)return!1;g(c);this._goToNextDestination()}if(c.x==a.x&&c.z==a.z)return!1;for(b=1;b<e.length-1;b++)c=e[b].z-e[b-1].z,d=e[b+1].z-e[b].z,(e[b].x-e[b-1].x!=e[b+1].x-e[b].x||c!=d)&&g(e[b]);g(a);return!0}return!1};this.clearDestinations=function(){b.length=0};this.setMovementType=function(a){f=a};this.getNextDestination=function(){return this._nextDestination};this.setDirection=function(a){this.owner.isMoving()||
this.owner.playAnimation("Idle_iso_"+a)};this.goToObject=function(a){if("string"==typeof a&&(a=wade.getSceneObject(a),!a))return;var b=this.owner.iso.gridCoords,c=[],d=a.iso.objectData.interactionOffset;d&&c.push({x:a.iso.gridCoords.x+d.x,z:a.iso.gridCoords.z+d.z,object:a});c.push({x:a.iso.gridCoords.x,z:a.iso.gridCoords.z,object:a});for(var d=wade.iso.getValidMovementDirections(),f=[],g=0;g<d.length;g++)f.push({x:a.iso.gridCoords.x+d[g].x,z:a.iso.gridCoords.z+d[g].z,object:a});f.sort(function(a,
c){var d,e;d=b.x-a.x;e=b.z-a.z;var f=d*d+e*e;d=b.x-c.x;e=b.z-c.z;return f-(d*d+e*e)});for(g=0;g<f.length;g++)c.push(f[g]);for(g=0;g<c.length;g++)if(c[g].x!=b.x||c[g].z!=b.z){if(this.setDestination(c[g]))break}else{e=a;this.owner.processEvent("onMoveComplete");break}};this.startWandering=function(a,b,d){c={probability:a,stepDistance:b,targetObject:d}};this.stopWandering=function(){c=0};this.onMoveComplete=function(){if(b.length)this._goToNextDestination();else{this.owner.playAnimation("Idle_iso_"+
